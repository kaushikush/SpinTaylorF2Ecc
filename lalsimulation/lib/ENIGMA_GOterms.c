                 ...
                 Complex(0,1)*
                  (-14*Nu*(-31 + 31*delta + 2*Nu) + 
                    kappa2*(117*(-1 + delta) + (23 + 211*delta)*Nu + 
                       390*pow(Nu,2)))*S2z)))))/pow(r,4)) + /* Henry et al. QC spinning hereditary terms  */
                       (((-8*M_PI*((1 + delta - Nu)*S1z + S2z - (delta + Nu)*S2z)*pow(x,4))/3.)));
    }
    else if(vpnorder==7){
             ...
             2*Nu*(Complex(0,415432) - 66840*S2z + 
                15*(8*(-557 + 1342*delta)*S1z + 
                   ...
                   189*(5*(-1 + delta)*kappa2 + 
                    ...
                    (317520.*pow(r,4))) + /* Henry et al. QC spinning hereditary terms */ 
                    (2*M_PI*(kappa1*(1 + delta - 2*Nu)*pow(S1z,2) + S2z*(4*Nu*S1z - kappa2*(-1 + delta + 2*Nu)*S2z))*pow(x,4.5)));
                    }
...
// hQC_l_m() functions contains only the non-spinning hereditary terms at particular PN order.
...
//H21
 ...
 static COMPLEX16 hGO_2_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder, REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 1){
     ...
     (2*mass*((77 + 59*Nu + 11*delta*(7 + Nu))*S1z + 
       ...
       r*(Complex(0,-2)*PhiDOT*r*rDOT*
        ...
        (6.*pow(r,3))) +/* Henry et al. QC spinning hereditary terms */ 
         (Complex(0,-0.5)*((1 + delta)*S1z + (-1 + delta)*S2z)*pow(x,3.5)*(M_PI - Complex(0,2)*log(2))));
    }
          ...
          3*pow(mass,2)*r*(Complex(0,31680)*pow(rDOT,3)*
             ...
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (-8330400*pow(Nu,3) + 
                ...
                log(r/r0)))/pow(r,4)) + /* Henry et al. QC spinning hereditary terms */
                 ((-14*(1 + delta)*S1z + (431 + 87*delta)*Nu*S1z + (14 - 431*Nu + delta*(-14 + 87*Nu))*S2z)*pow(x,4.5)*(Complex(0,1)*M_PI + log(4)))/84.);
    }
    ...
    if(vpnorder == 1){
     ...
     (10*pow(mass,2)*((252*(1 + delta) - (1277 + 1279*delta)*Nu + 
       ...
       + 81*(-29 + 80*log(1.5))) - 5*(54*kappa2*(-4 + Nu*(13 + 8*Nu) + delta*(4 + Nu*(-5 + 12*Nu)))*S2z + 
        ...
        + *//* Henry et al. ecc spin terms */ ((Complex(0,504504)*pow(mass,3)*(2*mass*(rDOT*(S1z*(108 - 498*Nu + Complex(0,5)*(-24 - 5*kappa1 + 3*(76 + kappa1)*Nu + 4*(-111 + 13*kappa1)*pow(Nu,2))*S1z) + 
              6*(-18 + 83*Nu)*S2z - Complex(0,5)*(-24 - 5*kappa2 + 3*(76 + kappa2)*Nu + 4*(-111 + 13*kappa2)*pow(Nu,2))*pow(S2z,2)) + 
           PhiDOT*r*(S1z*(Complex(0,-3)*(-99 + 581*Nu) + 5*(-24 + 399*kappa1 + 48*(7 - 19*Nu)*Nu + kappa1*Nu*(-1629 + 188*Nu))*S1z) + Complex(0,3)*(-99 + 581*Nu)*S2z - 
              5*(-24 + 399*kappa2 + 48*(7 - 19*Nu)*Nu + kappa2*Nu*(-1629 + 188*Nu))*pow(S2z,2))) + 
        r*(3*PhiDOT*r*pow(rDOT,2)*(S1z*(Complex(0,216) + 545*kappa1*S1z + 40*(45 + 8*kappa1)*pow(Nu,2)*S1z - 30*Nu*(Complex(0,50) + 20*S1z + 73*kappa1*S1z)) + 
              Complex(0,12)*(-18 + 125*Nu)*S2z - 5*(109*kappa2 - 6*(20 + 73*kappa2)*Nu + 8*(45 + 8*kappa2)*pow(Nu,2))*pow(S2z,2)) + 
           2*pow(rDOT,3)*(S1z*(-54 + Complex(0,145)*kappa1*S1z - Complex(0,30)*Nu*(Complex(0,11) + 2*Nu*S1z + kappa1*(17 + 8*Nu)*S1z)) + 6*(9 - 55*Nu)*S2z + 
              Complex(0,5)*(12*pow(Nu,2) + kappa2*(-29 + 6*Nu*(17 + 8*Nu)))*pow(S2z,2)) + 
           6*pow(PhiDOT,2)*pow(r,2)*rDOT*(S1z*(297 - 465*Nu + Complex(0,5)*(6*(20 - 87*Nu)*Nu + kappa1*(-50 + 3*Nu*(47 + 76*Nu)))*S1z) + 3*(-99 + 155*Nu)*S2z - 
              Complex(0,5)*(6*(20 - 87*Nu)*Nu + kappa2*(-50 + 3*Nu*(47 + 76*Nu)))*pow(S2z,2)) + 
           pow(PhiDOT,3)*pow(r,3)*(Complex(0,3)*(531 - 1295*Nu)*S1z + 10*(-33*kappa1 + 6*(30 + 13*kappa1)*Nu + 4*(-96 + 67*kappa1)*pow(Nu,2))*pow(S1z,2) + 
              S2z*(Complex(0,-1593) + 330*kappa2*S2z + 5*Nu*(Complex(0,777) - 4*(90 + 39*kappa2 - 192*Nu + 134*kappa2*Nu)*S2z))))) + 
     delta*(-17640*(-4083 + Nu*(58311 + Nu*(-269240 + 405617*Nu)))*pow(r,4)*pow(PhiDOT*r + Complex(0,1)*rDOT,6)*pow(Complex(0,1)*PhiDOT*r + rDOT,3) + 
        168*pow(mass,2)*pow(r,2)*(Complex(0,1)*(-7508635 + 7*Nu*(-1318438 + Nu*(-10231834 + 9667755*Nu)))*pow(PhiDOT,5)*pow(r,5) + 
           7*(1235591 + Nu*(884445 + (23935218 - 26913443*Nu)*Nu))*pow(PhiDOT,4)*pow(r,4)*rDOT - 
           Complex(0,1)*(8961149 + 7*Nu*(-31755709 + Nu*(-11134798 + 22187331*Nu)))*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) - 
           (-36806435 + 7*Nu*(33178545 + Nu*(24565078 + 22873537*Nu)))*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
           Complex(0,5)*(-7761899 + 7*Nu*(2892563 + 5998602*Nu + 7493619*pow(Nu,2)))*PhiDOT*r*pow(rDOT,4) + 
           5*(-2422057 + 7*Nu*(501045 + Nu*(2033141 + 2771816*Nu)))*pow(rDOT,5)) + 
        1764*mass*pow(r,3)*(Complex(0,-2)*(239087 + Nu*(-1206515 + Nu*(422631 + 3979375*Nu)))*pow(PhiDOT,7)*pow(r,7) + 
           2*(621284 + Nu*(-2279907 + 2*Nu*(-1180187 + 5876531*Nu)))*pow(PhiDOT,6)*pow(r,6)*rDOT + 
           Complex(0,2)*(39270 + Nu*(1235486 - 5319747*Nu + 4406349*pow(Nu,2)))*pow(PhiDOT,5)*pow(r,5)*pow(rDOT,2) + 
           8*(349111 + 4*Nu*(-519370 + 33*Nu*(10939 + 42635*Nu)))*pow(PhiDOT,4)*pow(r,4)*pow(rDOT,3) + 
           Complex(0,2)*(1212607 + 3*Nu*(-2012698 - 67827*Nu + 7955628*pow(Nu,2)))*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,4) + 
           4*(201135 + 2*Nu*(-773107 + Nu*(1214819 + 1157652*Nu)))*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) + 
           Complex(0,5)*(333969 + 2*Nu*(-981471 + 4*Nu*(154039 + 750016*Nu)))*PhiDOT*r*pow(rDOT,6) - 40*(13245 + 2*Nu*(-37005 + Nu*(14251 + 130160*Nu)))*pow(rDOT,7))
         + 2*pow(mass,4)*(4*rDOT*(269279500*pow(Nu,3) + 2*(-174108226 + 63063*S1z*(Complex(0,108) + 5*(24 + 5*kappa1)*S1z) + 
                 63063*S2z*(Complex(0,108) + 5*(24 + 5*kappa2)*S2z)) - 
              21*Nu*(103100846 + 1846845*pow(M_PI,2) + Complex(0,1693692)*S2z - 
                 6006*(S1z*(Complex(0,-282) + 5*(-180 + 7*kappa1)*S1z) - 980*S1z*S2z + 5*(-180 + 7*kappa2)*pow(S2z,2))) - 
              2940*pow(Nu,2)*(-122855 + 4719*((-6 + 7*kappa1)*pow(S1z,2) - 26*S1z*S2z + (-6 + 7*kappa2)*pow(S2z,2)))) + 
           Complex(0,1)*PhiDOT*r*(-1176172480*pow(Nu,3) + 8*(-74084729 + 189189*S1z*(Complex(0,99) + 5*(-8 + 133*kappa1)*S1z) + 
                 189189*S2z*(Complex(0,99) + 5*(-8 + 133*kappa2)*S2z)) + 
              35280*pow(Nu,2)*(56255 + 429*((-22 + 65*kappa1)*pow(S1z,2) - 174*S1z*S2z + (-22 + 65*kappa2)*pow(S2z,2))) - 
              147*Nu*(-65012788 + 4485195*pow(M_PI,2) + Complex(0,3943368)*S2z + 
                 10296*(S1z*(Complex(0,383) + 5*(-96 + 277*kappa1)*S1z) - 3220*S1z*S2z + 5*(-96 + 277*kappa2)*pow(S2z,2))))) + 
        pow(mass,3)*r*(Complex(0,-12)*PhiDOT*r*pow(rDOT,2)*(-1035895280*pow(Nu,3) - 
              2*(-547993687 + 63063*S1z*(Complex(0,216) + 545*kappa1*S1z) + 63063*S2z*(Complex(0,216) + 545*kappa2*S2z)) + 
              77*Nu*(42451610 + 1511055*pow(M_PI,2) + Complex(0,1749384)*S2z + 
                 6552*(S1z*(Complex(0,267) + 25*(6 + 11*kappa1)*S1z) - 5*S1z*S2z + 25*(6 + 11*kappa2)*pow(S2z,2))) + 
              490*pow(Nu,2)*(-5802767 + 5148*((-6 + 23*kappa1)*pow(S1z,2) - 58*S1z*S2z + (-6 + 23*kappa2)*pow(S2z,2)))) + 
           4*pow(rDOT,3)*(-1359334480*pow(Nu,3) - 4*(-150254558 + 63063*S1z*(Complex(0,54) + 145*kappa1*S1z) + 63063*S2z*(Complex(0,54) + 145*kappa2*S2z)) + 
              231*Nu*(8490448 + 503685*pow(M_PI,2) + Complex(0,242424)*S2z + 2184*(S1z*(Complex(0,111) + 110*kappa1*S1z) + 70*S1z*S2z + 110*kappa2*pow(S2z,2))) + 
              11760*pow(Nu,2)*(-312980 + 429*((3 + 25*kappa1)*pow(S1z,2) - 44*S1z*S2z + (3 + 25*kappa2)*pow(S2z,2)))) + 
           6*pow(PhiDOT,2)*pow(r,2)*rDOT*(2368900688*pow(Nu,3) + 
              8*(-812986529 + 63063*S1z*(Complex(0,297) + 250*kappa1*S1z) + 63063*S2z*(Complex(0,297) + 250*kappa2*S2z)) - 
              1176*pow(Nu,2)*(2423171 + 4290*((-3 + 41*kappa1)*pow(S1z,2) - 88*S1z*S2z + (-3 + 41*kappa2)*pow(S2z,2))) + 
              539*Nu*(-24139772 + 647595*pow(M_PI,2) + Complex(0,120744)*S2z - 
                 936*(S1z*(Complex(0,-129) + 600*S1z + 205*kappa1*S1z) - 460*S1z*S2z + 5*(120 + 41*kappa2)*pow(S2z,2)))) + 
           Complex(0,1)*pow(PhiDOT,3)*pow(r,3)*(-4538040136*pow(Nu,3) - 
              88*(259018351 + 17199*S1z*(Complex(0,-531) + 110*kappa1*S1z) + 17199*S2z*(Complex(0,-531) + 110*kappa2*S2z)) + 
              2352*pow(Nu,2)*(7332973 + 12870*((5 + 23*kappa1)*pow(S1z,2) - 36*S1z*S2z + (5 + 23*kappa2)*pow(S2z,2))) + 
              21*Nu*(49864815*pow(M_PI,2) + 8*(-88128538 - Complex(0,2099097)*S2z + 
                    9009*(S1z*(Complex(0,-233) + 40*(15 + kappa1)*S1z) + 360*S1z*S2z + 40*(15 + kappa2)*pow(S2z,2))))))) + 
     74954880*delta*pow(mass,3)*(Complex(0,22)*mass*PhiDOT*r + Complex(0,59)*pow(PhiDOT,3)*pow(r,4) + 8*mass*rDOT + 66*pow(PhiDOT,2)*pow(r,3)*rDOT + 
        Complex(0,24)*PhiDOT*pow(r,2)*pow(rDOT,2) - 4*r*pow(rDOT,3))*log(r/r0))/(2.4216192e7*sqrt(210)*pow(r,4))) + /* Henry et al. QC spinning hereditary terms */ 
        ((9*sqrt(0.04285714285714286)*pow(x,4.5)*(Complex(0,-5)*M_PI*((-4 - 4*delta + 19*Nu + 5*delta*Nu)*S1z + 
          (4 - 4*delta - 19*Nu + 5*delta*Nu)*S2z) + 20*Nu*(19*S1z - 19*S2z + 5*delta*S2z)*atanh(1/5) + 
       delta*S2z*(10*log(1.5802469135802468) - 3*log(1024))))/8.));
    }
           ...
           (40*(1 + delta - 2*Nu)*S1z - 
             ...
             S2z*(-40*(-1 + delta + 2*Nu) - 
                Complex(0,1)*
                 ...
                 ((8*sqrt(0.7142857142857143)*Nu*M_PI*(S1z + S2z)*pow(x,4))/3.));
    }
...
static COMPLEX16 hGO_3_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
   ...
   (sqrt(14)*pow(r,4))));
        ...
        S2z*(Complex(0,-315)*delta*Nu + 30*(4 - 11*Nu + delta*(-4 + 13*Nu))*M_PI + 60*Nu*(6 - 50*Nu + delta*(-6 + 11*Nu))*S2z + 
          ...
          + */ /* Henry et al. ecc + spin terms */ ((Complex(0,1)*(1513512*pow(mass,3)*(2*mass*(PhiDOT*r*(Complex(0,1)*(-97 + 631*Nu)*S1z + 5*(8 + 16*Nu*(-7 + 15*Nu) + 3*kappa1*(-39 + Nu*(149 + 4*Nu)))*pow(S1z,2) + 
                 S2z*(Complex(0,97) - Complex(0,631)*Nu - 5*(8 + 16*Nu*(-7 + 15*Nu) + 3*kappa2*(-39 + Nu*(149 + 4*Nu)))*S2z)) + 
              rDOT*(2*(-18 + 83*Nu)*S1z - Complex(0,5)*(-4*(6 + Nu*(-25 + 7*Nu)) + kappa1*(155 + Nu*(-373 + 164*Nu)))*pow(S1z,2) + 
                 S2z*(36 - 166*Nu + Complex(0,5)*(-4*(6 + Nu*(-25 + 7*Nu)) + kappa2*(155 + Nu*(-373 + 164*Nu)))*S2z))) + 
           r*(2*pow(rDOT,3)*(S1z*(18 - 110*Nu - Complex(0,5)*(69*kappa1 - 214*kappa1*Nu + 4*(5 + 4*kappa1)*pow(Nu,2))*S1z) + 2*(-9 + 55*Nu)*S2z + 
                 Complex(0,5)*(69*kappa2 - 214*kappa2*Nu + 4*(5 + 4*kappa2)*pow(Nu,2))*pow(S2z,2)) + 
              pow(PhiDOT,3)*pow(r,3)*(S1z*(Complex(0,255) - Complex(0,1403)*Nu + 10*(28*(3 - 8*Nu)*Nu + kappa1*(51 + 2*Nu*(-91 + 118*Nu)))*S1z) + 
                 Complex(0,1)*(-255 + 1403*Nu)*S2z - 10*(28*(3 - 8*Nu)*Nu + kappa2*(51 + 2*Nu*(-91 + 118*Nu)))*pow(S2z,2)) + 
              2*pow(PhiDOT,2)*pow(r,2)*rDOT*(S1z*(255 - 1079*Nu + Complex(0,5)*(2*(60 - 361*Nu)*Nu + kappa1*(6 + Nu*(-47 + 164*Nu)))*S1z) + (-255 + 1079*Nu)*S2z - 
                 Complex(0,5)*(2*(60 - 361*Nu)*Nu + kappa2*(6 + Nu*(-47 + 164*Nu)))*pow(S2z,2)) + 
              PhiDOT*r*pow(rDOT,2)*(Complex(0,4)*(-114 + 781*Nu)*S1z + 5*(-213*kappa1 - 72*Nu + 278*kappa1*Nu + 8*(7 + 44*kappa1)*pow(Nu,2))*pow(S1z,2) + 
                 S2z*(Complex(0,456) + 1065*kappa2*S2z + 2*Nu*(Complex(0,-1562) - 5*(-36 + 139*kappa2 + 4*(7 + 44*kappa2)*Nu)*S2z))))) + 
        delta*(52920*(-4083 + Nu*(58311 + Nu*(-269240 + 405617*Nu)))*pow(r,4)*pow(PhiDOT*r - Complex(0,1)*rDOT,4)*pow(PhiDOT*r + Complex(0,1)*rDOT,5) + 
           840*pow(mass,2)*pow(r,2)*((-2555489 + 7*Nu*(820078 + Nu*(-6623390 + 4948497*Nu)))*pow(PhiDOT,5)*pow(r,5) + 
              Complex(0,1)*(3537631 + 7*Nu*(-2817653 + Nu*(-7052042 + 4017147*Nu)))*pow(PhiDOT,4)*pow(r,4)*rDOT + 
              3*(-1428997 + 7*Nu*(-1230747 + Nu*(-237418 + 4061717*Nu)))*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) + 
              Complex(0,1)*(-5153011 + 7*Nu*(-2375327 + 9*Nu*(218846 + 1640185*Nu)))*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) + 
              (-7761899 + 7*Nu*(2892563 + 5998602*Nu + 7493619*pow(Nu,2)))*PhiDOT*r*pow(rDOT,4) + 
              Complex(0,3)*(-2422057 + 7*Nu*(501045 + Nu*(2033141 + 2771816*Nu)))*pow(rDOT,5)) - 
           8820*mass*pow(r,3)*(2*(111737 + Nu*(-366573 + Nu*(-618923 + 2278593*Nu)))*pow(PhiDOT,7)*pow(r,7) + 
              Complex(0,2)*(101844 + Nu*(-273675 - 871630*Nu + 2069774*pow(Nu,2)))*pow(PhiDOT,6)*pow(r,6)*rDOT + 
              2*(341322 + Nu*(-1429938 + Nu*(-1206083 + 7690681*Nu)))*pow(PhiDOT,5)*pow(r,5)*pow(rDOT,2) + 
              Complex(0,8)*(90241 + 2*Nu*(-206022 + Nu*(-62113 + 1003558*Nu)))*pow(PhiDOT,4)*pow(r,4)*pow(rDOT,3) + 
              2*(410547 + Nu*(-2269686 + Nu*(762091 + 8400052*Nu)))*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,4) + 
              Complex(0,4)*(217935 + 2*Nu*(-573699 + 5*Nu*(18671 + 445748*Nu)))*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) + 
              (333969 + 2*Nu*(-981471 + 4*Nu*(154039 + 750016*Nu)))*PhiDOT*r*pow(rDOT,6) + Complex(0,24)*(13245 + 2*Nu*(-37005 + Nu*(14251 + 130160*Nu)))*pow(rDOT,7))
            + 2*pow(mass,4)*(Complex(0,-4178597424)*rDOT + Complex(0,84)*rDOT*
               (38468500*pow(Nu,3) + Complex(0,648648)*(S1z + S2z) - 90090*((-24 + 155*kappa1)*pow(S1z,2) + (-24 + 155*kappa2)*pow(S2z,2)) - 
                 420*pow(Nu,2)*(-122855 + 3003*((2 + 11*kappa1)*pow(S1z,2) - 18*S1z*S2z + (2 + 11*kappa2)*pow(S2z,2))) + 
                 3*Nu*(-103100846 - 1846845*pow(M_PI,2) - Complex(0,564564)*S2z + 
                    6006*(S1z*(Complex(0,-94) + 5*(-52 + 63*kappa1)*S1z) - 20*S1z*S2z + 5*(-52 + 63*kappa2)*pow(S2z,2)))) + 
              PhiDOT*r*(1176172480*pow(Nu,3) + 8*(74084729 - 189189*S1z*(Complex(0,97) + 5*(-8 + 117*kappa1)*S1z) - 
                    189189*S2z*(Complex(0,97) + 5*(-8 + 117*kappa2)*S2z)) - 
                 176400*pow(Nu,2)*(11251 + 429*((2 + 13*kappa1)*pow(S1z,2) - 22*S1z*S2z + (2 + 13*kappa2)*pow(S2z,2))) + 
                 147*Nu*(-65012788 + 4485195*pow(M_PI,2) + Complex(0,4499352)*S2z + 
                    10296*(S1z*(Complex(0,437) + 15*(-32 + 71*kappa1)*S1z) - 3860*S1z*S2z + 15*(-32 + 71*kappa2)*pow(S2z,2))))) - 
           3*pow(mass,3)*r*(Complex(0,-4)*pow(rDOT,3)*(601018232 - 1359334480*pow(Nu,3) - 756756*S1z*(Complex(0,6) + 115*kappa1*S1z) - 
                 756756*S2z*(Complex(0,6) + 115*kappa2*S2z) + 231*Nu*
                  (8490448 + 503685*pow(M_PI,2) + Complex(0,80808)*S2z + 2184*(S1z*(Complex(0,37) + 190*kappa1*S1z) + 70*S1z*S2z + 190*kappa2*pow(S2z,2))) + 
                 58800*pow(Nu,2)*(-62596 + 429*((-1 + 5*kappa1)*pow(S1z,2) - 12*S1z*S2z + (-1 + 5*kappa2)*pow(S2z,2)))) - 
              Complex(0,14)*pow(PhiDOT,2)*pow(r,2)*rDOT*(-229522160*pow(Nu,3) + 
                 8*(48303859 + 135135*S1z*(Complex(0,-17) + 2*kappa1*S1z) + 135135*S2z*(Complex(0,-17) + 2*kappa2*S2z)) + 
                 2520*pow(Nu,2)*(100913 + 286*((-31 + 5*kappa1)*pow(S1z,2) - 72*S1z*S2z + (-31 + 5*kappa2)*pow(S2z,2))) + 
                 7*Nu*(125038052 + 2374515*pow(M_PI,2) + Complex(0,5858424)*S2z - 
                    10296*(S1z*(Complex(0,-569) + 25*(-24 + 7*kappa1)*S1z) + 700*S1z*S2z + 25*(-24 + 7*kappa2)*pow(S2z,2)))) + 
              4*PhiDOT*r*pow(rDOT,2)*(-1095987374 + 1035895280*pow(Nu,3) + 378378*S1z*(Complex(0,152) + 355*kappa1*S1z) + 
                 378378*S2z*(Complex(0,152) + 355*kappa2*S2z) - 490*pow(Nu,2)*
                  (-5802767 + 5148*((2 + 23*kappa1)*pow(S1z,2) - 42*S1z*S2z + (2 + 23*kappa2)*pow(S2z,2))) - 
                 77*Nu*(42451610 + 1511055*pow(M_PI,2) + Complex(0,3623256)*S2z - 
                    6552*(S1z*(Complex(0,-553) + 5*(18 + 37*kappa1)*S1z) + 965*S1z*S2z + 5*(18 + 37*kappa2)*pow(S2z,2)))) + 
              7*pow(PhiDOT,3)*pow(r,3)*(512893080*pow(Nu,3) - 136*(-2089567 + 135135*S1z*(Complex(0,1) + 2*kappa1*S1z) + 135135*S2z*(Complex(0,1) + 2*kappa2*S2z)) - 
                 560*pow(Nu,2)*(2457671 + 2574*((11 + 53*kappa1)*pow(S1z,2) - 84*S1z*S2z + (11 + 53*kappa2)*pow(S2z,2))) + 
                 3*Nu*(16621605*pow(M_PI,2) + 8*(27468722 + Complex(0,2681679)*S2z + 
                       3003*(S1z*(Complex(0,893) - 840*S1z + 800*kappa1*S1z) - 3160*S1z*S2z + 40*(-21 + 20*kappa2)*pow(S2z,2)))))))) + 
     74954880*delta*pow(mass,3)*(mass*(Complex(0,-22)*PhiDOT*r - 24*rDOT) + 
        3*r*(Complex(0,7)*pow(PhiDOT,3)*pow(r,3) + 14*pow(PhiDOT,2)*pow(r,2)*rDOT - Complex(0,8)*PhiDOT*r*pow(rDOT,2) + 4*pow(rDOT,3)))*log(r/r0))/
   (3.6324288e8*sqrt(14)*pow(r,4))) + /* Henry et al. QC spinning hereditary terms */
          ((((-4 + 11*Nu + delta*(-4 + 13*Nu))*S1z + (4 - 11*Nu + delta*(-4 + 13*Nu))*S2z)*pow(x,4.5)*
     (Complex(0,1)*M_PI + log(4)))/(24.*sqrt(14))));
    }
...
static COMPLEX16 hl_4_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_4_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_4_m_4(Nu,vpnorder,x)) * cpolar(1,-4*Phi);
    }
}
...
static COMPLEX16 hl_4_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_min4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,4) * conj(hGO_4_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_4_m_4(Nu,vpnorder,x)) * cpolar(1,4*Phi); 
    }
}
           ...
           (10*(234744 - 1010534*Nu + 1024443*pow(Nu,2) + 
             ...
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              ...
              PhiDOT*r*(-38076 + 174720*pow(Nu,3) - 
                ...
                (sqrt(70)*pow(r,4))) + /* Henry et al. QC spinning hereditary terms */
                 ((27*sqrt(0.35714285714285715)*Nu*((-1 + delta)*S1z + S2z + delta*S2z)*pow(x,4.5)*
              (Complex(0,-1)*M_PI + 4*atanh(1/5)))/8.));
    }
...
static COMPLEX16 hl_4_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_2: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_4_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_4_m_2(Nu,vpnorder,x)) * cpolar(1,-2*Phi);
    }
}
...
static COMPLEX16 hl_4_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min2: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * pow(-1,4) * conj(hGO_4_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_4_m_2(Nu,vpnorder,x)) * cpolar(1,2*Phi); 
    }
}
             ...
             PhiDOT*r*(Complex(0,-1)*(-121 + 633*Nu)*S1z + 
                6*(220*pow(Nu,2) + 
                 ...
                 - S2z*(Complex(0,121) + 162*kappa2*S2z + 
                  ...
                  (sqrt(10)*pow(r,4))) + /* Henry et al. QC spinning hereditary terms */ ((sqrt(2.5)*Nu*((-1 + delta)*S1z + S2z 
                  + delta*S2z)*pow(x,4.5)*(Complex(0,1)*M_PI + log(4)))/168.));
    }
...
static COMPLEX16 hl_5_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_5: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_5_m_5(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_5_m_5(Nu,vpnorder,x)) * cpolar(1,-5*Phi);
    }
...
static COMPLEX16 hl_5_m_min5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min5: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,5) * conj(hGO_5_m_5(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_5_m_5(Nu,vpnorder,x)) * cpolar(1,5*Phi);
    }
...
static COMPLEX16 hl_5_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * (hGO_5_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_5_m_4(Nu,vpnorder,x) */) * cpolar(1,-4*Phi);
    }
}
...
static COMPLEX16 hl_5_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * pow(-1,5) * conj(hGO_5_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_5_m_4(Nu,vpnorder,x) */) * cpolar(1,4*Phi); 
    }
}
...
static COMPLEX16 hl_5_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_3: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_5_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_5_m_3(Nu,vpnorder,x)) * cpolar(1,-3*Phi);
    }
...
static COMPLEX16 hl_5_m_min3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min3: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * pow(-1,5) * conj(hGO_5_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_5_m_3(Nu,vpnorder,x)) * cpolar(1,3*Phi);
    }
...
static COMPLEX16 hl_5_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_2: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_5_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_5_m_2(Nu,vpnorder,x) */) * cpolar(1,-2*Phi);
    }
}
...
static COMPLEX16 hl_5_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min2: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,5) * conj(hGO_5_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_5_m_2(Nu,vpnorder,x) */) * cpolar(1,2*Phi); 
    }
}
...
static COMPLEX16 hl_5_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_1: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_5_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_5_m_1(Nu,vpnorder,x)) * cpolar(1,-1*Phi);
    }
...
static COMPLEX16 hl_5_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min1: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * pow(-1,5) * conj(hGO_5_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)+hQC_5_m_1(Nu,vpnorder,x)) * cpolar(1,1*Phi);
    }
...
static COMPLEX16 hl_6_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_6: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_6_m_6(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_6(Nu,vpnorder,x) */) * cpolar(1,-6*Phi);
    }
...
static COMPLEX16 hl_6_m_min6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min6: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,6) * conj(hGO_6_m_6(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_6(Nu,vpnorder,x) */) * cpolar(1,6*Phi); 
    }
}
...
static COMPLEX16 hl_6_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_m5: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_6_m_5(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_5(Nu,vpnorder,x) */) * cpolar(1,-5*Phi);
    }
...
static COMPLEX16 hl_6_m_min5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min5: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,6) * conj(hGO_6_m_5(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_5(Nu,vpnorder,x) */) * cpolar(1,5*Phi);
    }
...
static COMPLEX16 hl_6_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_6_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_4(Nu,vpnorder,x) */) * cpolar(1,-4*Phi);
    }
...
static COMPLEX16 hl_6_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,6) * conj(hGO_6_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_4(Nu,vpnorder,x) */) * cpolar(1,4*Phi); 
    }
}
...
static COMPLEX16 hl_6_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_3: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_6_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_3(Nu,vpnorder,x) */) * cpolar(1,-3*Phi);
    }
...
static COMPLEX16 hl_6_m_min3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min3: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,6) * conj(hGO_6_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_3(Nu,vpnorder,x) */) * cpolar(1,3*Phi);
    }
...
static COMPLEX16 hl_6_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_1: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_6_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_2(Nu,vpnorder,x) */) * cpolar(1,-2*Phi);
    }
...
static COMPLEX16 hl_6_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min2: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,6) * conj(hGO_6_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_2(Nu,vpnorder,x) */) * cpolar(1,2*Phi); 
    }
}
...
static COMPLEX16 hl_6_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_1: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * (hGO_6_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_1(Nu,vpnorder,x) */) * cpolar(1,-1*Phi);
    }
}
...
static COMPLEX16 hl_6_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min1: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)   * pow(-1,6) * conj(hGO_6_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)/* +hQC_6_m_1(Nu,vpnorder,x) */) * cpolar(1,1*Phi);
    }
}
...
static COMPLEX16 hl_7_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_2: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * hGO_7_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z) * cpolar(1,-2*Phi);
    }
...
static COMPLEX16 hl_7_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min2: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * pow(-1,7) * conj(hGO_7_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)) * cpolar(1,2*Phi);
    }
...
static COMPLEX16 hl_7_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * hGO_7_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z) * cpolar(1,-4*Phi);
    }
...
static COMPLEX16 hl_7_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min4: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * pow(-1,7) * conj(hGO_7_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)) * cpolar(1,4*Phi);
    }
...
static COMPLEX16 hl_7_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_6: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * hGO_7_m_6(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z) * cpolar(1,-6*Phi);
    }
...
static COMPLEX16 hl_7_m_min6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder,REAL8 S1z, REAL8 S2z){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min6: Input PN order parameter should be between [0, 8].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R)  * pow(-1,7) * conj(hGO_7_m_6(mass,Nu,r,rDOT,PhiDOT,vpnorder,S1z,S2z)) * cpolar(1,6*Phi);
    }
}
...
static COMPLEX16 h05PNGOresult(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 inc,REAL8 euler_beta,REAL8 R,UINT4 vpnorder,REAL8 S1z,REAL8 S2z, REAL8 x){
    ...
    //3PN
        ...
        return hcombined;
         ...
         COMPLEX16 hcombined =XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,1)*hl_6_m_1(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-1)*hl_6_m_min1(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+ 
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,2)*hl_6_m_2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-2)*hl_6_m_min2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,3)*hl_6_m_3(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-3)*hl_6_m_min3(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,4)*hl_6_m_4(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-4)*hl_6_m_min4(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,5)*hl_6_m_5(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-5)*hl_6_m_min5(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,6)*hl_6_m_6(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-6)*hl_6_m_min6(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,5,2)*hl_5_m_2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,5,-2)*hl_5_m_min2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,5,4)*hl_5_m_4(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,5,-4)*hl_5_m_min4(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,6)*hl_7_m_6(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,-6)*hl_7_m_min6(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,4)*hl_7_m_4(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,-4)*hl_7_m_min4(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,2)*hl_7_m_2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,-2)*hl_7_m_min2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z)+
