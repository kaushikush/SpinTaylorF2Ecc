...
//H22
static COMPLEX16 hGO_2_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    ...
    if(vpnorder == 2){
        ...
        + 207200*pow(Nu,3))*pow(rDOT,6)))/(3.3264e6*pow(r,4));
    }
...
static COMPLEX16 hl_2_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_2_m_2: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,2*M_PI/2) * hGO_2_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-2*Phi);
    }
}

static COMPLEX16 hl_2_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_2_m_min2: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-2*M_PI/2)* pow(-1,2) * conj(hGO_2_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,2*Phi); 
    }
}

//H21
static COMPLEX16 hGO_2_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_2_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_2_m_1: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,1*M_PI/2) * hGO_2_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-1*Phi);
    }

}

static COMPLEX16 hl_2_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_2_m_min1: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-1*M_PI/2)* pow(-1,2) * conj(hGO_2_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,1*Phi);
    }
    
}

//H33
static COMPLEX16 hGO_3_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_3_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_3_m_3: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,3*M_PI/2) * hGO_3_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-3*Phi);
    }

}

static COMPLEX16 hl_3_m_min3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_3_m_min3: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-3*M_PI/2)* pow(-1,3) * conj(hGO_3_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,3*Phi);
    }
    
}

//H32
static COMPLEX16 hGO_3_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_3_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_3_m_2: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,2*M_PI/2) * hGO_3_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-2*Phi);
    }
}

static COMPLEX16 hl_3_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_3_m_min2: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-2*M_PI/2)* pow(-1,3) * conj(hGO_3_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,2*Phi); 
    }
}

//H31
static COMPLEX16 hGO_3_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
    ...
    if(vpnorder == 1){
        ...
        - 12*(-771 + 1126*Nu 
        + 3616*pow(Nu,2))*pow(rDOT,5))))/(4752.*sqrt(14)*pow(r,3));
    }
        ...
        + 1000*pow(rDOT,4))))/(180.*sqrt(14)*pow(r,4));
    }
...
static COMPLEX16 hl_3_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_1: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,1*M_PI/2) * hGO_3_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-1*Phi);
    }

}

static COMPLEX16 hl_3_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_min1: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-1*M_PI/2)* pow(-1,3) * conj(hGO_3_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,1*Phi);
    }
    
}

//H44
static COMPLEX16 hGO_4_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_4_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_4: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,4*M_PI/2) * hGO_4_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-4*Phi);
    }
}

static COMPLEX16 hl_4_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_min4: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-4*M_PI/2)* pow(-1,4) * conj(hGO_4_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,4*Phi); 
    }
}

//H43
static COMPLEX16 hGO_4_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
    ...
    if(vpnorder == 3){
        ...
        + Complex(0,112)*pow(rDOT,3))))/(180.*sqrt(70)*pow(r,2));
    }
...
static COMPLEX16 hl_4_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_3: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,3*M_PI/2) * hGO_4_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-3*Phi);
    }

}

static COMPLEX16 hl_4_m_min3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_min3: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-3*M_PI/2)* pow(-1,4) * conj(hGO_4_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,3*Phi);
    }
    
}

//H42
static COMPLEX16 hGO_4_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    ...
    if(vpnorder == 2){
        ...
        + 10*(-10233 + 44864*Nu + 13050*pow(Nu,2) 
        - 203280*pow(Nu,3))*pow(rDOT,6)))/(5.04504e6*sqrt(5)*pow(r,4));
    }
...
static COMPLEX16 hl_4_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_2: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,2*M_PI/2) * hGO_4_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-2*Phi);
    }
}

static COMPLEX16 hl_4_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min2: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-2*M_PI/2)* pow(-1,4) * conj(hGO_4_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,2*Phi); 
    }
}

//H41
static COMPLEX16 hGO_4_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_4_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_1: Input PN order parameter should be between [1, 6].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,1*M_PI/2) * hGO_4_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-1*Phi);
    }

}

static COMPLEX16 hl_4_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_4_m_min1: Input PN order parameter should be between [1, 6].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-1*M_PI/2)* pow(-1,4) * conj(hGO_4_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,1*Phi);
    }
    
}

//H55
static COMPLEX16 hGO_5_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_5_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_5: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,5*M_PI/2) * hGO_5_m_5(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-5*Phi);
    }

}

static COMPLEX16 hl_5_m_min5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min5: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-5*M_PI/2)* pow(-1,5) * conj(hGO_5_m_5(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,5*Phi);
    }
    
}

//H54
static COMPLEX16 hGO_5_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_5_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_4: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,4*M_PI/2) * hGO_5_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-4*Phi);
    }
}

static COMPLEX16 hl_5_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min4: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-4*M_PI/2)* pow(-1,5) * conj(hGO_5_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,4*Phi); 
    }
}

//H53
static COMPLEX16 hGO_5_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_5_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_3: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,3*M_PI/2) * hGO_5_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-3*Phi);
    }

}

static COMPLEX16 hl_5_m_min3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min3: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-3*M_PI/2)* pow(-1,5) * conj(hGO_5_m_3(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,3*Phi);
    }
    
}

//H52
static COMPLEX16 hGO_5_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_5_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_2: Input PN order parameter should be between [1, 6].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,2*M_PI/2) * hGO_5_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-2*Phi);
    }
}

static COMPLEX16 hl_5_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min2: Input PN order parameter should be between [1, 6].");
        ...
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-2*M_PI/2)* pow(-1,5) * conj(hGO_5_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,2*Phi); 
    }
}

//H51
static COMPLEX16 hGO_5_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_5_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_1: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,1*M_PI/2) * hGO_5_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-1*Phi);
    }

}

static COMPLEX16 hl_5_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_5_m_min1: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-1*M_PI/2)* pow(-1,5) * conj(hGO_5_m_1(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,1*Phi);
    }
    
}

//66
static COMPLEX16 hGO_6_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_6_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_6: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,6*M_PI/2) * hGO_6_m_6(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-6*Phi);
    }

}

static COMPLEX16 hl_6_m_min6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min6: Input PN order parameter should be between [1, 6].");
    }

   else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-6*M_PI/2)* pow(-1,6) * conj(hGO_6_m_6(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,6*Phi); 
    }
}

//65
static COMPLEX16 hGO_6_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_6_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_m5: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_6_m_min5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min5: Input PN order parameter should be between [1, 6].");
    }
...
//64
static COMPLEX16 hGO_6_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_6_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_4: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,4*M_PI/2) * hGO_6_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-4*Phi);
    }

}

static COMPLEX16 hl_6_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min4: Input PN order parameter should be between [1, 6].");
    }

   else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-4*M_PI/2)* pow(-1,6) * conj(hGO_6_m_4(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,4*Phi); 
    }
}

//63
static COMPLEX16 hGO_6_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_6_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_3: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_6_m_min3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
     
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min3: Input PN order parameter should be between [1, 6].");
    }
...
//62
static COMPLEX16 hGO_6_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_6_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_1: Input PN order parameter should be between [1, 6].");
    }

    else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,2*M_PI/2) * hGO_6_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder) * cpolar(1,-2*Phi);
    }

}

static COMPLEX16 hl_6_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min2: Input PN order parameter should be between [1, 6].");
    }

   else{
        return ((4*mass*Nu*sqrt(M_PI/5.))/R) * cpolar(1,-2*M_PI/2)* pow(-1,6) * conj(hGO_6_m_2(mass,Nu,r,rDOT,PhiDOT,vpnorder)) * cpolar(1,2*Phi); 
    }
}

//61
static COMPLEX16 hGO_6_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    REAL8 delta = sqrt(1-4*Nu);
...
static COMPLEX16 hl_6_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
...
static COMPLEX16 hl_6_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_6_m_min1: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_7(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_7: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_min7(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min7: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_5: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_min5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min5: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_3: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_min3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min3: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_1: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_min1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min1: Input PN order parameter should be between [1, 6].");
    }
...
//72
static COMPLEX16 hGO_7_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_7_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_2: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min2: Input PN order parameter should be between [1, 6].");
    }
...
//74
static COMPLEX16 hGO_7_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_7_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_4: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min4: Input PN order parameter should be between [1, 6].");
    }
...
//76
static COMPLEX16 hGO_7_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
...
static COMPLEX16 hl_7_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){

    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_6: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_7_m_min6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_7_m_min6: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_8(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_8: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_min8(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_min8: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_6: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_min6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_min6: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_4: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_min4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_min4: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_2: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 hl_8_m_min2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 R,UINT4 vpnorder){
    ...
    if ((vpnorder < 1) || (vpnorder > 6)) {
    XLAL_ERROR(XLAL_EINVAL,"Error in hl_8_m_min2: Input PN order parameter should be between [1, 6].");
    }
...
static COMPLEX16 h05PNGOresult(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 inc,REAL8 euler_beta,REAL8 R,UINT4 vpnorder){
...
static REAL8 hplusGO(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 inc,REAL8 euler_beta,REAL8 R,UINT4 vpnorder){
// nu = symmetric mass ratio m1m2/M^2
            REAL8 hplus = creal(h05PNGOresult(mass,Nu,r,rDOT,Phi,PhiDOT,inc,euler_beta,R,vpnorder));
            return hplus;
}

static REAL8 hcrossGO(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 inc,REAL8 euler_beta,REAL8 R,UINT4 vpnorder){
// nu = symmetric mass ratio m1m2/M^2
