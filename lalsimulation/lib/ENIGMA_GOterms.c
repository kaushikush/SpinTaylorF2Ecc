...
/* All the hGO_l_m fucntions contain the 3PN non-spinning general orbit terms from Mishra et al. arXiv:1501.07096 and
 3.5PN quasi-circular spinning corrections as given in Henry et al, arXiv:2209.00374v2 */

/* The (2,2) mode has newly computed 4PN non-spinning quasi-circular piece from arXiv:2304.11185 */
    ...
    if(vpnorder == 0){
      ...
      /* (This is the quasi-circular limit of the general orbit term-->) */ - ((-4*((1 + delta - Nu)*S1z + S2z - (delta + Nu)*S2z)*pow(x,2.5))/3.) 
       ...
       + S2z*(4*Nu*S1z - kappa2*(-1 + delta + 2*Nu)*S2z))*pow(x,3)));
        ...
        - 122*pow(rDOT,3))))/(105.*pow(r,3)) /* Henry et al. QC spin terms *//* + ((2*(56*delta*Nu*(-S1z + S2z) 
        + 101*Nu*(S1z + S2z) + 132*pow(Nu,2)*(S1z + S2z) - 80*(S1z + delta*S1z + S2z - delta*S2z))*pow(x,3.5))/63.) */
        + /* Henry et al. ecc spin terms */ ((pow(mass,2)*(mass*((238 + delta*(238 - 141*Nu) + 
             Nu*(-181 + 474*Nu))*PhiDOT*r*S1z + 
          Complex(0,8)*(55 + delta*(55 - 19*Nu) + 2*Nu*(-50 + 43*Nu))*
           rDOT*S1z + (238 + delta*(-238 + 141*Nu) + 
             Nu*(-181 + 474*Nu))*PhiDOT*r*S2z + 
          Complex(0,8)*(55 + delta*(-55 + 19*Nu) + 2*Nu*(-50 + 43*Nu))*
           rDOT*S2z) - r*(PhiDOT*r*pow(rDOT,2)*
           (-((18*(1 + delta) + 5*(-63 + 55*delta)*Nu + 
                  188*pow(Nu,2))*S1z) + 
             (18*(-1 + delta) + 5*(63 + 55*delta)*Nu - 
                188*pow(Nu,2))*S2z) - 
          Complex(0,2)*pow(rDOT,3)*
           ((-27*(1 + delta) + 6*(5 + 7*delta)*Nu - 4*pow(Nu,2))*
              S1z + (-27 + 27*delta + 30*Nu - 42*delta*Nu - 
                4*pow(Nu,2))*S2z) + 
          Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
           ((51 + 88*Nu*(-3 + 5*Nu) + delta*(51 + 62*Nu))*S1z + 
             (51 + 88*Nu*(-3 + 5*Nu) - delta*(51 + 62*Nu))*S2z) + 
          pow(PhiDOT,3)*pow(r,3)*
           ((120*(1 + delta) + (-483 + 83*delta)*Nu + 234*pow(Nu,2))*
              S1z + (120 + 3*Nu*(-161 + 78*Nu) - delta*(120 + 83*Nu))*
              S2z))))/(84.*pow(r,3))));
    }
        ...
        + 207200*pow(Nu,3))*pow(rDOT,6)))/(3.3264e6*pow(r,4)) /* Henry et al. QC spin terms */ /* + (((4*(1 + delta)*(-7 + 9*kappa1) 
       ...
       S2z*(12*(7 - 17*kappa2)*pow(Nu,2)*S2z + 4*(-1 + delta)*(Complex(0,21) + 42*M_PI + 7*S2z - 9*kappa2*S2z) + 
          ...
          + /* Henry et al. ecc spin terms */ (-0.005952380952380952*(pow(mass,3)*
       (2*mass*(S1z*(Complex(0,14)*(1 + delta - 2*Nu) + 
              42*(1 + delta - 2*Nu)*Nu*S1z + 
              kappa1*(438 + delta*(438 + 103*Nu) + Nu*(-773 + 108*Nu))*
               S1z) + 2*(Complex(0,-7)*(-1 + delta + 2*Nu) + 
              (995 - 192*Nu)*Nu*S1z)*S2z - 
           (42*Nu*(-1 + delta + 2*Nu) + 
              kappa2*(-438 + (773 - 108*Nu)*Nu + delta*(438 + 103*Nu)))
             *pow(S2z,2)) + 
         r*(pow(rDOT,2)*(Complex(0,56)*(1 + delta - 2*Nu)*S1z + 
              (-56*(1 + delta - 2*Nu)*Nu + 
                 kappa1*(291*(1 + delta) - 2*(445 + 154*delta)*Nu + 
                    24*pow(Nu,2)))*pow(S1z,2) + 
              4*Nu*(-3 + 44*Nu)*S1z*S2z + 
              S2z*(Complex(0,-56)*(-1 + delta + 2*Nu) + 
                 56*Nu*(-1 + delta + 2*Nu)*S2z + 
                 kappa2*(291 - 890*Nu + 24*pow(Nu,2) + 
                    delta*(-291 + 308*Nu))*S2z)) + 
           pow(PhiDOT,2)*pow(r,2)*
            (Complex(0,196)*(1 + delta - 2*Nu)*S1z + 
              (56*Nu*(7 + 7*delta + Nu) + 
                 kappa1*(-153*(1 + delta) - 2*(62 + 215*delta)*Nu + 
                    804*pow(Nu,2)))*pow(S1z,2) + 
              8*(60 - 187*Nu)*Nu*S1z*S2z + 
              S2z*(Complex(0,-196)*(-1 + delta + 2*Nu) + 
                 56*Nu*(7 - 7*delta + Nu)*S2z + 
                 kappa2*(-153 + 4*Nu*(-31 + 201*Nu) + 
                    delta*(153 + 430*Nu))*S2z)) + 
           2*PhiDOT*r*rDOT*(Complex(0,-1)*
               (117*(1 + delta)*kappa1 - 434*(1 + delta)*Nu + 
                 (-23 + 211*delta)*kappa1*Nu + 
                 2*(14 - 195*kappa1)*pow(Nu,2))*pow(S1z,2) + 
              4*S1z*(35*(1 + delta - 2*Nu) + 
                 Complex(0,1)*(9 - 209*Nu)*Nu*S2z) + 
              S2z*(-140*(-1 + delta + 2*Nu) + 
                 Complex(0,1)*
                  (-14*Nu*(-31 + 31*delta + 2*Nu) + 
                    kappa2*(117*(-1 + delta) + (23 + 211*delta)*Nu + 
                       390*pow(Nu,2)))*S2z)))))/pow(r,4)));
    }
    else if(vpnorder==7){

        return(/* Henry et al QC spin terms *//* ((3318*pow(Nu,3)*(S1z + S2z) + Nu*(-504*((7 + delta)*kappa1 - 3*(3 + delta)*lambda1)*pow(S1z,3) - 
          ...
          + */ /* Henry et al. ecc+spin terms */ ((pow(mass,2)*(-3*mass*r*(Complex(0,-16)*pow(rDOT,3)*
           (Complex(0,12)*Nu*(-16703 + 4427*Nu) + 
             35*Nu*(4578 + Nu*(-4288 + 765*Nu) + 
                delta*(3748 + 802*Nu))*S1z + 
             35*(delta*(942 - 2*Nu*(1874 + 401*Nu)) + 
                Nu*(4578 + Nu*(-4288 + 765*Nu)))*S2z - 
             32970*(S1z + delta*S1z + S2z)) + 
          4*PhiDOT*r*pow(rDOT,2)*
           (-338520*pow(Nu,3)*(S1z + S2z) + 
             48930*(S1z + delta*S1z + S2z - delta*S2z) + 
             Nu*(Complex(0,3420696) - 35*(14154 + 21167*delta)*S1z - 
          ...
          Complex(0,8)*pow(PhiDOT,2)*pow(r,2)*rDOT*
           (779100*pow(Nu,3)*(S1z + S2z) + 
            ...
            3*pow(r,2)*(Complex(0,4)*pow(PhiDOT,2)*pow(r,2)*
           pow(rDOT,3)*(Complex(0,2)*(65451 - 350563*Nu)*Nu + 
             105*Nu*(6020 + delta*(3114 + 411*Nu) + 
                Nu*(-4513 + 9136*Nu))*S1z + 
             105*(-3*delta*(-408 + Nu*(1038 + 137*Nu)) + 
                Nu*(6020 + Nu*(-4513 + 9136*Nu)))*S2z - 
             128520*(S1z + delta*S1z + S2z)) + 
          PhiDOT*r*pow(rDOT,4)*
           (Complex(0,-128)*Nu*(2487 + 18334*Nu) - 
             105*Nu*(8689 + 8*Nu*(-687 + 1402*Nu) + 
                delta*(2143 + 8212*Nu))*S1z + 
             105*(Nu*(-8689 + 8*(687 - 1402*Nu)*Nu) + 
                delta*(-1470 + Nu*(2143 + 8212*Nu)))*S2z + 
             154350*(S1z + delta*S1z + S2z)) - 
          Complex(0,6)*pow(rDOT,5)*
           (-11760*pow(Nu,3)*(S1z + S2z) + 
             4*pow(Nu,2)*(Complex(0,57338) + 
                35*(569 + 301*delta)*S1z + 35*(569 - 301*delta)*S2z) - 
             16*Nu*(Complex(0,-2517) + 35*(72 + 71*delta)*S1z + 
                35*(72 - 71*delta)*S2z) + 
             8715*(S1z + delta*S1z + S2z - delta*S2z)) + 
          pow(PhiDOT,5)*pow(r,5)*
           (2263380*pow(Nu,3)*(S1z + S2z) + 
             3*Nu*(Complex(0,653432) + 35*(13283 + 7839*delta)*S1z + 
                35*(13283 - 7839*delta)*S2z) - 
             219240*(S1z + delta*S1z + S2z - delta*S2z) + 
             4*pow(Nu,2)*(Complex(0,-291268) + 
                105*(-7669 + 165*delta)*S1z - 
                105*(7669 + 165*delta)*S2z)) + 
          Complex(0,14)*pow(PhiDOT,4)*pow(r,4)*rDOT*
           (385170*pow(Nu,3)*(S1z + S2z) + 
             15*Nu*(Complex(0,16914) + (8633 + 2267*delta)*S1z + 
                8633*S2z - 2267*delta*S2z) - 
             18630*(S1z + delta*S1z + S2z - delta*S2z) + 
             2*pow(Nu,2)*(Complex(0,-67904) + 
                15*(-13932 + 679*delta)*S1z - 
                15*(13932 + 679*delta)*S2z)) + 
          6*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
           (-6720*pow(Nu,3)*(S1z + S2z) + 
             5*Nu*(Complex(0,-241704) + 7*(4377 + 3083*delta)*S1z + 
                7*(4377 - 3083*delta)*S2z) - 
             36960*(S1z + delta*S1z + S2z - delta*S2z) + 
             pow(Nu,2)*(Complex(0,-364384) + 
                35*(5059 - 4753*delta)*S1z + 35*(5059 + 4753*delta)*S2z
                ))) + 14*pow(mass,2)*
        (Complex(0,30)*rDOT*(15280*pow(Nu,3)*(S1z + S2z) - 
             4*pow(Nu,2)*(Complex(0,-111) + 3562*S1z + 
                682*delta*S1z + 945*kappa1*pow(S1z,3) + 
                (3562 - 682*delta + 945*(-2 + kappa1)*pow(S1z,2))*
                 S2z + 945*(-2 + kappa2)*S1z*pow(S2z,2) + 
                945*kappa2*pow(S2z,3)) + 
             Nu*(Complex(0,-27520) + 
                378*(5*(1 + delta)*kappa1 + 3*(3 + delta)*lambda1)*
                 pow(S1z,3) + (29749 - 13605*delta)*S2z - 
                1512*(1 + delta)*kappa1*pow(S1z,2)*S2z - 
                378*(5*(-1 + delta)*kappa2 + 3*(-3 + delta)*lambda2)*
                 pow(S2z,3) + 
                S1z*(29749 + 13605*delta + 
                   1512*(-1 + delta)*kappa2*pow(S2z,2))) + 
             2*(-8009*(1 + delta)*S1z - 
                567*(1 + delta)*lambda1*pow(S1z,3) + 
                (-1 + delta)*S2z*(8009 + 567*lambda2*pow(S2z,2)))) + 
          PhiDOT*r*(285840*pow(Nu,3)*(S1z + S2z) - 
             30*pow(Nu,2)*(Complex(0,11504) + 
                1890*kappa1*pow(S1z,3) + 23090*S2z - 
                1823*delta*S2z + 1890*(-2 + kappa1)*pow(S1z,2)*S2z + 
                1890*kappa2*pow(S2z,3) + 
                S1z*(23090 + 1823*delta + 
                   1890*(-2 + kappa2)*pow(S2z,2))) + 
             30*(689*(1 + delta)*S1z - 
                1134*(1 + delta)*lambda1*pow(S1z,3) + 
                (-1 + delta)*S2z*(-689 + 1134*lambda2*pow(S2z,2))) + 
             2*Nu*(Complex(0,415432) - 66840*S2z + 
                15*(8*(-557 + 1342*delta)*S1z + 
                   189*(5*(1 + delta)*kappa1 + 6*(3 + delta)*lambda1)*
                    pow(S1z,3) - 10736*delta*S2z - 
                   2457*(1 + delta)*kappa1*pow(S1z,2)*S2z + 
                   2457*(-1 + delta)*kappa2*S1z*pow(S2z,2) - 
                   189*(5*(-1 + delta)*kappa2 + 
                      6*(-3 + delta)*lambda2)*pow(S2z,3)))))))/
   (317520.*pow(r,4))));
    }
...
static COMPLEX16 hQC_2_m_2(REAL8 Nu, UINT4 vpnorder, REAL8 x){
   ...
   // keeping only the hereditary terms
    ...
    // 4PN non-spinning quasi-circular (2,2) mode has been obtained from Blanchet et al. arXiv:2304.11185
    ...
    if(vpnorder == 1){
     ...
     (2*mass*((77 + 17*Nu + 11*delta*(7 + Nu))*S1z + 
       ...
       r*(Complex(0,-2)*PhiDOT*r*rDOT*
        ...
        /* Henry et al QC spin terms *//* + (Complex(0,-0.08333333333333333)*pow(x,3.5)*(2*(-((1 + delta)*(5 + kappa1)) 
        ...
        + /* Henry et al. ecc spin terms */ ((pow(mass,3)*(-4*rDOT*(kappa1*(1 + delta - 2*Nu)*pow(S1z,2) + 
          kappa2*(-1 + delta + 2*Nu)*pow(S2z,2)) - 
        Complex(0,1)*PhiDOT*r*
        ((-((1 + delta)*(9 + kappa1)) + 
             2*(9 + (4 + 3*delta)*kappa1)*Nu)*pow(S1z,2) - 
          12*delta*Nu*S1z*S2z + 
          (9 + kappa2 - 2*(9 + 4*kappa2)*Nu + 
             delta*(-9 - kappa2 + 6*kappa2*Nu))*pow(S2z,2))))/
        (6.*pow(r,3))));
    }
      ...
      Nu*(378*(3 + delta)*kappa1*pow(S1z,3) + 378*(1 + delta)*(-2 + kappa1)*pow(S1z,2)*S2z + S1z*(8351 + 7027*delta + 378*(-1 + delta)*(-2 + kappa2)*pow(S2z,2)) + 
        ...
        + /* Henry et al. ecc spin terms */ (Complex(0,0.00033068783068783067)*pow(mass,2)*
        (3*pow(r,2)*(Complex(0,4)*PhiDOT*r*pow(rDOT,3)*
           ((-315*(1 + delta) + 2*(251 + 463*delta)*Nu + 
                4*(15 + delta)*pow(Nu,2))*S1z + 
             (315 - 315*delta - 502*Nu + 926*delta*Nu + 
                4*(-15 + delta)*pow(Nu,2))*S2z) + 
          12*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
           ((189*(1 + delta) - 2*(521 + 293*delta)*Nu + 
                7*(55 + 23*delta)*pow(Nu,2))*S1z + 
             (189*(-1 + delta) + 2*(521 - 293*delta)*Nu + 
                7*(-55 + 23*delta)*pow(Nu,2))*S2z) + 
          pow(rDOT,4)*((567*(1 + delta) - 16*(77 + 64*delta)*Nu + 
                8*(177 + 173*delta)*pow(Nu,2))*S1z + 
             (567*(-1 + delta) + 16*(77 - 64*delta)*Nu + 
                8*(-177 + 173*delta)*pow(Nu,2))*S2z) - 
          Complex(0,4)*pow(PhiDOT,3)*pow(r,3)*rDOT*
           ((936*(1 + delta) - 5*(979 + 215*delta)*Nu + 
                2*(1353 + 293*delta)*pow(Nu,2))*S1z + 
             (936*(-1 + delta) + 5*(979 - 215*delta)*Nu + 
                2*(-1353 + 293*delta)*pow(Nu,2))*S2z) + 
          4*pow(PhiDOT,4)*pow(r,4)*
           ((-252*(1 + delta) + (1315 + 857*delta)*Nu + 
                4*(-285 + 43*delta)*pow(Nu,2))*S1z + 
             (252 + 5*Nu*(-263 + 228*Nu) + 
                delta*(-252 + Nu*(857 + 172*Nu)))*S2z)) - 
       2*mass*r*(Complex(0,-1)*PhiDOT*r*rDOT*
           ((2043*(1 + delta) + (37 + 2597*delta)*Nu + 
                (10635 + 139*delta)*pow(Nu,2))*S1z + 
             (2043*(-1 + delta) + (-37 + 2597*delta)*Nu + 
                (-10635 + 139*delta)*pow(Nu,2))*S2z) + 
          pow(PhiDOT,2)*pow(r,2)*
           ((-765 - Nu*(667 + 7773*Nu) + 
                delta*(-765 + 7*Nu*(-533 + 245*Nu)))*S1z + 
             (765 + Nu*(667 + 7773*Nu) + 
                delta*(-765 + 7*Nu*(-533 + 245*Nu)))*S2z) + 
          4*pow(rDOT,2)*((-234*(1 + delta) - 
                4*(560 + 901*delta)*Nu + (483 + 1111*delta)*pow(Nu,2)
                )*S1z + (234 + 7*(320 - 69*Nu)*Nu + 
                delta*(-234 + Nu*(-3604 + 1111*Nu)))*S2z)) + 
       2*pow(mass,2)*(1134*kappa1*(-1 - delta + (3 + delta)*Nu)*
           pow(S1z,3) + 1134*(1 + delta)*(-2 + kappa1)*Nu*
           pow(S1z,2)*S2z + 
          S1z*(-5661 - 5661*delta - 17156*Nu - 9172*delta*Nu + 
             231*pow(Nu,2) + 775*delta*pow(Nu,2) + 
             1134*(-1 + delta)*(-2 + kappa2)*Nu*pow(S2z,2)) + 
          S2z*(5661 - 5661*delta + 17156*Nu - 9172*delta*Nu - 
             231*pow(Nu,2) + 775*delta*pow(Nu,2) + 
             1134*kappa2*(1 - delta + (-3 + delta)*Nu)*pow(S2z,2)))))
            /pow(r,4));
    }

    else if(vpnorder == 7){

        return(/* Henry et al. QC spin terms */ /* Complex(0,0.0003968253968253968)*pow(x,4.5)*(10*(6*(1 + delta)*(63 + 26*kappa1) - (84*(26 + 17*delta) + (1069 + 757*delta)*kappa1)*Nu + 
        ...
        3*S1z*(Complex(0,-1)*(66 + 66*delta - 2957*Nu - 280*log(2)) + 5*
         ...
         + */ /* Henry et al. ecc+spin terms */ ((Complex(0,-1.0020843354176688e-7)*
        (-23760*pow(mass,3)*(pow(PhiDOT,3)*pow(r,4)*
           (Complex(0,-12)*(-35 + 107*Nu)*S1z + 
             5*(126 - 462*Nu + 80*pow(Nu,2) + 
                kappa1*(-2 - 79*Nu + 153*pow(Nu,2)))*pow(S1z,2) + 
             S2z*(Complex(0,-420) + Complex(0,1284)*Nu + 
                10*(-63 + kappa2)*S2z + 5*(462 + 79*kappa2)*Nu*S2z - 
                5*(80 + 153*kappa2)*pow(Nu,2)*S2z)) - 
          Complex(0,1)*pow(PhiDOT,2)*pow(r,3)*rDOT*
           (Complex(0,-24)*(-35 + 202*Nu)*S1z + 
             5*(-14*Nu*(3 + 58*Nu) + 
                kappa1*(-409 + 1096*Nu + 6*pow(Nu,2)))*pow(S1z,2)\
              + S2z*(Complex(0,-840) + 2045*kappa2*S2z + 
                10*(406 - 3*kappa2)*pow(Nu,2)*S2z + 
                Nu*(Complex(0,4848) + 210*S2z - 5480*kappa2*S2z))) - 
          Complex(0,4)*r*pow(rDOT,3)*
           (Complex(0,3)*(26 + 57*Nu)*S1z + 
             5*(4*pow(Nu,2) + kappa1*(-7 + 49*Nu + 15*pow(Nu,2)))*
              pow(S1z,2) - 
          ...
          Complex(0,2)*mass*rDOT*
           (Complex(0,-4)*(-78 + 769*Nu)*S1z + 
             5*((14 - 59*Nu)*Nu + 
                kappa1*(-70 - 77*Nu + 18*pow(Nu,2)))*pow(S1z,2) + 
             S2z*(Complex(0,-312) + 350*kappa2*S2z + 
                5*(59 - 18*kappa2)*pow(Nu,2)*S2z + 
                Nu*(Complex(0,3076) - 70*S2z + 385*kappa2*S2z))) + 
          PhiDOT*pow(r,2)*pow(rDOT,2)*
           (Complex(0,6)*(-62 + 219*Nu)*S1z - 
             5*(189 - 756*Nu + 388*pow(Nu,2) + 
                kappa1*(98 - 266*Nu + 276*pow(Nu,2)))*pow(S1z,2) + 
             S2z*(Complex(0,372) + 945*S2z + 490*kappa2*S2z + 
                20*(97 + 69*kappa2)*pow(Nu,2)*S2z - 
                2*Nu*(Complex(0,657) + 35*(54 + 19*kappa2)*S2z))) + 
          mass*PhiDOT*r*(Complex(0,8)*(-61 + 480*Nu)*S1z + 
             5*(-392 + 448*Nu + 474*pow(Nu,2) + 
                kappa1*(-11 + 150*Nu + 58*pow(Nu,2)))*pow(S1z,2) - 
             S2z*(Complex(0,-488) - 5*(392 + 11*kappa2)*S2z + 
                10*(237 + 29*kappa2)*pow(Nu,2)*S2z + 
                10*Nu*(Complex(0,384) + (224 + 75*kappa2)*S2z)))) + 
       delta*mass*(-240*mass*PhiDOT*pow(r,3)*
           ((197936 - 139360*Nu - 367105*pow(Nu,2) + 
                253245*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4) + 
             Complex(0,1)*(279236 - 483940*Nu - 2817805*pow(Nu,2) + 
                459180*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*rDOT - 
             6*(38627 + 89295*Nu - 492740*pow(Nu,2) + 
                75975*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,2) - 
             Complex(0,1)*(-731008 + 2287930*Nu + 981060*pow(Nu,2) + 
                10275*pow(Nu,3))*PhiDOT*r*pow(rDOT,3) + 
             (-327667 + 436705*Nu + 659790*pow(Nu,2) - 
                438255*pow(Nu,3))*pow(rDOT,4)) + 
          900*PhiDOT*pow(r,4)*
           (2*(-2594 + 27609*Nu - 74032*pow(Nu,2) + 
                25974*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6) + 
             Complex(0,4)*(-5730 + 58833*Nu - 137842*pow(Nu,2) + 
                17123*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*rDOT + 
             2*(-114 - 41622*Nu + 147569*pow(Nu,2) + 
                4196*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
              pow(rDOT,2) + 
             Complex(0,4)*(-9554 + 70788*Nu - 156227*pow(Nu,2) + 
                5810*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
              pow(rDOT,3) + 
             (17619 - 138450*Nu + 322600*pow(Nu,2) - 
                80816*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,4) - 
             Complex(0,2)*(8793 - 52230*Nu + 69340*pow(Nu,2) + 
                2536*pow(Nu,3))*PhiDOT*r*pow(rDOT,5) + 
             2*(3957 - 24534*Nu + 42584*pow(Nu,2) - 
                20800*pow(Nu,3))*pow(rDOT,6)) - 
          2*pow(mass,3)*(Complex(0,-23760)*rDOT*
              (5*(Nu*(-14 + 31*Nu) + 7*kappa1*(10 + 31*Nu))*
                 pow(S1z,2) + 
                2*S1z*(Complex(0,-156) + 155*pow(Nu,2)*S2z + 
                   2*Nu*(Complex(0,613) + 390*S2z)) + 
                S2z*(Complex(0,-312) + 350*kappa2*S2z + 
                   155*pow(Nu,2)*S2z + 
                   Nu*(Complex(0,2452) + 35*(-2 + 31*kappa2)*S2z))) + 
             PhiDOT*r*(8946400*pow(Nu,3) - 
                8*(6991786 + Complex(0,724680)*S1z + 
                   7425*(392 + 11*kappa1)*pow(S1z,2) + 
                   Complex(0,724680)*S2z + 
                   7425*(392 + 11*kappa2)*pow(S2z,2)) - 
                3600*pow(Nu,2)*
                 (-628 + 33*(-19 + 92*kappa1)*pow(S1z,2) - 
                   7326*S1z*S2z + 33*(-19 + 92*kappa2)*pow(S2z,2)) + 
                15*Nu*(994455*pow(M_PI,2) + 
                   8*(-2249485 + 7920*(-21 + 8*kappa1)*pow(S1z,2) + 
                      Complex(0,283536)*S2z + 
                      7920*(-21 + 8*kappa2)*pow(S2z,2) - 
                      1584*S1z*(Complex(0,-179) + 170*S2z))))) + 
          3*pow(mass,2)*r*(Complex(0,31680)*pow(rDOT,3)*
              (5*(4*pow(Nu,2) + 7*kappa1*(-1 + 5*Nu))*pow(S1z,2) + 
                S1z*(Complex(0,78) + 40*pow(Nu,2)*S2z + 
                   Nu*(Complex(0,327) + 420*S2z)) + 
                S2z*(Complex(0,78) - 35*kappa2*S2z + 
                   20*pow(Nu,2)*S2z + 
                   Nu*(Complex(0,327) + 175*kappa2*S2z))) - 
             22*PhiDOT*r*pow(rDOT,2)*
              (2553200*pow(Nu,3) - 
                ...
                200*pow(Nu,2)*
                 (39445 + 72*(-4 + 21*kappa1)*pow(S1z,2) - 
                   3600*S1z*S2z + 72*(-4 + 21*kappa2)*pow(S2z,2)) + 
                25*Nu*(23247*pow(M_PI,2) + 
                   8*(-69259 + Complex(0,1026)*S1z + 
                      126*(27 + 5*kappa1)*pow(S1z,2) + 
                      Complex(0,1026)*S2z + 
                      126*(27 + 5*kappa2)*pow(S2z,2)))) + 
             pow(PhiDOT,3)*pow(r,3)*
              (10071200*pow(Nu,3) + 
                ...
                400*pow(Nu,2)*
                 (64177 + 792*(-5 + 6*kappa1)*pow(S1z,2) - 
                   17424*S1z*S2z + 792*(-5 + 6*kappa2)*pow(S2z,2)) + 
                15*Nu*(426195*pow(M_PI,2) + 
                   8*(-509635 + 330*(210 + 83*kappa1)*pow(S1z,2) + 
                      Complex(0,29304)*S2z + 
                      330*(210 + 83*kappa2)*pow(S2z,2) - 
                      792*S1z*(Complex(0,-37) + 70*S2z)))) - 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (-8330400*pow(Nu,3) + 
                8*(-2810116 - Complex(0,415800)*S1z + 
                   1012275*kappa1*pow(S1z,2) - 
                   Complex(0,415800)*S2z + 1012275*kappa2*pow(S2z,2))
                  + 4800*pow(Nu,2)*
                 (13411 + 33*(19 + 12*kappa1)*pow(S1z,2) + 
                   462*S1z*S2z + 33*(19 + 12*kappa2)*pow(S2z,2)) + 
                5*Nu*(1278585*pow(M_PI,2) - 
                   8*(5139685 + 990*(-21 + 139*kappa1)*pow(S1z,2) - 
                      Complex(0,313632)*S2z + 
                      990*(-21 + 139*kappa2)*pow(S2z,2) - 
                      3564*S1z*(Complex(0,88) + 185*S2z)))))) - 
                13559040*delta*pow(mass,3)*PhiDOT*r*
                (2*mass - 3*pow(PhiDOT,2)*pow(r,3) + 
                Complex(0,6)*PhiDOT*pow(r,2)*rDOT + 6*r*pow(rDOT,2))*
                log(r/r0)))/pow(r,4)));
    }
    ...
    if(vpnorder == 1){
     ...
     (4*mass*(-1 + 5*Nu)*((1 + delta)*S1z + (-1 + delta)*S2z) + 
       r*(2*pow(rDOT,2)*(6*(1 + delta)*S1z - 5*(5 + 3*delta)*Nu*S1z + 
        ...
        + /* Henry et al. ecc spin terms */ ((Complex(0,0.125)*sqrt(1.0714285714285714)*pow(mass,3)*
        (7*PhiDOT*r + Complex(0,2)*rDOT)*
        (kappa1*(-1 - delta + 2*(2 + delta)*Nu)*pow(S1z,2) + 
        S2z*(-4*delta*Nu*S1z + 
          kappa2*(1 - delta + 2*(-2 + delta)*Nu)*S2z)))/pow(r,3)));
    }
        ...
        +/* Henry et al. ecc spin terms*/ ((Complex(0,-0.006944444444444444)*pow(mass,2)*
     (10*pow(mass,2)*((252*(1 + delta) - (1277 + 1279*delta)*Nu + 
             8*(12 + 47*delta)*pow(Nu,2))*S1z + 
          (252*(-1 + delta) + (1277 - 1279*delta)*Nu + 
             8*(-12 + 47*delta)*pow(Nu,2))*S2z) + 
       2*mass*r*(2*pow(PhiDOT,2)*pow(r,2)*
           ((1320*(1 + delta) - 2*(4469 + 211*delta)*Nu + 
                (8709 + 2777*delta)*pow(Nu,2))*S1z + 
             (1320*(-1 + delta) + 8938*Nu - 422*delta*Nu + 
                (-8709 + 2777*delta)*pow(Nu,2))*S2z) + 
          Complex(0,3)*PhiDOT*r*rDOT*
           ((2000*(1 + delta) - (9147 + 3173*delta)*Nu + 
                (8911 + 5273*delta)*pow(Nu,2))*S1z + 
             (2000*(-1 + delta) + (9147 - 3173*delta)*Nu + 
                (-8911 + 5273*delta)*pow(Nu,2))*S2z) + 
          10*pow(rDOT,2)*((-105*(1 + delta) + (541 + 77*delta)*Nu - 
                2*(462 + 247*delta)*pow(Nu,2))*S1z + 
             (105 + Nu*(-541 + 924*Nu) + 
                delta*(-105 + (77 - 494*Nu)*Nu))*S2z)) - 
       3*pow(r,2)*(-3*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
           ((480*(1 + delta) - (1711 + 1889*delta)*Nu + 
                2*(-1161 + 757*delta)*pow(Nu,2))*S1z + 
             (480*(-1 + delta) + (1711 - 1889*delta)*Nu + 
                2*(1161 + 757*delta)*pow(Nu,2))*S2z) + 
          2*pow(PhiDOT,4)*pow(r,4)*
           ((350*(1 + delta) - 4*(404 + 461*delta)*Nu + 
                (883 + 769*delta)*pow(Nu,2))*S1z + 
             (350*(-1 + delta) + 4*(404 - 461*delta)*Nu + 
                (-883 + 769*delta)*pow(Nu,2))*S2z) + 
          Complex(0,2)*pow(PhiDOT,3)*pow(r,3)*rDOT*
           ((660*(1 + delta) - (4061 + 2899*delta)*Nu + 
                (2643 + 4789*delta)*pow(Nu,2))*S1z + 
             (660*(-1 + delta) + (4061 - 2899*delta)*Nu + 
                (-2643 + 4789*delta)*pow(Nu,2))*S2z) + 
          10*pow(rDOT,4)*((-30*(1 + delta) + (187 + 101*delta)*Nu - 
                2*(159 + 61*delta)*pow(Nu,2))*S1z + 
             (30 + Nu*(-187 + 318*Nu) + 
        ...
        return(/* Henry et al. QC spin terms *//* (Complex(0,-0.020833333333333332)*pow(x,4.5)*(-270*(-6*Nu*(-2 + delta*(-2 + Nu) + 6*Nu) 
       ...
       + 81*(-29 + 80*log(1.5))) - 5*(54*kappa2*(-4 + Nu*(13 + 8*Nu) + delta*(4 + Nu*(-5 + 12*Nu)))*S2z + 
        ...
        + *//* Henry et al. ecc spin terms */ ((Complex(0,-1185355664)*delta*pow(mass,4)*PhiDOT*r + 
     Complex(0,19113759672)*delta*pow(mass,4)*Nu*PhiDOT*r + 
     Complex(0,3969352800)*delta*pow(mass,4)*pow(Nu,2)*PhiDOT*r - 
     Complex(0,2352344960)*delta*pow(mass,4)*pow(Nu,3)*PhiDOT*r - 
     Complex(0,1318647330)*delta*pow(mass,4)*Nu*PhiDOT*pow(M_PI,2)*
      r - Complex(0,22793614888)*delta*pow(mass,3)*pow(PhiDOT,3)*
      pow(r,4) - Complex(0,14805594384)*delta*pow(mass,3)*Nu*
      pow(PhiDOT,3)*pow(r,4) + 
     Complex(0,17247152496)*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4) - 
     Complex(0,4538040136)*delta*pow(mass,3)*pow(Nu,3)*
      pow(PhiDOT,3)*pow(r,4) + 
     Complex(0,1047161115)*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*
      pow(M_PI,2)*pow(r,4) - 
     Complex(0,1261450680)*delta*pow(mass,2)*pow(PhiDOT,5)*
      pow(r,7) - Complex(0,1550483088)*delta*pow(mass,2)*Nu*
      pow(PhiDOT,5)*pow(r,7) - 
     Complex(0,12032636784)*delta*pow(mass,2)*pow(Nu,2)*
      pow(PhiDOT,5)*pow(r,7) + 
     Complex(0,11369279880)*delta*pow(mass,2)*pow(Nu,3)*
      pow(PhiDOT,5)*pow(r,7) - 
     Complex(0,843498936)*delta*mass*pow(PhiDOT,7)*pow(r,10) + 
     Complex(0,4256584920)*delta*mass*Nu*pow(PhiDOT,7)*pow(r,10) - 
     Complex(0,1491042168)*delta*mass*pow(Nu,2)*pow(PhiDOT,7)*
      pow(r,10) - Complex(0,14039235000)*delta*mass*pow(Nu,3)*
      pow(PhiDOT,7)*pow(r,10) - 
     Complex(0,72024120)*delta*pow(PhiDOT,9)*pow(r,13) + 
     Complex(0,1028606040)*delta*Nu*pow(PhiDOT,9)*pow(r,13) - 
     Complex(0,4749393600)*delta*pow(Nu,2)*pow(PhiDOT,9)*
      pow(r,13) + Complex(0,7155083880)*delta*pow(Nu,3)*
      pow(PhiDOT,9)*pow(r,13) - 
     2785731616*delta*pow(mass,4)*rDOT - 
     19096796208*delta*pow(mass,4)*Nu*rDOT + 
     2889549600*delta*pow(mass,4)*pow(Nu,2)*rDOT + 
     2154236000*delta*pow(mass,4)*pow(Nu,3)*rDOT - 
     310269960*delta*pow(mass,4)*Nu*pow(M_PI,2)*rDOT - 
     39023353392*delta*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*rDOT - 
     80731803768*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*
      rDOT - 17097894576*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,2)*pow(r,3)*rDOT + 
     14213404128*delta*pow(mass,3)*pow(Nu,3)*pow(PhiDOT,2)*
      pow(r,3)*rDOT + 2094322230*delta*pow(mass,3)*Nu*
      pow(PhiDOT,2)*pow(M_PI,2)*pow(r,3)*rDOT + 
     1453055016*delta*pow(mass,2)*pow(PhiDOT,4)*pow(r,6)*rDOT + 
     1040107320*delta*pow(mass,2)*Nu*pow(PhiDOT,4)*pow(r,6)*
      rDOT + 28147816368*delta*pow(mass,2)*pow(Nu,2)*
      pow(PhiDOT,4)*pow(r,6)*rDOT - 
     31650208968*delta*pow(mass,2)*pow(Nu,3)*pow(PhiDOT,4)*
      pow(r,6)*rDOT + 2191889952*delta*mass*pow(PhiDOT,6)*
      pow(r,9)*rDOT - 8043511896*delta*mass*Nu*pow(PhiDOT,6)*
      pow(r,9)*rDOT - 8327399472*delta*mass*pow(Nu,2)*
      pow(PhiDOT,6)*pow(r,9)*rDOT + 
     41464802736*delta*mass*pow(Nu,3)*pow(PhiDOT,6)*pow(r,9)*
      rDOT + 216072360*delta*pow(PhiDOT,8)*pow(r,12)*rDOT - 
     3085818120*delta*Nu*pow(PhiDOT,8)*pow(r,12)*rDOT + 
     14248180800*delta*pow(Nu,2)*pow(PhiDOT,8)*pow(r,12)*rDOT - 
     21465251640*delta*pow(Nu,3)*pow(PhiDOT,8)*pow(r,12)*rDOT - 
     Complex(0,13151848488)*delta*pow(mass,3)*PhiDOT*pow(r,2)*
      pow(rDOT,2) - Complex(0,44552849880)*delta*pow(mass,3)*Nu*
      PhiDOT*pow(r,2)*pow(rDOT,2) + 
     Complex(0,34120269960)*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*
      pow(r,2)*pow(rDOT,2) + 
     Complex(0,12430743360)*delta*pow(mass,3)*pow(Nu,3)*PhiDOT*
      pow(r,2)*pow(rDOT,2) - 
     Complex(0,1396214820)*delta*pow(mass,3)*Nu*PhiDOT*pow(M_PI,2)*
      pow(r,2)*pow(rDOT,2) - 
     Complex(0,1505473032)*delta*pow(mass,2)*pow(PhiDOT,3)*
      pow(r,5)*pow(rDOT,2) + 
     Complex(0,37344713784)*delta*pow(mass,2)*Nu*pow(PhiDOT,3)*
      pow(r,5)*pow(rDOT,2) + 
     Complex(0,13094522448)*delta*pow(mass,2)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,5)*pow(rDOT,2) - 
     Complex(0,26092301256)*delta*pow(mass,2)*pow(Nu,3)*
      pow(PhiDOT,3)*pow(r,5)*pow(rDOT,2) + 
     Complex(0,138544560)*delta*mass*pow(PhiDOT,5)*pow(r,8)*
      pow(rDOT,2) + Complex(0,4358794608)*delta*mass*Nu*
      pow(PhiDOT,5)*pow(r,8)*pow(rDOT,2) - 
     Complex(0,18768067416)*delta*mass*pow(Nu,2)*pow(PhiDOT,5)*
      pow(r,8)*pow(rDOT,2) + 
     Complex(0,15545599272)*delta*mass*pow(Nu,3)*pow(PhiDOT,5)*
      pow(r,8)*pow(rDOT,2) + 
     2404072928*delta*pow(mass,3)*r*pow(rDOT,3) + 
     10508955072*delta*pow(mass,3)*Nu*r*pow(rDOT,3) - 
     14722579200*delta*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3) - 
     5437337920*delta*pow(mass,3)*pow(Nu,3)*r*pow(rDOT,3) + 
     465404940*delta*pow(mass,3)*Nu*pow(M_PI,2)*r*pow(rDOT,3) + 
     6183481080*delta*pow(mass,2)*pow(PhiDOT,2)*pow(r,4)*
      pow(rDOT,3) - 39017968920*delta*pow(mass,2)*Nu*
      pow(PhiDOT,2)*pow(r,4)*pow(rDOT,3) - 
     28888531728*delta*pow(mass,2)*pow(Nu,2)*pow(PhiDOT,2)*
      pow(r,4)*pow(rDOT,3) - 
     26899279512*delta*pow(mass,2)*pow(Nu,3)*pow(PhiDOT,2)*
      pow(r,4)*pow(rDOT,3) + 
     4926654432*delta*mass*pow(PhiDOT,4)*pow(r,7)*pow(rDOT,3) - 
     29317397760*delta*mass*Nu*pow(PhiDOT,4)*pow(r,7)*
      pow(rDOT,3) + 20376994176*delta*mass*pow(Nu,2)*
      pow(PhiDOT,4)*pow(r,7)*pow(rDOT,3) + 
     79419795840*delta*mass*pow(Nu,3)*pow(PhiDOT,4)*pow(r,7)*
      pow(rDOT,3) + 576192960*delta*pow(PhiDOT,6)*pow(r,10)*
      pow(rDOT,3) - 8228848320*delta*Nu*pow(PhiDOT,6)*pow(r,10)*
      pow(rDOT,3) + 37995148800*delta*pow(Nu,2)*pow(PhiDOT,6)*
      pow(r,10)*pow(rDOT,3) - 
     57240671040*delta*pow(Nu,3)*pow(PhiDOT,6)*pow(r,10)*
      pow(rDOT,3) + Complex(0,6519995160)*delta*pow(mass,2)*PhiDOT*
      pow(r,3)*pow(rDOT,4) - 
     Complex(0,17008270440)*delta*pow(mass,2)*Nu*PhiDOT*pow(r,3)*
      pow(rDOT,4) - Complex(0,35271779760)*delta*pow(mass,2)*
      pow(Nu,2)*PhiDOT*pow(r,3)*pow(rDOT,4) - 
     Complex(0,44062479720)*delta*pow(mass,2)*pow(Nu,3)*PhiDOT*
      pow(r,3)*pow(rDOT,4) + 
     Complex(0,4278077496)*delta*mass*pow(PhiDOT,3)*pow(r,6)*
      pow(rDOT,4) - Complex(0,21302395632)*delta*mass*Nu*
      pow(PhiDOT,3)*pow(r,6)*pow(rDOT,4) - 
     Complex(0,717880968)*delta*mass*pow(Nu,2)*pow(PhiDOT,3)*
      pow(r,6)*pow(rDOT,4) + 
     Complex(0,84202366752)*delta*mass*pow(Nu,3)*pow(PhiDOT,3)*
      pow(r,6)*pow(rDOT,4) + 
     Complex(0,432144720)*delta*pow(PhiDOT,5)*pow(r,9)*
      pow(rDOT,4) - Complex(0,6171636240)*delta*Nu*pow(PhiDOT,5)*
      pow(r,9)*pow(rDOT,4) + 
     Complex(0,28496361600)*delta*pow(Nu,2)*pow(PhiDOT,5)*
      pow(r,9)*pow(rDOT,4) - 
     Complex(0,42930503280)*delta*pow(Nu,3)*pow(PhiDOT,5)*
      pow(r,9)*pow(rDOT,4) - 
     2034527880*delta*pow(mass,2)*pow(r,2)*pow(rDOT,5) + 
     2946144600*delta*pow(mass,2)*Nu*pow(r,2)*pow(rDOT,5) + 
     11954869080*delta*pow(mass,2)*pow(Nu,2)*pow(r,2)*
      pow(rDOT,5) + 16298278080*delta*pow(mass,2)*pow(Nu,3)*
      pow(r,2)*pow(rDOT,5) + 
     1419208560*delta*mass*pow(PhiDOT,2)*pow(r,5)*pow(rDOT,5) - 
     10910085984*delta*mass*Nu*pow(PhiDOT,2)*pow(r,5)*
      pow(rDOT,5) + 17143525728*delta*mass*pow(Nu,2)*
      pow(PhiDOT,2)*pow(r,5)*pow(rDOT,5) + 
     16336785024*delta*mass*pow(Nu,3)*pow(PhiDOT,2)*pow(r,5)*
      pow(rDOT,5) + 432144720*delta*pow(PhiDOT,4)*pow(r,8)*
      pow(rDOT,5) - 6171636240*delta*Nu*pow(PhiDOT,4)*pow(r,8)*
      pow(rDOT,5) + 28496361600*delta*pow(Nu,2)*pow(PhiDOT,4)*
      pow(r,8)*pow(rDOT,5) - 
     42930503280*delta*pow(Nu,3)*pow(PhiDOT,4)*pow(r,8)*
      pow(rDOT,5) + Complex(0,2945606580)*delta*mass*PhiDOT*
      pow(r,4)*pow(rDOT,6) - 
     Complex(0,17313148440)*delta*mass*Nu*PhiDOT*pow(r,4)*
      pow(rDOT,6) + Complex(0,10868991840)*delta*mass*pow(Nu,2)*
      PhiDOT*pow(r,4)*pow(rDOT,6) + 
     Complex(0,52921128960)*delta*mass*pow(Nu,3)*PhiDOT*pow(r,4)*
      pow(rDOT,6) + Complex(0,576192960)*delta*pow(PhiDOT,3)*
      pow(r,7)*pow(rDOT,6) - 
     Complex(0,8228848320)*delta*Nu*pow(PhiDOT,3)*pow(r,7)*
      pow(rDOT,6) + Complex(0,37995148800)*delta*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,7)*pow(rDOT,6) - 
     Complex(0,57240671040)*delta*pow(Nu,3)*pow(PhiDOT,3)*
      pow(r,7)*pow(rDOT,6) - 
     934567200*delta*mass*pow(r,3)*pow(rDOT,7) + 
     5222145600*delta*mass*Nu*pow(r,3)*pow(rDOT,7) - 
     2011101120*delta*mass*pow(Nu,2)*pow(r,3)*pow(rDOT,7) - 
     18368179200*delta*mass*pow(Nu,3)*pow(r,3)*pow(rDOT,7) + 
     Complex(0,216072360)*delta*PhiDOT*pow(r,5)*pow(rDOT,8) - 
     Complex(0,3085818120)*delta*Nu*PhiDOT*pow(r,5)*pow(rDOT,8) + 
     Complex(0,14248180800)*delta*pow(Nu,2)*PhiDOT*pow(r,5)*
      pow(rDOT,8) - Complex(0,21465251640)*delta*pow(Nu,3)*PhiDOT*
      pow(r,5)*pow(rDOT,8) - 
     72024120*delta*pow(r,4)*pow(rDOT,9) + 
     1028606040*delta*Nu*pow(r,4)*pow(rDOT,9) - 
     4749393600*delta*pow(Nu,2)*pow(r,4)*pow(rDOT,9) + 
     7155083880*delta*pow(Nu,3)*pow(r,4)*pow(rDOT,9) - 
     299675376*pow(mass,4)*PhiDOT*r*S1z - 
     299675376*delta*pow(mass,4)*PhiDOT*r*S1z + 
     1758700944*pow(mass,4)*Nu*PhiDOT*r*S1z + 
     1159350192*delta*pow(mass,4)*Nu*PhiDOT*r*S1z - 
     803674872*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*S1z - 
     803674872*delta*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*S1z + 
     1959998040*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*S1z + 
     352648296*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*S1z + 
     Complex(0,108972864)*pow(mass,4)*rDOT*S1z + 
     Complex(0,108972864)*delta*pow(mass,4)*rDOT*S1z - 
     Complex(0,502485984)*pow(mass,4)*Nu*rDOT*S1z - 
     Complex(0,284540256)*delta*pow(mass,4)*Nu*rDOT*S1z + 
     Complex(0,899026128)*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*
      rDOT*S1z + Complex(0,899026128)*delta*pow(mass,3)*
      pow(PhiDOT,2)*pow(r,3)*rDOT*S1z - 
     Complex(0,1407566160)*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*
      rDOT*S1z + Complex(0,390486096)*delta*pow(mass,3)*Nu*
      pow(PhiDOT,2)*pow(r,3)*rDOT*S1z - 
     326918592*pow(mass,3)*PhiDOT*pow(r,2)*pow(rDOT,2)*S1z - 
     326918592*delta*pow(mass,3)*PhiDOT*pow(r,2)*pow(rDOT,2)*
      S1z + 2270268000*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*S1z + 1616430816*delta*pow(mass,3)*Nu*PhiDOT*
      pow(r,2)*pow(rDOT,2)*S1z - 
     Complex(0,54486432)*pow(mass,3)*r*pow(rDOT,3)*S1z - 
     Complex(0,54486432)*delta*pow(mass,3)*r*pow(rDOT,3)*S1z + 
     Complex(0,332972640)*pow(mass,3)*Nu*r*pow(rDOT,3)*S1z + 
     Complex(0,223999776)*delta*pow(mass,3)*Nu*r*pow(rDOT,3)*S1z - 
     Complex(0,121080960)*pow(mass,4)*PhiDOT*r*pow(S1z,2) - 
     Complex(0,121080960)*delta*pow(mass,4)*PhiDOT*r*pow(S1z,2) + 
     Complex(0,2012970960)*kappa1*pow(mass,4)*PhiDOT*r*
      pow(S1z,2) + Complex(0,2012970960)*delta*kappa1*pow(mass,4)*
      PhiDOT*r*pow(S1z,2) + 
     Complex(0,1695133440)*pow(mass,4)*Nu*PhiDOT*r*pow(S1z,2) + 
     Complex(0,1452971520)*delta*pow(mass,4)*Nu*PhiDOT*r*
      pow(S1z,2) - Complex(0,8218370160)*kappa1*pow(mass,4)*Nu*
      PhiDOT*r*pow(S1z,2) - 
     Complex(0,4192428240)*delta*kappa1*pow(mass,4)*Nu*PhiDOT*r*
      pow(S1z,2) - Complex(0,4601076480)*pow(mass,4)*pow(Nu,2)*
      PhiDOT*r*pow(S1z,2) - 
     Complex(0,665945280)*delta*pow(mass,4)*pow(Nu,2)*PhiDOT*r*
      pow(S1z,2) + Complex(0,948467520)*kappa1*pow(mass,4)*
      pow(Nu,2)*PhiDOT*r*pow(S1z,2) + 
     Complex(0,1967565600)*delta*kappa1*pow(mass,4)*pow(Nu,2)*
      PhiDOT*r*pow(S1z,2) - 
     Complex(0,166486320)*kappa1*pow(mass,3)*pow(PhiDOT,3)*
      pow(r,4)*pow(S1z,2) - 
     Complex(0,166486320)*delta*kappa1*pow(mass,3)*pow(PhiDOT,3)*
      pow(r,4)*pow(S1z,2) + 
     Complex(0,908107200)*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*
      pow(S1z,2) + Complex(0,908107200)*delta*pow(mass,3)*Nu*
      pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) + 
     Complex(0,393513120)*kappa1*pow(mass,3)*Nu*pow(PhiDOT,3)*
      pow(r,4)*pow(S1z,2) + 
     Complex(0,60540480)*delta*kappa1*pow(mass,3)*Nu*pow(PhiDOT,3)*
      pow(r,4)*pow(S1z,2) - 
     Complex(0,1937295360)*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,3)*
      pow(r,4)*pow(S1z,2) + 
     Complex(0,151351200)*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) + 
     Complex(0,1352070720)*kappa1*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) + 
     Complex(0,696215520)*delta*kappa1*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) + 
     121080960*pow(mass,4)*rDOT*pow(S1z,2) + 
     121080960*delta*pow(mass,4)*rDOT*pow(S1z,2) + 
     25225200*kappa1*pow(mass,4)*rDOT*pow(S1z,2) + 
     25225200*delta*kappa1*pow(mass,4)*rDOT*pow(S1z,2) - 
     1150269120*pow(mass,4)*Nu*rDOT*pow(S1z,2) - 
     908107200*delta*pow(mass,4)*Nu*rDOT*pow(S1z,2) - 
     15135120*kappa1*pow(mass,4)*Nu*rDOT*pow(S1z,2) + 
     35315280*delta*kappa1*pow(mass,4)*Nu*rDOT*pow(S1z,2) + 
     2239997760*pow(mass,4)*pow(Nu,2)*rDOT*pow(S1z,2) + 
     665945280*delta*pow(mass,4)*pow(Nu,2)*rDOT*pow(S1z,2) - 
     262342080*kappa1*pow(mass,4)*pow(Nu,2)*rDOT*pow(S1z,2) - 
     776936160*delta*kappa1*pow(mass,4)*pow(Nu,2)*rDOT*
      pow(S1z,2) + 756756000*kappa1*pow(mass,3)*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S1z,2) + 
     756756000*delta*kappa1*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*
      rDOT*pow(S1z,2) - 1816214400*pow(mass,3)*Nu*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S1z,2) - 
     1816214400*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*rDOT*
      pow(S1z,2) - 2134051920*kappa1*pow(mass,3)*Nu*
      pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S1z,2) - 
     620539920*delta*kappa1*pow(mass,3)*Nu*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S1z,2) + 
     7900532640*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,2)*pow(r,3)*
      rDOT*pow(S1z,2) + 90810720*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S1z,2) - 
     3450807360*kappa1*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S1z,2) - 
     1241079840*delta*kappa1*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S1z,2) + 
     Complex(0,824864040)*kappa1*pow(mass,3)*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S1z,2) + 
     Complex(0,824864040)*delta*kappa1*pow(mass,3)*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S1z,2) - 
     Complex(0,908107200)*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S1z,2) - 
     Complex(0,908107200)*delta*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S1z,2) - 
     Complex(0,3314591280)*kappa1*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S1z,2) - 
     Complex(0,1664863200)*delta*kappa1*pow(mass,3)*Nu*PhiDOT*
      pow(r,2)*pow(rDOT,2)*pow(S1z,2) + 
     Complex(0,2724321600)*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S1z,2) + 
     Complex(0,181621440)*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*
      pow(r,2)*pow(rDOT,2)*pow(S1z,2) + 
     Complex(0,484323840)*kappa1*pow(mass,3)*pow(Nu,2)*PhiDOT*
      pow(r,2)*pow(rDOT,2)*pow(S1z,2) - 
     Complex(0,696215520)*delta*kappa1*pow(mass,3)*pow(Nu,2)*
      PhiDOT*pow(r,2)*pow(rDOT,2)*pow(S1z,2) - 
     146306160*kappa1*pow(mass,3)*r*pow(rDOT,3)*pow(S1z,2) - 
     146306160*delta*kappa1*pow(mass,3)*r*pow(rDOT,3)*
      pow(S1z,2) + 514594080*kappa1*pow(mass,3)*Nu*r*pow(rDOT,3)*
      pow(S1z,2) + 221981760*delta*kappa1*pow(mass,3)*Nu*r*
      pow(rDOT,3)*pow(S1z,2) + 
     60540480*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*pow(S1z,2) + 
     60540480*delta*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*
      pow(S1z,2) + 242161920*kappa1*pow(mass,3)*pow(Nu,2)*r*
      pow(rDOT,3)*pow(S1z,2) + 
     504504000*delta*kappa1*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*
      pow(S1z,2) + 299675376*pow(mass,4)*PhiDOT*r*S2z - 
     299675376*delta*pow(mass,4)*PhiDOT*r*S2z - 
     1758700944*pow(mass,4)*Nu*PhiDOT*r*S2z + 
     1159350192*delta*pow(mass,4)*Nu*PhiDOT*r*S2z + 
     803674872*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*S2z - 
     803674872*delta*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*S2z - 
     1959998040*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*S2z + 
     352648296*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*S2z - 
     Complex(0,108972864)*pow(mass,4)*rDOT*S2z + 
     Complex(0,108972864)*delta*pow(mass,4)*rDOT*S2z + 
     Complex(0,502485984)*pow(mass,4)*Nu*rDOT*S2z - 
     Complex(0,284540256)*delta*pow(mass,4)*Nu*rDOT*S2z - 
     Complex(0,899026128)*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*
      rDOT*S2z + Complex(0,899026128)*delta*pow(mass,3)*
      pow(PhiDOT,2)*pow(r,3)*rDOT*S2z + 
     Complex(0,1407566160)*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*
      rDOT*S2z + Complex(0,390486096)*delta*pow(mass,3)*Nu*
      pow(PhiDOT,2)*pow(r,3)*rDOT*S2z + 
     326918592*pow(mass,3)*PhiDOT*pow(r,2)*pow(rDOT,2)*S2z - 
     326918592*delta*pow(mass,3)*PhiDOT*pow(r,2)*pow(rDOT,2)*
      S2z - 2270268000*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*S2z + 1616430816*delta*pow(mass,3)*Nu*PhiDOT*
      pow(r,2)*pow(rDOT,2)*S2z + 
     Complex(0,54486432)*pow(mass,3)*r*pow(rDOT,3)*S2z - 
     Complex(0,54486432)*delta*pow(mass,3)*r*pow(rDOT,3)*S2z - 
     Complex(0,332972640)*pow(mass,3)*Nu*r*pow(rDOT,3)*S2z + 
     Complex(0,223999776)*delta*pow(mass,3)*Nu*r*pow(rDOT,3)*S2z + 
     Complex(0,9747017280)*delta*pow(mass,4)*Nu*PhiDOT*r*S1z*S2z - 
     Complex(0,5267021760)*delta*pow(mass,4)*pow(Nu,2)*PhiDOT*r*
      S1z*S2z + Complex(0,544864320)*delta*pow(mass,3)*Nu*
      pow(PhiDOT,3)*pow(r,4)*S1z*S2z - 
     Complex(0,1089728640)*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4)*S1z*S2z - 
     988827840*delta*pow(mass,4)*Nu*rDOT*S1z*S2z + 
     2885762880*delta*pow(mass,4)*pow(Nu,2)*rDOT*S1z*S2z + 
     1392431040*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*rDOT*
      S1z*S2z + 2663781120*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,2)*pow(r,3)*rDOT*S1z*S2z + 
     Complex(0,30270240)*delta*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*S1z*S2z + 
     Complex(0,1755673920)*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*
      pow(r,2)*pow(rDOT,2)*S1z*S2z + 
     141261120*delta*pow(mass,3)*Nu*r*pow(rDOT,3)*S1z*S2z - 
     887927040*delta*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*S1z*
      S2z + Complex(0,121080960)*pow(mass,4)*PhiDOT*r*pow(S2z,2) - 
     Complex(0,121080960)*delta*pow(mass,4)*PhiDOT*r*pow(S2z,2) - 
     Complex(0,2012970960)*kappa2*pow(mass,4)*PhiDOT*r*
      pow(S2z,2) + Complex(0,2012970960)*delta*kappa2*pow(mass,4)*
      PhiDOT*r*pow(S2z,2) - 
     Complex(0,1695133440)*pow(mass,4)*Nu*PhiDOT*r*pow(S2z,2) + 
     Complex(0,1452971520)*delta*pow(mass,4)*Nu*PhiDOT*r*
      pow(S2z,2) + Complex(0,8218370160)*kappa2*pow(mass,4)*Nu*
      PhiDOT*r*pow(S2z,2) - 
     Complex(0,4192428240)*delta*kappa2*pow(mass,4)*Nu*PhiDOT*r*
      pow(S2z,2) + Complex(0,4601076480)*pow(mass,4)*pow(Nu,2)*
      PhiDOT*r*pow(S2z,2) - 
     Complex(0,665945280)*delta*pow(mass,4)*pow(Nu,2)*PhiDOT*r*
      pow(S2z,2) - Complex(0,948467520)*kappa2*pow(mass,4)*
      pow(Nu,2)*PhiDOT*r*pow(S2z,2) + 
     Complex(0,1967565600)*delta*kappa2*pow(mass,4)*pow(Nu,2)*
      PhiDOT*r*pow(S2z,2) + 
     Complex(0,166486320)*kappa2*pow(mass,3)*pow(PhiDOT,3)*
      pow(r,4)*pow(S2z,2) - 
     Complex(0,166486320)*delta*kappa2*pow(mass,3)*pow(PhiDOT,3)*
      pow(r,4)*pow(S2z,2) - 
     Complex(0,908107200)*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*
      pow(S2z,2) + Complex(0,908107200)*delta*pow(mass,3)*Nu*
      pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) - 
     Complex(0,393513120)*kappa2*pow(mass,3)*Nu*pow(PhiDOT,3)*
      pow(r,4)*pow(S2z,2) + 
     Complex(0,60540480)*delta*kappa2*pow(mass,3)*Nu*pow(PhiDOT,3)*
      pow(r,4)*pow(S2z,2) + 
     Complex(0,1937295360)*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,3)*
      pow(r,4)*pow(S2z,2) + 
     Complex(0,151351200)*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) - 
     Complex(0,1352070720)*kappa2*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) + 
     Complex(0,696215520)*delta*kappa2*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) - 
     121080960*pow(mass,4)*rDOT*pow(S2z,2) + 
     121080960*delta*pow(mass,4)*rDOT*pow(S2z,2) - 
     25225200*kappa2*pow(mass,4)*rDOT*pow(S2z,2) + 
     25225200*delta*kappa2*pow(mass,4)*rDOT*pow(S2z,2) + 
     1150269120*pow(mass,4)*Nu*rDOT*pow(S2z,2) - 
     908107200*delta*pow(mass,4)*Nu*rDOT*pow(S2z,2) + 
     15135120*kappa2*pow(mass,4)*Nu*rDOT*pow(S2z,2) + 
     35315280*delta*kappa2*pow(mass,4)*Nu*rDOT*pow(S2z,2) - 
     2239997760*pow(mass,4)*pow(Nu,2)*rDOT*pow(S2z,2) + 
     665945280*delta*pow(mass,4)*pow(Nu,2)*rDOT*pow(S2z,2) + 
     262342080*kappa2*pow(mass,4)*pow(Nu,2)*rDOT*pow(S2z,2) - 
     776936160*delta*kappa2*pow(mass,4)*pow(Nu,2)*rDOT*
      pow(S2z,2) - 756756000*kappa2*pow(mass,3)*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S2z,2) + 
     756756000*delta*kappa2*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*
      rDOT*pow(S2z,2) + 1816214400*pow(mass,3)*Nu*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S2z,2) - 
     1816214400*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*rDOT*
      pow(S2z,2) + 2134051920*kappa2*pow(mass,3)*Nu*
      pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S2z,2) - 
     620539920*delta*kappa2*pow(mass,3)*Nu*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S2z,2) - 
     7900532640*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,2)*pow(r,3)*
      rDOT*pow(S2z,2) + 90810720*delta*pow(mass,3)*pow(Nu,2)*
      pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S2z,2) + 
     3450807360*kappa2*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S2z,2) - 
     1241079840*delta*kappa2*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,2)*
      pow(r,3)*rDOT*pow(S2z,2) - 
     Complex(0,824864040)*kappa2*pow(mass,3)*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S2z,2) + 
     Complex(0,824864040)*delta*kappa2*pow(mass,3)*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S2z,2) + 
     Complex(0,908107200)*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S2z,2) - 
     Complex(0,908107200)*delta*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S2z,2) + 
     Complex(0,3314591280)*kappa2*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S2z,2) - 
     Complex(0,1664863200)*delta*kappa2*pow(mass,3)*Nu*PhiDOT*
      pow(r,2)*pow(rDOT,2)*pow(S2z,2) - 
     Complex(0,2724321600)*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
      pow(rDOT,2)*pow(S2z,2) + 
     Complex(0,181621440)*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*
      pow(r,2)*pow(rDOT,2)*pow(S2z,2) - 
     Complex(0,484323840)*kappa2*pow(mass,3)*pow(Nu,2)*PhiDOT*
      pow(r,2)*pow(rDOT,2)*pow(S2z,2) - 
     Complex(0,696215520)*delta*kappa2*pow(mass,3)*pow(Nu,2)*
      PhiDOT*pow(r,2)*pow(rDOT,2)*pow(S2z,2) + 
     146306160*kappa2*pow(mass,3)*r*pow(rDOT,3)*pow(S2z,2) - 
     146306160*delta*kappa2*pow(mass,3)*r*pow(rDOT,3)*
      pow(S2z,2) - 514594080*kappa2*pow(mass,3)*Nu*r*pow(rDOT,3)*
      pow(S2z,2) + 221981760*delta*kappa2*pow(mass,3)*Nu*r*
      pow(rDOT,3)*pow(S2z,2) - 
     60540480*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*pow(S2z,2) + 
     60540480*delta*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*
      pow(S2z,2) - 242161920*kappa2*pow(mass,3)*pow(Nu,2)*r*
      pow(rDOT,3)*pow(S2z,2) + 
     504504000*delta*kappa2*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*
      pow(S2z,2) + 74954880*delta*pow(mass,3)*
      (Complex(0,22)*mass*PhiDOT*r + 
        ...
        4*r*pow(rDOT,3))*log(r/r0) + 
     2663781120*delta*pow(mass,3)*Nu*
      (Complex(0,1)*pow(PhiDOT,3)*pow(r,4) + 2*mass*rDOT + 
        Complex(0,3)*PhiDOT*pow(r,2)*pow(rDOT,2) - 
        2*r*pow(rDOT,3))*log(r/r0p))/
     (2.4216192e7*sqrt(210)*pow(r,4))));
    }
...
static COMPLEX16 hGO_3_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 2){
        ...
        + /* Henry et al. ecc spin terms */ ((sqrt(0.7142857142857143)*pow(mass,2)*
     (Complex(0,2)*mass*rDOT*
        ((-12 + Nu*(97 + 4*Nu) + delta*(-12 + 5*Nu))*S1z + 
          (-12 + delta*(12 - 5*Nu) + Nu*(97 + 4*Nu))*S2z) + 
       4*mass*PhiDOT*r*(-((12 + delta*(12 - 23*Nu) + Nu*(53 + 8*Nu))*
             S1z) - (12 + Nu*(53 + 8*Nu) + delta*(-12 + 23*Nu))*S2z) - 
       3*r*(16*pow(Nu,2)*PhiDOT*r*
           (4*pow(PhiDOT,2)*pow(r,2) - 
             Complex(0,2)*PhiDOT*r*rDOT + pow(rDOT,2))*(S1z + S2z) + 
          ...
          Nu*(-4*pow(PhiDOT,3)*pow(r,3)*
             ...
             Complex(0,4)*pow(rDOT,3)*
              ((-4 + delta)*S1z - (4 + delta)*S2z)))))/(72.*pow(r,3))));
    }
        ...
        + /* Henry et al. ecc spin terms */ ((sqrt(0.7142857142857143)*pow(mass,3)*
        (2*mass*(Complex(0,2)*(1 + delta - 2*Nu)*S1z + 
          Nu*((1 + delta)*(-6 + kappa1) + 12*Nu)*pow(S1z,2) + 
          8*Nu*(-1 + 3*Nu)*S1z*S2z + 
          S2z*(Complex(0,-2)*(-1 + delta + 2*Nu) + 
             Nu*(-6 - delta*(-6 + kappa2) + kappa2 + 12*Nu)*S2z)) + 
         r*(4*pow(rDOT,2)*(Complex(0,2)*(1 + delta - 2*Nu)*S1z + 
             Nu*((1 + delta)*(-2 + kappa1) + 4*Nu)*pow(S1z,2) + 
             8*pow(Nu,2)*S1z*S2z + 
             S2z*(Complex(0,-2)*(-1 + delta + 2*Nu) + 
          ...
          2*pow(PhiDOT,2)*pow(r,2)*
           (Complex(0,14)*(1 + delta - 2*Nu)*S1z + 
             (6*(1 + delta)*kappa1 - 
                ...
                4*(1 + 9*kappa1)*pow(Nu,2))*pow(S1z,2) - 
             64*pow(Nu,2)*S1z*S2z + 
             S2z*(Complex(0,-14)*(-1 + delta + 2*Nu) + 
                2*Nu*(-13 + 13*delta + 2*Nu)*S2z + 
                kappa2*(6 + delta*(-6 + 11*Nu) + Nu*(-23 + 36*Nu))*S2z)
             ) + PhiDOT*r*rDOT*
           (40*(1 + delta - 2*Nu)*S1z - 
             Complex(0,1)*(8*Nu*(-2 - 2*delta + Nu) + 
                kappa1*(3 + delta*(3 + 11*Nu) + Nu*(5 + 18*Nu)))*
              pow(S1z,2) + Complex(0,20)*(-3 + Nu)*Nu*S1z*S2z + 
             S2z*(-40*(-1 + delta + 2*Nu) - 
                Complex(0,1)*
                 (8*Nu*(-2 + 2*delta + Nu) + 
                   kappa2*(3 - delta*(3 + 11*Nu) + Nu*(5 + 18*Nu)))*S2z
                )))))/(24.*pow(r,4))));
    }

    else if(vpnorder == 7){

        return(/* Henry et al. QC spin terms *//* ((-26902*pow(Nu,3)*(S1z + S2z) - 4664*(S1z + delta*S1z + S2z - delta*S2z) + 
       ...
       + */ /* Henry et al. ecc + spin terms */ (-0.000014029180695847363*(pow(mass,2)*
      (3*pow(r,2)*(-120*pow(Nu,3)*
            (3565*pow(PhiDOT,5)*pow(r,5) + 
              ...
              Complex(0,869)*pow(PhiDOT,2)*pow(r,2)*
               pow(rDOT,3) - 56*PhiDOT*r*pow(rDOT,4) - 
              Complex(0,120)*pow(rDOT,5))*(S1z + S2z) + 
           2475*pow(PhiDOT,2)*pow(r,2)*
            (6*pow(PhiDOT,3)*pow(r,3) + 
              Complex(0,77)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
              72*PhiDOT*r*pow(rDOT,2) + Complex(0,6)*pow(rDOT,3))*
            (S1z + delta*S1z + S2z - delta*S2z) - 
           3*Nu*(Complex(0,22)*pow(PhiDOT,4)*pow(r,4)*rDOT*
           ...
           2*pow(Nu,2)*(pow(PhiDOT,5)*pow(r,5)*
               (Complex(0,-1549757) + 300*(1448 + 1311*delta)*S1z + 
                 300*(1448 - 1311*delta)*S2z) + 
              Complex(0,11)*pow(PhiDOT,4)*pow(r,4)*rDOT*
               (Complex(0,329548) + 15*(4113 + 1411*delta)*S1z + 
                 61695*S2z - 21165*delta*S2z) + 
              Complex(0,22)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              ...
              21*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
               (Complex(0,161403) + 10*(-1897 + 1471*delta)*S1z - 
                 10*(1897 + 1471*delta)*S2z))) - 
        6*mass*r*(60*pow(Nu,3)*
            (2417*pow(PhiDOT,3)*pow(r,3) + 
              Complex(0,7258)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
              4381*PhiDOT*r*pow(rDOT,2) + 
              Complex(0,480)*pow(rDOT,3))*(S1z + S2z) - 
           165*(1161*pow(PhiDOT,3)*pow(r,3) - 
              Complex(0,536)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
              2412*PhiDOT*r*pow(rDOT,2) - 
              Complex(0,270)*pow(rDOT,3))*
            (S1z + delta*S1z + S2z - delta*S2z) + 
           2*Nu*(Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*rDOT*
               (Complex(0,1015784) + 5*(30849 + 88721*delta)*S1z + 
                 5*(30849 - 88721*delta)*S2z) + 
              pow(PhiDOT,3)*pow(r,3)*
               (Complex(0,-173371) + 5*(61569 + 10789*delta)*S1z + 
           ...
           pow(Nu,2)*(20*PhiDOT*r*pow(rDOT,2)*
               (Complex(0,-11187) - 48074*S1z + 11057*delta*S1z - 
                 48074*S2z - 11057*delta*S2z) + 
              Complex(0,725)*pow(rDOT,3)*
               (-73*S1z + 31*delta*S1z - 73*S2z - 31*delta*S2z) + 
              pow(PhiDOT,3)*pow(r,3)*
               (Complex(0,603141) - 543040*S1z + 404620*delta*S1z - 
                 20*(27152 + 20231*delta)*S2z) + 
              Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*rDOT*
               (Complex(0,-1798104) - 648485*S1z + 105755*delta*S1z - 
                 5*(129697 + 21151*delta)*S2z))) + 
        10*pow(mass,2)*(24*pow(Nu,3)*
            (6981*PhiDOT*r + Complex(0,1600)*rDOT)*(S1z + S2z) - 
           ...
           Complex(0,30)*Nu*rDOT*
            (297*(1 + delta)*kappa1*pow(S1z,3) + 
              ...
              S2z*(17261 + 1641*delta - 
                 297*(-1 + delta)*kappa2*pow(S2z,2))) + 
           8*Nu*PhiDOT*r*(Complex(0,-7315) - 
              4455*(1 + delta)*kappa1*pow(S1z,3) + 
              3*(3881 - 7757*delta)*S2z - 
              4455*(1 + delta)*kappa1*pow(S1z,2)*S2z + 
              4455*(-1 + delta)*kappa2*pow(S2z,3) + 
              3*S1z*(3881 + 7757*delta + 
                 1485*(-1 + delta)*kappa2*pow(S2z,2))) + 
           3*pow(Nu,2)*(Complex(0,-5)*rDOT*
               (S1z*(18793 + 223*delta + 1188*kappa1*pow(S1z,2)) + 
                 (18793 - 223*delta + 1188*(-2 + kappa1)*pow(S1z,2))*
                  S2z + 1188*(-2 + kappa2)*S1z*pow(S2z,2) + 
                 1188*kappa2*pow(S2z,3)) + 
              4*PhiDOT*r*(Complex(0,-4939) - 23359*S1z - 
                 5563*delta*S1z + 5940*kappa1*pow(S1z,3) + 
                 (-23359 + 5563*delta + 
                    5940*(-2 + kappa1)*pow(S1z,2))*S2z + 
                 5940*(-2 + kappa2)*S1z*pow(S2z,2) + 
                 5940*kappa2*pow(S2z,3))))))/(sqrt(35)*pow(r,4))));
    }
...
static COMPLEX16 hGO_3_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 1){
       ...
       r*(2*pow(rDOT,2)*(-6*(1 + delta)*S1z + 
        ...
        - 12*(-771 + 1126*Nu 
        + 3616*pow(Nu,2))*pow(rDOT,5))))/(4752.*sqrt(14)*pow(r,3)) /* Henry et al. QC spin terms *//* +((Complex(0,-0.041666666666666664)*(kappa1*(5 
        - 4*Nu + delta*(5 + 6*Nu))*pow(S1z,2) + S2z*(-12*delta*Nu*S1z + kappa2*(-5 + 5*delta + 4*Nu + 6*delta*Nu)*S2z))*
        pow(x,3.5))/sqrt(14)) */+ /* Henry et al. ecc spin terms */ ((pow(mass,3)*(kappa1*(Complex(0,-1)*
           (-13 - 13*delta + 68*Nu + 42*delta*Nu)*PhiDOT*r - 
          34*(1 + delta)*rDOT + 4*(26 + 9*delta)*Nu*rDOT)*pow(S1z,2)\
        + S2z*(12*delta*Nu*(Complex(0,7)*PhiDOT*r - 6*rDOT)*S1z + 
          kappa2*(Complex(0,-1)*(13 - 13*delta - 68*Nu + 42*delta*Nu)*
              PhiDOT*r + 2*(17 - 17*delta - 52*Nu + 18*delta*Nu)*rDOT)*
           S2z)))/(24.*sqrt(14)*pow(r,3))));
    }
        ...
        + 1000*pow(rDOT,4))))/(180.*sqrt(14)*pow(r,4)) /*Henry et al QC spin terms *//* +((Complex(0,0.004629629629629629)*(70*(S1z - S2z 
        + delta*(S1z + S2z)) - pow(Nu,2)*(931*(S1z - S2z) + 45*delta*(S1z + S2z)) - 
         Nu*(59*(-S1z + S2z) + 99*delta*(S1z + S2z)))*pow(x,4))/sqrt(14)) */
         + /* Henry et al. ecc spin terms */ ((Complex(0,0.0023148148148148147)*pow(mass,2)*
     (2*pow(mass,2)*((252*(1 + delta) - (1277 + 1279*delta)*Nu + 
             8*(12 + 47*delta)*pow(Nu,2))*S1z + 
          (252*(-1 + delta) + (1277 - 1279*delta)*Nu + 
             8*(-12 + 47*delta)*pow(Nu,2))*S2z) + 
       3*pow(r,2)*(2*pow(rDOT,4)*
           ((30 + Nu*(-187 + 318*Nu) + 
                delta*(30 + Nu*(-101 + 122*Nu)))*S1z + 
             (-30 + (187 - 318*Nu)*Nu + 
                delta*(30 + Nu*(-101 + 122*Nu)))*S2z) + 
          2*pow(PhiDOT,4)*pow(r,4)*
           ((90 - Nu*(28 + 579*Nu) + delta*(90 + Nu*(-800 + 551*Nu)))*
              S1z + (-90 + Nu*(28 + 579*Nu) + 
          ...
          3*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
           ((32 + Nu*(-451 + 230*Nu) + delta*(32 + Nu*(691 + 626*Nu)))*
              S1z + (-32 + (451 - 230*Nu)*Nu + 
       ...
       2*mass*r*(2*pow(PhiDOT,2)*pow(r,2)*
           ((-312*(1 + delta) + 2*(827 - 923*delta)*Nu + 
                5*(-201 + 131*delta)*pow(Nu,2))*S1z + 
             (-312*(-1 + delta) - 2*(827 + 923*delta)*Nu + 
                5*(201 + 131*delta)*pow(Nu,2))*S2z) + 
          2*pow(rDOT,2)*((105 + Nu*(-541 + 924*Nu) + 
   ...
   (sqrt(14)*pow(r,4))));
        ...
        S2z*(Complex(0,-315)*delta*Nu + 30*(4 - 11*Nu + delta*(-4 + 13*Nu))*M_PI + 60*Nu*(6 - 50*Nu + delta*(-6 + 11*Nu))*S2z + 
          ...
          + */ /* Henry et al. ecc + spin terms */ ((Complex(0,-2.752978943455134e-9)*
     (-1185355664*delta*pow(mass,4)*PhiDOT*r + 
       19113759672*delta*pow(mass,4)*Nu*PhiDOT*r + 
       3969352800*delta*pow(mass,4)*pow(Nu,2)*PhiDOT*r - 
       2352344960*delta*pow(mass,4)*pow(Nu,3)*PhiDOT*r - 
       1318647330*delta*pow(mass,4)*Nu*PhiDOT*pow(M_PI,2)*r + 
       5967803352*delta*pow(mass,3)*pow(PhiDOT,3)*pow(r,4) + 
       13844235888*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4) - 
       28902210960*delta*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,3)*
        pow(r,4) + 10770754680*delta*pow(mass,3)*pow(Nu,3)*
        pow(PhiDOT,3)*pow(r,4) + 
       1047161115*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(M_PI,2)*
        pow(r,4) + 2146610760*delta*pow(mass,2)*pow(PhiDOT,5)*
        pow(r,7) - 4822058640*delta*pow(mass,2)*Nu*pow(PhiDOT,5)*
        pow(r,7) + 38945533200*delta*pow(mass,2)*pow(Nu,2)*
        pow(PhiDOT,5)*pow(r,7) - 
       29097162360*delta*pow(mass,2)*pow(Nu,3)*pow(PhiDOT,5)*
        pow(r,7) + 1971040680*delta*mass*pow(PhiDOT,7)*
        pow(r,10) - 6466347720*delta*mass*Nu*pow(PhiDOT,7)*
        pow(r,10) - 10917801720*delta*mass*pow(Nu,2)*
        pow(PhiDOT,7)*pow(r,10) + 
       40194380520*delta*mass*pow(Nu,3)*pow(PhiDOT,7)*
        pow(r,10) + 216072360*delta*pow(PhiDOT,9)*pow(r,13) - 
       3085818120*delta*Nu*pow(PhiDOT,9)*pow(r,13) + 
       14248180800*delta*pow(Nu,2)*pow(PhiDOT,9)*pow(r,13) - 
       21465251640*delta*pow(Nu,3)*pow(PhiDOT,9)*pow(r,13) + 
       Complex(0,8357194848)*delta*pow(mass,4)*rDOT + 
       Complex(0,57290388624)*delta*pow(mass,4)*Nu*rDOT - 
       Complex(0,8668648800)*delta*pow(mass,4)*pow(Nu,2)*rDOT - 
       Complex(0,6462708000)*delta*pow(mass,4)*pow(Nu,3)*rDOT + 
       Complex(0,930809880)*delta*pow(mass,4)*Nu*pow(M_PI,2)*rDOT - 
       Complex(0,16230096624)*delta*pow(mass,3)*pow(PhiDOT,2)*
        pow(r,3)*rDOT - Complex(0,39424968408)*delta*pow(mass,3)*
        Nu*pow(PhiDOT,2)*pow(r,3)*rDOT - 
       Complex(0,10680631920)*delta*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT + 
       Complex(0,9639930720)*delta*pow(mass,3)*pow(Nu,3)*
        pow(PhiDOT,2)*pow(r,3)*rDOT - 
       Complex(0,698107410)*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(M_PI,2)*pow(r,3)*rDOT - 
       Complex(0,2971610040)*delta*pow(mass,2)*pow(PhiDOT,4)*
        pow(r,6)*rDOT + Complex(0,16567799640)*delta*pow(mass,2)*
        Nu*pow(PhiDOT,4)*pow(r,6)*rDOT + 
       Complex(0,41466006960)*delta*pow(mass,2)*pow(Nu,2)*
        pow(PhiDOT,4)*pow(r,6)*rDOT - 
       Complex(0,23620824360)*delta*pow(mass,2)*pow(Nu,3)*
        pow(PhiDOT,4)*pow(r,6)*rDOT + 
       Complex(0,1796528160)*delta*mass*pow(PhiDOT,6)*pow(r,9)*
        rDOT - Complex(0,4827627000)*delta*mass*Nu*pow(PhiDOT,6)*
        pow(r,9)*rDOT - Complex(0,15375553200)*delta*mass*
        pow(Nu,2)*pow(PhiDOT,6)*pow(r,9)*rDOT + 
       Complex(0,36510813360)*delta*mass*pow(Nu,3)*pow(PhiDOT,6)*
        pow(r,9)*rDOT + Complex(0,216072360)*delta*pow(PhiDOT,8)*
        pow(r,12)*rDOT - Complex(0,3085818120)*delta*Nu*
        pow(PhiDOT,8)*pow(r,12)*rDOT + 
       Complex(0,14248180800)*delta*pow(Nu,2)*pow(PhiDOT,8)*
        pow(r,12)*rDOT - Complex(0,21465251640)*delta*pow(Nu,3)*
        pow(PhiDOT,8)*pow(r,12)*rDOT - 
       13151848488*delta*pow(mass,3)*PhiDOT*pow(r,2)*
        pow(rDOT,2) - 44552849880*delta*pow(mass,3)*Nu*PhiDOT*
        pow(r,2)*pow(rDOT,2) + 
       34120269960*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2) + 12430743360*delta*pow(mass,3)*pow(Nu,3)*
        PhiDOT*pow(r,2)*pow(rDOT,2) - 
       1396214820*delta*pow(mass,3)*Nu*PhiDOT*pow(M_PI,2)*pow(r,2)*
        pow(rDOT,2) + 3601072440*delta*pow(mass,2)*pow(PhiDOT,3)*
        pow(r,5)*pow(rDOT,2) + 
       21710377080*delta*pow(mass,2)*Nu*pow(PhiDOT,3)*pow(r,5)*
        pow(rDOT,2) + 4188053520*delta*pow(mass,2)*pow(Nu,2)*
        pow(PhiDOT,3)*pow(r,5)*pow(rDOT,2) - 
       71648687880*delta*pow(mass,2)*pow(Nu,3)*pow(PhiDOT,3)*
        pow(r,5)*pow(rDOT,2) + 
       6020920080*delta*mass*pow(PhiDOT,5)*pow(r,8)*
        pow(rDOT,2) - 25224106320*delta*mass*Nu*pow(PhiDOT,5)*
        pow(r,8)*pow(rDOT,2) - 
       21275304120*delta*mass*pow(Nu,2)*pow(PhiDOT,5)*pow(r,8)*
        pow(rDOT,2) + 135663612840*delta*mass*pow(Nu,3)*
        pow(PhiDOT,5)*pow(r,8)*pow(rDOT,2) + 
       864289440*delta*pow(PhiDOT,7)*pow(r,11)*pow(rDOT,2) - 
       12343272480*delta*Nu*pow(PhiDOT,7)*pow(r,11)*
        pow(rDOT,2) + 56992723200*delta*pow(Nu,2)*pow(PhiDOT,7)*
        pow(r,11)*pow(rDOT,2) - 
       85861006560*delta*pow(Nu,3)*pow(PhiDOT,7)*pow(r,11)*
        pow(rDOT,2) - Complex(0,7212218784)*delta*pow(mass,3)*r*
        pow(rDOT,3) - Complex(0,31526865216)*delta*pow(mass,3)*Nu*
        r*pow(rDOT,3) + Complex(0,44167737600)*delta*pow(mass,3)*
        pow(Nu,2)*r*pow(rDOT,3) + 
       Complex(0,16312013760)*delta*pow(mass,3)*pow(Nu,3)*r*
        pow(rDOT,3) - Complex(0,1396214820)*delta*pow(mass,3)*Nu*
        pow(M_PI,2)*r*pow(rDOT,3) + 
       Complex(0,4328529240)*delta*pow(mass,2)*pow(PhiDOT,2)*
        pow(r,4)*pow(rDOT,3) + 
       Complex(0,13966922760)*delta*pow(mass,2)*Nu*pow(PhiDOT,2)*
        pow(r,4)*pow(rDOT,3) - 
       Complex(0,11581330320)*delta*pow(mass,2)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,4)*pow(rDOT,3) - 
       Complex(0,86798590200)*delta*pow(mass,2)*pow(Nu,3)*
        pow(PhiDOT,2)*pow(r,4)*pow(rDOT,3) + 
       Complex(0,6367404960)*delta*mass*pow(PhiDOT,4)*pow(r,7)*
        pow(rDOT,3) - Complex(0,29073824640)*delta*mass*Nu*
        pow(PhiDOT,4)*pow(r,7)*pow(rDOT,3) - 
       Complex(0,8765386560)*delta*mass*pow(Nu,2)*pow(PhiDOT,4)*
        pow(r,7)*pow(rDOT,3) + 
       Complex(0,141622104960)*delta*mass*pow(Nu,3)*pow(PhiDOT,4)*
        pow(r,7)*pow(rDOT,3) + 
       Complex(0,864289440)*delta*pow(PhiDOT,6)*pow(r,10)*
        pow(rDOT,3) - Complex(0,12343272480)*delta*Nu*
        pow(PhiDOT,6)*pow(r,10)*pow(rDOT,3) + 
       Complex(0,56992723200)*delta*pow(Nu,2)*pow(PhiDOT,6)*
        pow(r,10)*pow(rDOT,3) - 
       Complex(0,85861006560)*delta*pow(Nu,3)*pow(PhiDOT,6)*
        pow(r,10)*pow(rDOT,3) + 
       6519995160*delta*pow(mass,2)*PhiDOT*pow(r,3)*
        pow(rDOT,4) - 17008270440*delta*pow(mass,2)*Nu*PhiDOT*
        pow(r,3)*pow(rDOT,4) - 
       35271779760*delta*pow(mass,2)*pow(Nu,2)*PhiDOT*pow(r,3)*
        pow(rDOT,4) - 44062479720*delta*pow(mass,2)*pow(Nu,3)*
        PhiDOT*pow(r,3)*pow(rDOT,4) + 
       7242049080*delta*mass*pow(PhiDOT,3)*pow(r,6)*
        pow(rDOT,4) - 40037261040*delta*mass*Nu*pow(PhiDOT,3)*
        pow(r,6)*pow(rDOT,4) + 
       13443285240*delta*mass*pow(Nu,2)*pow(PhiDOT,3)*pow(r,6)*
        pow(rDOT,4) + 148176917280*delta*mass*pow(Nu,3)*
        pow(PhiDOT,3)*pow(r,6)*pow(rDOT,4) + 
       1296434160*delta*pow(PhiDOT,5)*pow(r,9)*pow(rDOT,4) - 
       18514908720*delta*Nu*pow(PhiDOT,5)*pow(r,9)*pow(rDOT,4) + 
       85489084800*delta*pow(Nu,2)*pow(PhiDOT,5)*pow(r,9)*
        pow(rDOT,4) - 128791509840*delta*pow(Nu,3)*pow(PhiDOT,5)*
        pow(r,9)*pow(rDOT,4) + 
       Complex(0,6103583640)*delta*pow(mass,2)*pow(r,2)*
        pow(rDOT,5) - Complex(0,8838433800)*delta*pow(mass,2)*Nu*
        pow(r,2)*pow(rDOT,5) - 
       Complex(0,35864607240)*delta*pow(mass,2)*pow(Nu,2)*
        pow(r,2)*pow(rDOT,5) - 
       Complex(0,48894834240)*delta*pow(mass,2)*pow(Nu,3)*
        pow(r,2)*pow(rDOT,5) + 
       Complex(0,7688746800)*delta*mass*pow(PhiDOT,2)*pow(r,5)*
        pow(rDOT,5) - Complex(0,40480201440)*delta*mass*Nu*
        pow(PhiDOT,2)*pow(r,5)*pow(rDOT,5) + 
       Complex(0,6587128800)*delta*mass*pow(Nu,2)*pow(PhiDOT,2)*
        pow(r,5)*pow(rDOT,5) + 
       Complex(0,157259894400)*delta*mass*pow(Nu,3)*pow(PhiDOT,2)*
        pow(r,5)*pow(rDOT,5) + 
       Complex(0,1296434160)*delta*pow(PhiDOT,4)*pow(r,8)*
        pow(rDOT,5) - Complex(0,18514908720)*delta*Nu*
        pow(PhiDOT,4)*pow(r,8)*pow(rDOT,5) + 
       Complex(0,85489084800)*delta*pow(Nu,2)*pow(PhiDOT,4)*
        pow(r,8)*pow(rDOT,5) - 
       Complex(0,128791509840)*delta*pow(Nu,3)*pow(PhiDOT,4)*
        pow(r,8)*pow(rDOT,5) + 
       2945606580*delta*mass*PhiDOT*pow(r,4)*pow(rDOT,6) - 
       17313148440*delta*mass*Nu*PhiDOT*pow(r,4)*pow(rDOT,6) + 
       10868991840*delta*mass*pow(Nu,2)*PhiDOT*pow(r,4)*
        pow(rDOT,6) + 52921128960*delta*mass*pow(Nu,3)*PhiDOT*
        pow(r,4)*pow(rDOT,6) + 
       864289440*delta*pow(PhiDOT,3)*pow(r,7)*pow(rDOT,6) - 
       12343272480*delta*Nu*pow(PhiDOT,3)*pow(r,7)*pow(rDOT,6) + 
       56992723200*delta*pow(Nu,2)*pow(PhiDOT,3)*pow(r,7)*
        pow(rDOT,6) - 85861006560*delta*pow(Nu,3)*pow(PhiDOT,3)*
        pow(r,7)*pow(rDOT,6) + 
       Complex(0,2803701600)*delta*mass*pow(r,3)*pow(rDOT,7) - 
       Complex(0,15666436800)*delta*mass*Nu*pow(r,3)*pow(rDOT,7) + 
       Complex(0,6033303360)*delta*mass*pow(Nu,2)*pow(r,3)*
        pow(rDOT,7) + Complex(0,55104537600)*delta*mass*pow(Nu,3)*
        pow(r,3)*pow(rDOT,7) + 
       Complex(0,864289440)*delta*pow(PhiDOT,2)*pow(r,6)*
        pow(rDOT,7) - Complex(0,12343272480)*delta*Nu*
        pow(PhiDOT,2)*pow(r,6)*pow(rDOT,7) + 
       Complex(0,56992723200)*delta*pow(Nu,2)*pow(PhiDOT,2)*
        pow(r,6)*pow(rDOT,7) - 
       Complex(0,85861006560)*delta*pow(Nu,3)*pow(PhiDOT,2)*
        pow(r,6)*pow(rDOT,7) + 
       216072360*delta*PhiDOT*pow(r,5)*pow(rDOT,8) - 
       3085818120*delta*Nu*PhiDOT*pow(r,5)*pow(rDOT,8) + 
       14248180800*delta*pow(Nu,2)*PhiDOT*pow(r,5)*pow(rDOT,8) - 
       21465251640*delta*pow(Nu,3)*PhiDOT*pow(r,5)*pow(rDOT,8) + 
       Complex(0,216072360)*delta*pow(r,4)*pow(rDOT,9) - 
       Complex(0,3085818120)*delta*Nu*pow(r,4)*pow(rDOT,9) + 
       Complex(0,14248180800)*delta*pow(Nu,2)*pow(r,4)*
        pow(rDOT,9) - Complex(0,21465251640)*delta*pow(Nu,3)*
        pow(r,4)*pow(rDOT,9) + 
       Complex(0,293621328)*pow(mass,4)*PhiDOT*r*S1z + 
       Complex(0,293621328)*delta*pow(mass,4)*PhiDOT*r*S1z - 
       Complex(0,1910052144)*pow(mass,4)*Nu*PhiDOT*r*S1z - 
       Complex(0,1322809488)*delta*pow(mass,4)*Nu*PhiDOT*r*S1z - 
       Complex(0,385945560)*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*
        S1z - Complex(0,385945560)*delta*pow(mass,3)*pow(PhiDOT,3)*
        pow(r,4)*S1z + Complex(0,2123457336)*pow(mass,3)*Nu*
        pow(PhiDOT,3)*pow(r,4)*S1z + 
       Complex(0,1351566216)*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*
        pow(r,4)*S1z + 108972864*pow(mass,4)*rDOT*S1z + 
       108972864*delta*pow(mass,4)*rDOT*S1z - 
       502485984*pow(mass,4)*Nu*rDOT*S1z - 
       284540256*delta*pow(mass,4)*Nu*rDOT*S1z - 
       771891120*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*rDOT*S1z - 
       771891120*delta*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*rDOT*
        S1z + 3266158896*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*
        rDOT*S1z + 1722376656*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*S1z + 
       Complex(0,690161472)*pow(mass,3)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*S1z + Complex(0,690161472)*delta*pow(mass,3)*
        PhiDOT*pow(r,2)*pow(rDOT,2)*S1z - 
       Complex(0,4728211488)*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
        pow(rDOT,2)*S1z - Complex(0,3347888544)*delta*pow(mass,3)*
        Nu*PhiDOT*pow(r,2)*pow(rDOT,2)*S1z - 
       54486432*pow(mass,3)*r*pow(rDOT,3)*S1z - 
       54486432*delta*pow(mass,3)*r*pow(rDOT,3)*S1z + 
       332972640*pow(mass,3)*Nu*r*pow(rDOT,3)*S1z + 
       223999776*delta*pow(mass,3)*Nu*r*pow(rDOT,3)*S1z - 
       121080960*pow(mass,4)*PhiDOT*r*pow(S1z,2) - 
       121080960*delta*pow(mass,4)*PhiDOT*r*pow(S1z,2) + 
       1770809040*kappa1*pow(mass,4)*PhiDOT*r*pow(S1z,2) + 
       1770809040*delta*kappa1*pow(mass,4)*PhiDOT*r*pow(S1z,2) + 
       1695133440*pow(mass,4)*Nu*PhiDOT*r*pow(S1z,2) + 
       1452971520*delta*pow(mass,4)*Nu*PhiDOT*r*pow(S1z,2) - 
       6765398640*kappa1*pow(mass,4)*Nu*PhiDOT*r*pow(S1z,2) - 
       3223780560*delta*kappa1*pow(mass,4)*Nu*PhiDOT*r*
        pow(S1z,2) - 3632428800*pow(mass,4)*pow(Nu,2)*PhiDOT*r*
        pow(S1z,2) + 302702400*delta*pow(mass,4)*pow(Nu,2)*
        PhiDOT*r*pow(S1z,2) - 
       181621440*kappa1*pow(mass,4)*pow(Nu,2)*PhiDOT*r*
        pow(S1z,2) + 1967565600*delta*kappa1*pow(mass,4)*
        pow(Nu,2)*PhiDOT*r*pow(S1z,2) - 
       771891120*kappa1*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*
        pow(S1z,2) - 771891120*delta*kappa1*pow(mass,3)*
        pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) - 
       1271350080*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*
        pow(S1z,2) - 1271350080*delta*pow(mass,3)*Nu*
        pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) + 
       2754591840*kappa1*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*
        pow(S1z,2) + 1210809600*delta*kappa1*pow(mass,3)*Nu*
        pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) + 
       3390266880*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,3)*pow(r,4)*
        pow(S1z,2) - 332972640*delta*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) - 
       3571888320*kappa1*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,3)*
        pow(r,4)*pow(S1z,2) - 
       1604322720*delta*kappa1*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,3)*pow(r,4)*pow(S1z,2) - 
       Complex(0,363242880)*pow(mass,4)*rDOT*pow(S1z,2) - 
       Complex(0,363242880)*delta*pow(mass,4)*rDOT*pow(S1z,2) + 
       Complex(0,2345943600)*kappa1*pow(mass,4)*rDOT*pow(S1z,2) + 
       Complex(0,2345943600)*delta*kappa1*pow(mass,4)*rDOT*
        pow(S1z,2) + Complex(0,1513512000)*pow(mass,4)*Nu*rDOT*
        pow(S1z,2) + Complex(0,787026240)*delta*pow(mass,4)*Nu*
        rDOT*pow(S1z,2) - Complex(0,5645399760)*kappa1*pow(mass,4)*
        Nu*rDOT*pow(S1z,2) - 
       Complex(0,953512560)*delta*kappa1*pow(mass,4)*Nu*rDOT*
        pow(S1z,2) - Complex(0,423783360)*pow(mass,4)*pow(Nu,2)*
        rDOT*pow(S1z,2) + Complex(0,423783360)*delta*pow(mass,4)*
        pow(Nu,2)*rDOT*pow(S1z,2) + 
       Complex(0,2482159680)*kappa1*pow(mass,4)*pow(Nu,2)*rDOT*
        pow(S1z,2) + Complex(0,2330808480)*delta*kappa1*
        pow(mass,4)*pow(Nu,2)*rDOT*pow(S1z,2) - 
       Complex(0,90810720)*kappa1*pow(mass,3)*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S1z,2) - 
       Complex(0,90810720)*delta*kappa1*pow(mass,3)*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S1z,2) - 
       Complex(0,1816214400)*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S1z,2) - 
       Complex(0,1816214400)*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S1z,2) + 
       Complex(0,711350640)*kappa1*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S1z,2) + 
       Complex(0,529729200)*delta*kappa1*pow(mass,3)*Nu*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S1z,2) + 
       Complex(0,10927556640)*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S1z,2) + 
       Complex(0,938377440)*delta*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S1z,2) - 
       Complex(0,2482159680)*kappa1*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S1z,2) - 
       Complex(0,151351200)*delta*kappa1*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S1z,2) + 
       1611890280*kappa1*pow(mass,3)*PhiDOT*pow(r,2)*pow(rDOT,2)*
        pow(S1z,2) + 1611890280*delta*kappa1*pow(mass,3)*PhiDOT*
        pow(r,2)*pow(rDOT,2)*pow(S1z,2) + 
       544864320*pow(mass,3)*Nu*PhiDOT*pow(r,2)*pow(rDOT,2)*
        pow(S1z,2) + 544864320*delta*pow(mass,3)*Nu*PhiDOT*
        pow(r,2)*pow(rDOT,2)*pow(S1z,2) - 
       2103781680*kappa1*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S1z,2) + 
       1119998880*delta*kappa1*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S1z,2) - 
       423783360*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S1z,2) - 
       60540480*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S1z,2) - 
       2663781120*kappa1*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S1z,2) - 
       696215520*delta*kappa1*pow(mass,3)*pow(Nu,2)*PhiDOT*
        pow(r,2)*pow(rDOT,2)*pow(S1z,2) + 
       Complex(0,1044323280)*kappa1*pow(mass,3)*r*pow(rDOT,3)*
        pow(S1z,2) + Complex(0,1044323280)*delta*kappa1*
        pow(mass,3)*r*pow(rDOT,3)*pow(S1z,2) - 
       Complex(0,3238915680)*kappa1*pow(mass,3)*Nu*r*pow(rDOT,3)*
        pow(S1z,2) - Complex(0,1150269120)*delta*kappa1*
        pow(mass,3)*Nu*r*pow(rDOT,3)*pow(S1z,2) + 
       Complex(0,302702400)*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*
        pow(S1z,2) + Complex(0,302702400)*delta*pow(mass,3)*
        pow(Nu,2)*r*pow(rDOT,3)*pow(S1z,2) + 
       Complex(0,242161920)*kappa1*pow(mass,3)*pow(Nu,2)*r*
        pow(rDOT,3)*pow(S1z,2) - 
       Complex(0,1513512000)*delta*kappa1*pow(mass,3)*pow(Nu,2)*r*
        pow(rDOT,3)*pow(S1z,2) - 
       Complex(0,293621328)*pow(mass,4)*PhiDOT*r*S2z + 
       Complex(0,293621328)*delta*pow(mass,4)*PhiDOT*r*S2z + 
       Complex(0,1910052144)*pow(mass,4)*Nu*PhiDOT*r*S2z - 
       Complex(0,1322809488)*delta*pow(mass,4)*Nu*PhiDOT*r*S2z + 
       Complex(0,385945560)*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*
        S2z - Complex(0,385945560)*delta*pow(mass,3)*pow(PhiDOT,3)*
        pow(r,4)*S2z - Complex(0,2123457336)*pow(mass,3)*Nu*
        pow(PhiDOT,3)*pow(r,4)*S2z + 
       Complex(0,1351566216)*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*
        pow(r,4)*S2z - 108972864*pow(mass,4)*rDOT*S2z + 
       108972864*delta*pow(mass,4)*rDOT*S2z + 
       502485984*pow(mass,4)*Nu*rDOT*S2z - 
       284540256*delta*pow(mass,4)*Nu*rDOT*S2z + 
       771891120*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*rDOT*S2z - 
       771891120*delta*pow(mass,3)*pow(PhiDOT,2)*pow(r,3)*rDOT*
        S2z - 3266158896*pow(mass,3)*Nu*pow(PhiDOT,2)*pow(r,3)*
        rDOT*S2z + 1722376656*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*S2z - 
       Complex(0,690161472)*pow(mass,3)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*S2z + Complex(0,690161472)*delta*pow(mass,3)*
        PhiDOT*pow(r,2)*pow(rDOT,2)*S2z + 
       Complex(0,4728211488)*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
        pow(rDOT,2)*S2z - Complex(0,3347888544)*delta*pow(mass,3)*
        Nu*PhiDOT*pow(r,2)*pow(rDOT,2)*S2z + 
       54486432*pow(mass,3)*r*pow(rDOT,3)*S2z - 
       54486432*delta*pow(mass,3)*r*pow(rDOT,3)*S2z - 
       332972640*pow(mass,3)*Nu*r*pow(rDOT,3)*S2z + 
       223999776*delta*pow(mass,3)*Nu*r*pow(rDOT,3)*S2z + 
       11684312640*delta*pow(mass,4)*Nu*PhiDOT*r*S1z*S2z - 
       3329726400*delta*pow(mass,4)*pow(Nu,2)*PhiDOT*r*S1z*S2z - 
       4782697920*delta*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*
        S1z*S2z + 2542700160*delta*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,3)*pow(r,4)*S1z*S2z + 
       Complex(0,60540480)*delta*pow(mass,4)*Nu*rDOT*S1z*S2z - 
       Complex(0,3814050240)*delta*pow(mass,4)*pow(Nu,2)*rDOT*S1z*
        S2z + Complex(0,2118916800)*delta*pow(mass,3)*Nu*
        pow(PhiDOT,2)*pow(r,3)*rDOT*S1z*S2z + 
       Complex(0,2179457280)*delta*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*S1z*S2z + 
       5842156320*delta*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
        pow(rDOT,2)*S1z*S2z + 
       1271350080*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*S1z*S2z - 
       Complex(0,423783360)*delta*pow(mass,3)*Nu*r*pow(rDOT,3)*S1z*
        S2z + Complex(0,3632428800)*delta*pow(mass,3)*pow(Nu,2)*r*
        pow(rDOT,3)*S1z*S2z + 
       121080960*pow(mass,4)*PhiDOT*r*pow(S2z,2) - 
       121080960*delta*pow(mass,4)*PhiDOT*r*pow(S2z,2) - 
       1770809040*kappa2*pow(mass,4)*PhiDOT*r*pow(S2z,2) + 
       1770809040*delta*kappa2*pow(mass,4)*PhiDOT*r*pow(S2z,2) - 
       1695133440*pow(mass,4)*Nu*PhiDOT*r*pow(S2z,2) + 
       1452971520*delta*pow(mass,4)*Nu*PhiDOT*r*pow(S2z,2) + 
       6765398640*kappa2*pow(mass,4)*Nu*PhiDOT*r*pow(S2z,2) - 
       3223780560*delta*kappa2*pow(mass,4)*Nu*PhiDOT*r*
        pow(S2z,2) + 3632428800*pow(mass,4)*pow(Nu,2)*PhiDOT*r*
        pow(S2z,2) + 302702400*delta*pow(mass,4)*pow(Nu,2)*
        PhiDOT*r*pow(S2z,2) + 
       181621440*kappa2*pow(mass,4)*pow(Nu,2)*PhiDOT*r*
        pow(S2z,2) + 1967565600*delta*kappa2*pow(mass,4)*
        pow(Nu,2)*PhiDOT*r*pow(S2z,2) + 
       771891120*kappa2*pow(mass,3)*pow(PhiDOT,3)*pow(r,4)*
        pow(S2z,2) - 771891120*delta*kappa2*pow(mass,3)*
        pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) + 
       1271350080*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*
        pow(S2z,2) - 1271350080*delta*pow(mass,3)*Nu*
        pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) - 
       2754591840*kappa2*pow(mass,3)*Nu*pow(PhiDOT,3)*pow(r,4)*
        pow(S2z,2) + 1210809600*delta*kappa2*pow(mass,3)*Nu*
        pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) - 
       3390266880*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,3)*pow(r,4)*
        pow(S2z,2) - 332972640*delta*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) + 
       3571888320*kappa2*pow(mass,3)*pow(Nu,2)*pow(PhiDOT,3)*
        pow(r,4)*pow(S2z,2) - 
       1604322720*delta*kappa2*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,3)*pow(r,4)*pow(S2z,2) + 
       Complex(0,363242880)*pow(mass,4)*rDOT*pow(S2z,2) - 
       Complex(0,363242880)*delta*pow(mass,4)*rDOT*pow(S2z,2) - 
       Complex(0,2345943600)*kappa2*pow(mass,4)*rDOT*pow(S2z,2) + 
       Complex(0,2345943600)*delta*kappa2*pow(mass,4)*rDOT*
        pow(S2z,2) - Complex(0,1513512000)*pow(mass,4)*Nu*rDOT*
        pow(S2z,2) + Complex(0,787026240)*delta*pow(mass,4)*Nu*
        rDOT*pow(S2z,2) + Complex(0,5645399760)*kappa2*pow(mass,4)*
        Nu*rDOT*pow(S2z,2) - 
       Complex(0,953512560)*delta*kappa2*pow(mass,4)*Nu*rDOT*
        pow(S2z,2) + Complex(0,423783360)*pow(mass,4)*pow(Nu,2)*
        rDOT*pow(S2z,2) + Complex(0,423783360)*delta*pow(mass,4)*
        pow(Nu,2)*rDOT*pow(S2z,2) - 
       Complex(0,2482159680)*kappa2*pow(mass,4)*pow(Nu,2)*rDOT*
        pow(S2z,2) + Complex(0,2330808480)*delta*kappa2*
        pow(mass,4)*pow(Nu,2)*rDOT*pow(S2z,2) + 
       Complex(0,90810720)*kappa2*pow(mass,3)*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S2z,2) - 
       Complex(0,90810720)*delta*kappa2*pow(mass,3)*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S2z,2) + 
       Complex(0,1816214400)*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S2z,2) - 
       Complex(0,1816214400)*delta*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S2z,2) - 
       Complex(0,711350640)*kappa2*pow(mass,3)*Nu*pow(PhiDOT,2)*
        pow(r,3)*rDOT*pow(S2z,2) + 
       Complex(0,529729200)*delta*kappa2*pow(mass,3)*Nu*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S2z,2) - 
       Complex(0,10927556640)*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S2z,2) + 
       Complex(0,938377440)*delta*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S2z,2) + 
       Complex(0,2482159680)*kappa2*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S2z,2) - 
       Complex(0,151351200)*delta*kappa2*pow(mass,3)*pow(Nu,2)*
        pow(PhiDOT,2)*pow(r,3)*rDOT*pow(S2z,2) - 
       1611890280*kappa2*pow(mass,3)*PhiDOT*pow(r,2)*pow(rDOT,2)*
        pow(S2z,2) + 1611890280*delta*kappa2*pow(mass,3)*PhiDOT*
        pow(r,2)*pow(rDOT,2)*pow(S2z,2) - 
       544864320*pow(mass,3)*Nu*PhiDOT*pow(r,2)*pow(rDOT,2)*
        pow(S2z,2) + 544864320*delta*pow(mass,3)*Nu*PhiDOT*
        pow(r,2)*pow(rDOT,2)*pow(S2z,2) + 
       2103781680*kappa2*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S2z,2) + 
       1119998880*delta*kappa2*pow(mass,3)*Nu*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S2z,2) + 
       423783360*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S2z,2) - 
       60540480*delta*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S2z,2) + 
       2663781120*kappa2*pow(mass,3)*pow(Nu,2)*PhiDOT*pow(r,2)*
        pow(rDOT,2)*pow(S2z,2) - 
       696215520*delta*kappa2*pow(mass,3)*pow(Nu,2)*PhiDOT*
        pow(r,2)*pow(rDOT,2)*pow(S2z,2) - 
       Complex(0,1044323280)*kappa2*pow(mass,3)*r*pow(rDOT,3)*
        pow(S2z,2) + Complex(0,1044323280)*delta*kappa2*
        pow(mass,3)*r*pow(rDOT,3)*pow(S2z,2) + 
       Complex(0,3238915680)*kappa2*pow(mass,3)*Nu*r*pow(rDOT,3)*
        pow(S2z,2) - Complex(0,1150269120)*delta*kappa2*
        pow(mass,3)*Nu*r*pow(rDOT,3)*pow(S2z,2) - 
       Complex(0,302702400)*pow(mass,3)*pow(Nu,2)*r*pow(rDOT,3)*
        pow(S2z,2) + Complex(0,302702400)*delta*pow(mass,3)*
        pow(Nu,2)*r*pow(rDOT,3)*pow(S2z,2) - 
       Complex(0,242161920)*kappa2*pow(mass,3)*pow(Nu,2)*r*
        pow(rDOT,3)*pow(S2z,2) - 
       Complex(0,1513512000)*delta*kappa2*pow(mass,3)*pow(Nu,2)*r*
        pow(rDOT,3)*pow(S2z,2) + 
       74954880*delta*pow(mass,3)*
        (mass*(22*PhiDOT*r - Complex(0,24)*rDOT) + 
          3*r*(-7*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,14)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
             8*PhiDOT*r*pow(rDOT,2) + Complex(0,4)*pow(rDOT,3)))*
        log(r/r0) + 7991343360*delta*pow(mass,3)*Nu*
        (-(pow(PhiDOT,3)*pow(r,4)) - Complex(0,2)*mass*rDOT + 
          PhiDOT*pow(r,2)*pow(rDOT,2) + 
          Complex(0,2)*r*pow(rDOT,3))*log(r/r0p)))/
   (sqrt(14)*pow(r,4))));
    }
...
static COMPLEX16 hGO_4_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 2){
        ...
        + /* Henry et al. ecc spin terms */ ((pow(mass,2)*(Complex(0,-3)*pow(PhiDOT,2)*pow(r,3)*rDOT*
        ((-250 + 1221*Nu - 1512*pow(Nu,2) + delta*(-250 + 849*Nu))*
           S1z + (-250 + delta*(250 - 849*Nu) + 1221*Nu - 
             1512*pow(Nu,2))*S2z) - 
       2*mass*PhiDOT*r*((-130 + 757*Nu - 1224*pow(Nu,2) + 
             delta*(-130 + 513*Nu))*S1z + 
          (-130 + delta*(130 - 513*Nu) + 757*Nu - 1224*pow(Nu,2))*S2z
          ) - Complex(0,2)*mass*rDOT*
        ((-100 + 577*Nu - 864*pow(Nu,2) + delta*(-100 + 333*Nu))*
           S1z + (-100 + delta*(100 - 333*Nu) + 577*Nu - 
             864*pow(Nu,2))*S2z) - 
       6*pow(PhiDOT,3)*pow(r,4)*
        ((-65 + 263*Nu - 291*pow(Nu,2) + delta*(-65 + 282*Nu))*S1z + 
          (-65 + delta*(65 - 282*Nu) + 263*Nu - 291*pow(Nu,2))*S2z)\
        + 12*PhiDOT*pow(r,2)*pow(rDOT,2)*
        ((-40 + 201*Nu - 252*pow(Nu,2) + delta*(-40 + 129*Nu))*S1z + 
          (-40 + delta*(40 - 129*Nu) + 201*Nu - 252*pow(Nu,2))*S2z)\
        + Complex(0,6)*r*pow(rDOT,3)*
        ((-20 + 107*Nu - 144*pow(Nu,2) + delta*(-20 + 63*Nu))*S1z + 
          (-20 + delta*(20 - 63*Nu) + 107*Nu - 144*pow(Nu,2))*S2z)))/
       (72.*sqrt(35)*pow(r,3))));
    }
        ...
        /* Henry et al. QC spin terms *//* +((16*sqrt(0.7142857142857143)*(-1 + 3*Nu)*(kappa1*(1 + delta - 2*Nu)*pow(S1z,2) 
        + S2z*(4*Nu*S1z - kappa2*(-1 + delta + 2*Nu)*S2z))*pow(x,4))/9.) */
        +/* Henry et al. ecc spin terms */ ((sqrt(0.7142857142857143)*pow(mass,3)*(-1 + 3*Nu)*
        (12*mass + r*(53*pow(PhiDOT,2)*pow(r,2) + 
          Complex(0,26)*PhiDOT*r*rDOT - 8*pow(rDOT,2)))*
        (kappa1*(1 + delta - 2*Nu)*pow(S1z,2) + 
         S2z*(4*Nu*S1z + kappa2*S2z - delta*kappa2*S2z - 2*kappa2*Nu*S2z)
         ))/(48.*pow(r,4))));
    }

    else if(vpnorder == 7){

        return(/* Henry et al. QC spin terms *//* (8*(6630*pow(Nu,3)*(S1z + S2z) - 786*(S1z + delta*S1z + S2z - delta*S2z) 
        + 21*Nu*(273*delta*(S1z - S2z) + 173*(S1z + S2z)) - 2*pow(Nu,2)*(1557*delta*(S1z - S2z)
         + 2960*(S1z + S2z)))*pow(x,4.5))/(297.*sqrt(35))
         + *//* Henry et al. ecc+spin terms */((pow(mass,2)*(14*pow(mass,2)*
        (120*pow(Nu,3)*(24635*PhiDOT*r + Complex(0,18657)*rDOT)*
           (S1z + S2z) - 60*(10039*PhiDOT*r + Complex(0,7706)*rDOT)*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          5*Nu*(PhiDOT*r*(Complex(0,448616) + 703833*S1z + 
                505635*delta*S1z + 703833*S2z - 505635*delta*S2z) + 
             Complex(0,4)*rDOT*
              (Complex(0,4175) + 123114*S1z + 76938*delta*S1z + 
                123114*S2z - 76938*delta*S2z)) - 
          6*pow(Nu,2)*(2*PhiDOT*r*
              (Complex(0,217374) + 549175*S1z + 61075*delta*S1z + 
                549175*S2z - 61075*delta*S2z) + 
             Complex(0,5)*rDOT*
              (Complex(0,9861) + 132241*S1z + 18825*delta*S1z + 
                132241*S2z - 18825*delta*S2z))) - 
            3*pow(r,2)*(1680*pow(Nu,3)*
           (2833*pow(PhiDOT,5)*pow(r,5) + 
             ...
             Complex(0,1186)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3) - 5863*PhiDOT*r*pow(rDOT,4) - 
             Complex(0,2100)*pow(rDOT,5))*(S1z + S2z) - 
             1050*(454*pow(PhiDOT,5)*pow(r,5) + 
             Complex(0,1195)*pow(PhiDOT,4)*pow(r,4)*rDOT - 
             1950*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) - 
             Complex(0,442)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
             384*PhiDOT*r*pow(rDOT,4) - Complex(0,184)*pow(rDOT,5))
            *(S1z + delta*S1z + S2z - delta*S2z) - 
            6*pow(Nu,2)*(2*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,-2459811) + 35*(26517 + 10223*delta)*S1z + 
                (928095 - 357805*delta)*S2z) - 
             Complex(0,10)*pow(rDOT,5)*
              (Complex(0,35291) + 28*(2183 + 1155*delta)*S1z + 
                (61124 - 32340*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,917901) + 1120*(-191 + 1616*delta)*S1z - 
                1120*(191 + 1616*delta)*S2z) + 
             5*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,85426) + 7*(-148363 + 4365*delta)*S1z - 
                7*(148363 + 4365*delta)*S2z) - 
             4*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,280067) + 70*(5844 + 4817*delta)*S1z - 
                70*(-5844 + 4817*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,10375501) + 70*(65831 + 22871*delta)*S1z - 
                70*(-65831 + 22871*delta)*S2z)) + 
             Nu*(Complex(0,-40)*pow(rDOT,5)*
              (Complex(0,12203) + 42*(843 + 656*delta)*S1z - 
                42*(-843 + 656*delta)*S2z) + 
             Complex(0,4)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,-266071) + 210*(-2279 + 1010*delta)*S1z - 
                210*(2279 + 1010*delta)*S2z) - 
             16*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,58753) + 105*(2030 + 1947*delta)*S1z - 
                105*(-2030 + 1947*delta)*S2z) + 
             pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,-8997592) + 105*(39959 + 15835*delta)*S1z - 
                105*(-39959 + 15835*delta)*S2z) - 
             10*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,254228) + 21*(65293 + 34551*delta)*S1z - 
                21*(-65293 + 34551*delta)*S2z) + 
             Complex(0,2)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,12351083) + 105*(43193 + 37913*delta)*S1z - 
                105*(-43193 + 37913*delta)*S2z))) + 
             mass*r*(2520*pow(Nu,3)*
           (8036*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,41814)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
             30537*PhiDOT*r*pow(rDOT,2) - 
             Complex(0,9064)*pow(rDOT,3))*(S1z + S2z) - 
          210*(11849*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,31868)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
             3572*PhiDOT*r*pow(rDOT,2) + 
             Complex(0,1508)*pow(rDOT,3))*
           (S1z + delta*S1z + S2z - delta*S2z) - 
          12*pow(Nu,2)*(Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,-1150397) + 35*(154765 + 157449*delta)*S1z + 
                5416775*S2z - 5510715*delta*S2z) - 
             PhiDOT*r*pow(rDOT,2)*
              (Complex(0,2306552) + 35*(4931 + 110733*delta)*S1z + 
                172585*S2z - 3875655*delta*S2z) + 
             pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,12461121) + 35*(18331 + 87381*delta)*S1z + 
                641585*S2z - 3058335*delta*S2z) - 
             Complex(0,25)*pow(rDOT,3)*
              (Complex(0,36676) + 35*(137 + 1053*delta)*S1z + 
                4795*S2z - 36855*delta*S2z)) + 
          Nu*(Complex(0,-200)*pow(rDOT,3)*
              (Complex(0,-2501) + 42*(-308 + 51*delta)*S1z - 
                42*(308 + 51*delta)*S2z) + 
             2*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,-1951984) - 105*(-37907 + 14661*delta)*S1z + 
                105*(37907 + 14661*delta)*S2z) + 
             Complex(0,8)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,-10005028) + 105*(40991 + 31689*delta)*S1z - 
                105*(-40991 + 31689*delta)*S2z) + 
             pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,88418488) + 105*(57793 + 266391*delta)*S1z - 
...
static COMPLEX16 hGO_4_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 3){
        ...
        + Complex(0,112)*pow(rDOT,3))))/(180.*sqrt(70)*pow(r,2))/* Henry et al. QC spin terms *//* +((Complex(0,0.03409090909090909)
        *(220*(S1z - S2z + delta*(S1z + S2z)) + Nu*(-2403*(S1z - S2z) + 203*delta*(S1z + S2z)) + 
       pow(Nu,2)*(3359*(S1z - S2z) + 457*delta*(S1z + S2z)))*pow(x,4))/sqrt(70)) */
       + /* Henry et al. ecc spin terms */ ((Complex(0,-0.0006313131313131314)*pow(mass,2)*
     (2*pow(mass,2)*((-440 + 6801*Nu - 1428*pow(Nu,2) + 
             delta*(-440 - 3193*Nu + 300*pow(Nu,2)))*S1z + 
          (440 - 6801*Nu + 1428*pow(Nu,2) + 
             delta*(-440 - 3193*Nu + 300*pow(Nu,2)))*S2z) - 
       2*mass*r*(Complex(0,-3)*PhiDOT*r*rDOT*
          ...
          2*pow(rDOT,2)*((220 + 1659*Nu - 1512*pow(Nu,2) + 
                delta*(220 - 3067*Nu + 240*pow(Nu,2)))*S1z + 
             (-220 - 1659*Nu + 1512*pow(Nu,2) + 
                delta*(220 - 3067*Nu + 240*pow(Nu,2)))*S2z) + 
          2*pow(PhiDOT,2)*pow(r,2)*
           ((1826 - 19530*Nu + 20145*pow(Nu,2) + 
                delta*(1826 + 1534*Nu + 567*pow(Nu,2)))*S1z + 
             (-1826 + 19530*Nu - 20145*pow(Nu,2) + 
                delta*(1826 + 1534*Nu + 567*pow(Nu,2)))*S2z)) - 
       3*pow(r,2)*(Complex(0,3080)*pow(PhiDOT,3)*pow(r,3)*rDOT*
           ((1 + delta)*S1z + (-1 + delta)*S2z) + 
          2*pow(Nu,2)*(129*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
        ...
        return(/*Henry et al. QC spin terms *//* (Complex(0,-0.020833333333333332)*pow(x,4.5)*(54*(10*(4 + delta)*pow(Nu,2) 
        ...
        + */ /* Henry et al. ecc+spin terms */ ((Complex(0,-1.3875013875013875e-6)*mass*
     (5005*pow(mass,2)*(-24*PhiDOT*pow(r,2)*pow(rDOT,2)*
           (Complex(0,1)*(-11 + 48*Nu)*S1z + 
             6*(-5 + 4*kappa1)*pow(Nu,2)*pow(S1z,2) + 
             S2z*(Complex(0,11) - Complex(0,48)*Nu - 
                6*(-5 + 4*kappa2)*pow(Nu,2)*S2z)) + 
             4*r*pow(rDOT,3)*((-11 + 93*Nu)*S1z - 
             Complex(0,6)*(-5 + 4*kappa1)*pow(Nu,2)*pow(S1z,2) + 
             S2z*(11 - 93*Nu + 
                Complex(0,6)*(-5 + 4*kappa2)*pow(Nu,2)*S2z)) + 
             4*mass*rDOT*((22 - 111*Nu)*S1z + 
             Complex(0,6)*(15 + 8*kappa1)*pow(Nu,2)*pow(S1z,2) + 
             S2z*(-22 + 111*Nu - 
                Complex(0,6)*(15 + 8*kappa2)*pow(Nu,2)*S2z)) + 
             Complex(0,6)*pow(PhiDOT,2)*pow(r,3)*rDOT*
           (Complex(0,1)*(-121 + 963*Nu)*S1z + 
             6*(-55*pow(Nu,2) + kappa1*(-5 + 30*Nu + 4*pow(Nu,2)))*
              pow(S1z,2) + 
             S2z*(Complex(0,121) + 30*kappa2*S2z - 
                6*(-55 + 4*kappa2)*pow(Nu,2)*S2z - 
                9*Nu*(Complex(0,107) + 20*kappa2*S2z))) + 
             2*mass*PhiDOT*r*(Complex(0,-1)*(-121 + 633*Nu)*S1z + 
             6*(180*pow(Nu,2) + kappa1*(9 - 54*Nu + 28*pow(Nu,2)))*
              pow(S1z,2) - 
           ...
           (Complex(0,-1)*(-649 + 4767*Nu)*S1z + 
             6*(820*pow(Nu,2) + 
                kappa1*(75 - 450*Nu + 364*pow(Nu,2)))*pow(S1z,2) - 
             S2z*(Complex(0,649) + 450*kappa2*S2z + 
                24*(205 + 91*kappa2)*pow(Nu,2)*S2z - 
                3*Nu*(Complex(0,1589) + 900*kappa2*S2z)))) + 
              delta*(2*mass*PhiDOT*pow(r,3)*
           (10*(234744 - 1010534*Nu + 1024443*pow(Nu,2) + 
                5451096*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4) - 
             Complex(0,3)*(-2426804 + 1512854*Nu + 
                4994115*pow(Nu,2) + 610960*pow(Nu,3))*
              pow(PhiDOT,3)*pow(r,3)*rDOT + 
             (-30341028 + 23936528*Nu + 89326545*pow(Nu,2) + 
                19329660*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,2) + 
             Complex(0,21)*(-668008 + 803028*Nu + 
                1908955*pow(Nu,2) + 540370*pow(Nu,3))*PhiDOT*r*
              pow(rDOT,3) - 
             14*(-172143 + 155683*Nu + 680580*pow(Nu,2) + 
                111840*pow(Nu,3))*pow(rDOT,4)) - 
              105*PhiDOT*pow(r,4)*
              ((-8280 + 24681*Nu - 151973*pow(Nu,2) + 
                624074*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6) + 
             Complex(0,2)*(-32208 + 248485*Nu - 524074*pow(Nu,2) + 
                24546*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*rDOT + 
             2*(48924 - 239802*Nu + 137447*pow(Nu,2) + 
                358156*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
              pow(rDOT,2) + 
             Complex(0,4)*(174 + 24488*Nu - 102039*pow(Nu,2) + 
                44882*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
              pow(rDOT,3) + 
             3*(10455 - 56490*Nu + 84504*pow(Nu,2) + 
                54016*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,4) + 
             Complex(0,2)*(11175 - 52698*Nu + 57436*pow(Nu,2) + 
                60808*pow(Nu,3))*PhiDOT*r*pow(rDOT,5) - 
             6*(829 - 3726*Nu + 3480*pow(Nu,2) + 4640*pow(Nu,3))*
              pow(rDOT,6)) + 
              pow(mass,2)*r*(20020*pow(rDOT,3)*(S1z + S2z)*
              (-11 + 71*Nu + Complex(0,30)*pow(Nu,2)*(S1z + S2z)) - 
             52*PhiDOT*r*pow(rDOT,2)*
              (129150*pow(Nu,3) + 
                7*Nu*(31961 + Complex(0,8580)*S1z + 
                   Complex(0,8580)*S2z) - 
                Complex(0,3)*
             ...
             pow(PhiDOT,3)*pow(r,3)*
              (-10566168 - 70869960*pow(Nu,3) + 
                Complex(0,3248245)*S1z + 2252250*kappa1*pow(S1z,2) + 
                Complex(0,3248245)*S2z + 2252250*kappa2*pow(S2z,2) - 
                7*Nu*(4818166 + Complex(0,2480335)*S1z + 
                   1287000*kappa1*pow(S1z,2) + 
                   Complex(0,2480335)*S2z + 1287000*kappa2*pow(S2z,2)
                   ) + 3850*pow(Nu,2)*
                 (38873 + 78*(7 + 30*kappa1)*pow(S1z,2) - 
                   3588*S1z*S2z + 78*(7 + 30*kappa2)*pow(S2z,2))) - 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (6531280*pow(Nu,3) + 
                3*(5382288 + Complex(0,605605)*S1z + 
                   150150*kappa1*pow(S1z,2) + 
                   Complex(0,605605)*S2z + 150150*kappa2*pow(S2z,2))\
                 + 210*pow(Nu,2)*
                 (322144 + 2145*(1 + 4*kappa1)*pow(S1z,2) - 
                   12870*S1z*S2z + 2145*(1 + 4*kappa2)*pow(S2z,2)) - 
                21*Nu*(2826484 + 85800*kappa1*pow(S1z,2) + 
                   Complex(0,515515)*S2z + 85800*kappa2*pow(S2z,2) - 
                   5005*S1z*(Complex(0,-103) + 60*S2z)))) - 
                 26*pow(mass,3)*(770*rDOT*
              (Complex(0,-90)*pow(Nu,2)*pow(S1z,2) + 
                S2z*(-22 + 67*Nu - Complex(0,90)*pow(Nu,2)*S2z) + 
                S1z*(-22 + Nu*(67 + Complex(0,300)*S2z) - 
                   Complex(0,180)*pow(Nu,2)*S2z)) + 
              PhiDOT*r*(-38076 + 174720*pow(Nu,3) - 
                Complex(0,46585)*S1z - 20790*kappa1*pow(S1z,2) - 
                Complex(0,46585)*S2z - 20790*kappa2*pow(S2z,2) - 
                1260*pow(Nu,2)*
                 (158 + 33*(5 + 2*kappa1)*pow(S1z,2) + 198*S1z*S2z + 
                   33*(5 + 2*kappa2)*pow(S2z,2)) + 
                7*Nu*(6188 + 11880*kappa1*pow(S1z,2) + 
                   Complex(0,21505)*S2z + 11880*kappa2*pow(S2z,2) + 
...
static COMPLEX16 hGO_4_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 2){
        ...
        +/* Henry et al. ecc spin terms */ ((pow(mass,2)*(Complex(0,2)*mass*rDOT*
        ((-100 - 100*delta + 577*Nu + 333*delta*Nu - 864*pow(Nu,2))*
           S1z + (-100 + 100*delta + 577*Nu - 333*delta*Nu - 
             864*pow(Nu,2))*S2z) + 
       4*mass*PhiDOT*r*((-70 - 70*delta + 253*Nu + 237*delta*Nu - 
             156*pow(Nu,2))*S1z + 
          (-70 + 70*delta + 253*Nu - 237*delta*Nu - 156*pow(Nu,2))*
           S2z) - 3*r*(Complex(0,2)*pow(rDOT,3)*
           ((-20 - 20*delta + 107*Nu + 63*delta*Nu - 144*pow(Nu,2))*
              S1z + (-20 + 20*delta + 107*Nu - 63*delta*Nu - 
                144*pow(Nu,2))*S2z) + 
          4*PhiDOT*r*pow(rDOT,2)*
           ((-20 - 20*delta + 63*Nu + 67*delta*Nu - 16*pow(Nu,2))*
              S1z + (-20 + 20*delta + 63*Nu - 67*delta*Nu - 
                16*pow(Nu,2))*S2z) + 
          4*pow(PhiDOT,3)*pow(r,3)*
           ((5 + 5*delta - 7*Nu + 2*delta*Nu - 41*pow(Nu,2))*S1z - 
             (-5 + 5*delta + 7*Nu + 2*delta*Nu + 41*pow(Nu,2))*S2z)\
           - Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*rDOT*
           ((-10 - 10*delta - 339*Nu + 89*delta*Nu + 1048*pow(Nu,2))*
              S1z + (-10 + 10*delta - 339*Nu - 89*delta*Nu + 
                1048*pow(Nu,2))*S2z))))/(504.*sqrt(5)*pow(r,3))));
    }
        ...
        + 10*(-10233 + 44864*Nu + 13050*pow(Nu,2) 
        - 203280*pow(Nu,3))*pow(rDOT,6)))/(5.04504e6*sqrt(5)*pow(r,4)) /* Henry et al. QC spin terms */ /* +((2*sqrt(5)*(kappa1*(1 + delta - 2*Nu 
        + 6*pow(Nu,2))*pow(S1z,2) + S2z*(4*(1 - 3*Nu)*Nu*S1z - kappa2*(-1 + delta + 2*Nu - 6*pow(Nu,2))*S2z))*pow(x,4))/63.) */
        + /* Henry et al. ecc spin terms */ ((sqrt(5)*pow(mass,3)*(kappa1*
        (mass*(12 + delta*(12 - 34*Nu) - 58*Nu + 72*pow(Nu,2)) + 
          r*((5 - delta*(-5 + Nu) - 11*Nu + 30*pow(Nu,2))*
              pow(PhiDOT,2)*pow(r,2) + 
             Complex(0,1)*(13 + delta*(13 - 59*Nu) - 85*Nu + 
                78*pow(Nu,2))*PhiDOT*r*rDOT + 
             4*(-2 + 11*Nu - 12*pow(Nu,2) + delta*(-2 + 7*Nu))*
              pow(rDOT,2)))*pow(S1z,2) + 
       S2z*(-2*mass*(-24*Nu*S1z + 6*(-1 + delta)*kappa2*S2z + 
             (29 - 17*delta)*kappa2*Nu*S2z + 
             36*pow(Nu,2)*(2*S1z - kappa2*S2z)) + 
          r*(-((-1 + delta)*kappa2*
                (5*pow(PhiDOT,2)*pow(r,2) + 
                  Complex(0,13)*PhiDOT*r*rDOT - 8*pow(rDOT,2))*S2z)\
              - 6*pow(Nu,2)*
              (5*pow(PhiDOT,2)*pow(r,2) + 
                Complex(0,13)*PhiDOT*r*rDOT - 8*pow(rDOT,2))*
              (2*S1z - kappa2*S2z) + 
             Nu*(pow(PhiDOT,2)*pow(r,2)*
                 (20*S1z + (-11 + delta)*kappa2*S2z) - 
                4*pow(rDOT,2)*(8*S1z + (-11 + 7*delta)*kappa2*S2z) + 
                Complex(0,1)*PhiDOT*r*rDOT*
                 (52*S1z + (-85 + 59*delta)*kappa2*S2z))))))/
   (168.*pow(r,4))));
    }

    else if(vpnorder == 7){

        return(/* Henry et al. QC spin terms *//* ((-5958*delta*pow(Nu,2)*(S1z - S2z) + 45*delta*Nu*(-S1z + S2z) 
        - 6009*Nu*(S1z + S2z) + 7528*pow(Nu,2)*(S1z + S2z) - 1134*pow(Nu,3)*(S1z + S2z) + 
       1104*(S1z + delta*S1z + S2z - delta*S2z))*pow(x,4.5))/(2079.*sqrt(5))
       + *//* Henry et al. ecc+spin terms */ ((pow(mass,2)*(-14*pow(mass,2)*
        (60*pow(Nu,3)*(6830*PhiDOT*r + Complex(0,18657)*rDOT)*
           (S1z + S2z) - 30*(10617*PhiDOT*r + Complex(0,7706)*rDOT)*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          5*Nu*(PhiDOT*r*(Complex(0,224308) + 
                3*(67379 + 79865*delta)*S1z + 202137*S2z - 
                239595*delta*S2z) + 
             Complex(0,4)*rDOT*
              (Complex(0,4175) + (61557 + 38469*delta)*S1z + 
                61557*S2z - 38469*delta*S2z)) - 
          3*pow(Nu,2)*(4*PhiDOT*r*
              (Complex(0,108687) + 41225*S1z + 29825*delta*S1z + 
                41225*S2z - 29825*delta*S2z) + 
             Complex(0,5)*rDOT*
              (Complex(0,19722) + 132241*S1z + 18825*delta*S1z + 
                132241*S2z - 18825*delta*S2z))) - 
       3*pow(r,2)*(840*pow(Nu,3)*
           (3159*pow(PhiDOT,5)*pow(r,5) + 
             ...
             Complex(0,13970)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3) - 1546*PhiDOT*r*pow(rDOT,4) + 
             Complex(0,2100)*pow(rDOT,5))*(S1z + S2z) - 
          525*(354*pow(PhiDOT,5)*pow(r,5) + 
             Complex(0,453)*pow(PhiDOT,4)*pow(r,4)*rDOT - 
             60*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) + 
             Complex(0,1546)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3) - 336*PhiDOT*r*pow(rDOT,4) + 
             Complex(0,184)*pow(rDOT,5))*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          Nu*(Complex(0,7)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,1062898) + 15*(11275 + 23003*delta)*S1z + 
                (169125 - 345045*delta)*S2z) - 
             8*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,-58753) + 420*(145 + 6*delta)*S1z - 
                420*(-145 + 6*delta)*S2z) + 
             Complex(0,40)*pow(rDOT,5)*
              (Complex(0,12203) + 21*(843 + 656*delta)*S1z - 
                21*(-843 + 656*delta)*S2z) - 
             5*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,240964) + 21*(-20361 + 2747*delta)*S1z - 
                21*(20361 + 2747*delta)*S2z) + 
             2*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,1832842) + 105*(-13567 + 6603*delta)*S1z - 
                105*(13567 + 6603*delta)*S2z) + 
             Complex(0,4)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,97999) + 105*(9121 + 7144*delta)*S1z - 
                105*(-9121 + 7144*delta)*S2z)) + 
          6*pow(Nu,2)*(Complex(0,-10)*pow(rDOT,5)*
              (Complex(0,35291) + 14*(2183 + 1155*delta)*S1z + 
                (30562 - 16170*delta)*S2z) - 
             Complex(0,3)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,120747) + 280*(1571 + 165*delta)*S1z - 
                280*(-1571 + 165*delta)*S2z) + 
             2*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,-280067) - 140*(-124 + 1293*delta)*S1z + 
                140*(124 + 1293*delta)*S2z) + 
             5*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,45393) + 14*(-12899 + 1573*delta)*S1z - 
                14*(12899 + 1573*delta)*S2z) - 
             Complex(0,7)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,213613) + 5*(31897 + 4025*delta)*S1z - 
                5*(-31897 + 4025*delta)*S2z) + 
             pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,-2032699) - 35*(-33139 + 11613*delta)*S1z + 
                35*(33139 + 11613*delta)*S2z))) + 
       mass*r*(2520*pow(Nu,3)*
           (3772*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,22365)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
             1427*PhiDOT*r*pow(rDOT,2) + 
             Complex(0,4532)*pow(rDOT,3))*(S1z + S2z) + 
          420*(643*pow(PhiDOT,3)*pow(r,3) - 
             Complex(0,17143)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
             4684*PhiDOT*r*pow(rDOT,2) + Complex(0,377)*pow(rDOT,3)
             )*(S1z + delta*S1z + S2z - delta*S2z) - 
          6*pow(Nu,2)*(Complex(0,25)*pow(rDOT,3)*
              (Complex(0,73352) + 35*(137 + 1053*delta)*S1z + 
                (4795 - 36855*delta)*S2z) + 
             pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,3625463) + 70*(45113 + 1515*delta)*S1z - 
                70*(-45113 + 1515*delta)*S2z) + 
             4*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,576638) + 245*(-884 + 2103*delta)*S1z - 
                245*(884 + 2103*delta)*S2z) - 
             Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,-3147986) + 35*(-290963 + 34473*delta)*S1z - 
                35*(290963 + 34473*delta)*S2z)) + 
          Nu*(Complex(0,200)*pow(rDOT,3)*
              (Complex(0,-2501) + 21*(-308 + 51*delta)*S1z - 
                21*(308 + 51*delta)*S2z) + 
             5*pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,1501652) - 21*(-37535 + 8031*delta)*S1z + 
                21*(37535 + 8031*delta)*S2z) - 
             2*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,-975992) + 105*(33593 + 24921*delta)*S1z - 
                105*(-33593 + 24921*delta)*S2z) + 
             Complex(0,4)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,4843364) + 105*(88681 + 40215*delta)*S1z - 
...
static COMPLEX16 hGO_4_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 3){
        ...
        + /*Henry et al. ecc spin terms*/ ((Complex(0,0.00027056277056277056)*pow(mass,2)*
     (2*pow(mass,2)*((-440 + 6801*Nu - 1428*pow(Nu,2) + 
             delta*(-440 - 3193*Nu + 300*pow(Nu,2)))*S1z + 
          (440 - 6801*Nu + 1428*pow(Nu,2) + 
             delta*(-440 - 3193*Nu + 300*pow(Nu,2)))*S2z) + 
       2*mass*r*(Complex(0,1)*PhiDOT*r*rDOT*
          ...
          2*pow(PhiDOT,2)*pow(r,2)*
           ((-66 + 158*Nu - 3389*pow(Nu,2) + 
                delta*(-66 + 238*Nu + 301*pow(Nu,2)))*S1z + 
             (66 - 158*Nu + 3389*pow(Nu,2) + 
                delta*(-66 + 238*Nu + 301*pow(Nu,2)))*S2z)) + 
       pow(r,2)*(Complex(0,3960)*pow(PhiDOT,3)*pow(r,3)*rDOT*
           ((1 + delta)*S1z + (-1 + delta)*S2z) + 
          2*pow(Nu,2)*(6*pow(rDOT,4)*
              (149*S1z + 75*delta*S1z - 149*S2z + 75*delta*S2z) + 
             7*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
              (331*S1z + 293*delta*S1z - 331*S2z + 293*delta*S2z) - 
             Complex(0,2)*PhiDOT*r*pow(rDOT,3)*
              (925*S1z + 491*delta*S1z - 925*S2z + 491*delta*S2z) + 
             pow(PhiDOT,4)*pow(r,4)*
              (2593*S1z + 551*delta*S1z - 2593*S2z + 551*delta*S2z) + 
             Complex(0,1)*pow(PhiDOT,3)*pow(r,3)*rDOT*
              (8815*S1z + 2393*delta*S1z - 8815*S2z + 2393*delta*S2z))\
           + Nu*(6*pow(rDOT,4)*
              (-301*S1z + 213*delta*S1z + 301*S2z + 213*delta*S2z) + 
             8*pow(PhiDOT,4)*pow(r,4)*
              (-349*S1z + 305*delta*S1z + 349*S2z + 305*delta*S2z) - 
             Complex(0,2)*PhiDOT*r*pow(rDOT,3)*
              (-1625*S1z + 1009*delta*S1z + 1625*S2z + 1009*delta*S2z)\
              + pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
              (-4973*S1z + 2773*delta*S1z + 4973*S2z + 2773*delta*S2z)\
              - Complex(0,2)*pow(PhiDOT,3)*pow(r,3)*rDOT*
              (1765*S1z + 14779*delta*S1z - 1765*S2z + 14779*delta*S2z)
             ))))/(sqrt(10)*pow(r,4))));
    }

    else if(vpnorder == 7){

        return(/* Henry et al. QC spiun terms *//* (Complex(0,0.000992063492063492)*pow(x,4.5)*(6*(10*(4 + delta)*pow(Nu,2)
       ...
       + *//* Henry et al. ecc+spin terms */ ((Complex(0,1.9821448392876965e-7)*mass*
     (-(delta*(14*mass*PhiDOT*pow(r,3)*
             (2*(243784 - 839354*Nu + 840205*pow(Nu,2) + 
                  1464600*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4) - 
               Complex(0,3)*(-14468 - 3185682*Nu + 
                  8381955*pow(Nu,2) + 30000*pow(Nu,3))*
                pow(PhiDOT,3)*pow(r,3)*rDOT + 
               5*(-657932 + 496144*Nu + 2150479*pow(Nu,2) + 
                  542628*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
                pow(rDOT,2) - 
               Complex(0,3)*(-668008 + 803028*Nu + 
                  1908955*pow(Nu,2) + 540370*pow(Nu,3))*PhiDOT*r*
                pow(rDOT,3) + 
               6*(-172143 + 155683*Nu + 680580*pow(Nu,2) + 
                  111840*pow(Nu,3))*pow(rDOT,4)) - 
            105*PhiDOT*pow(r,4)*
             ((1320 - 35155*Nu + 36743*pow(Nu,2) + 
                  241538*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6) + 
               Complex(0,26)*
                (-7536 + 50167*Nu - 84782*pow(Nu,2) + 
                  22*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*rDOT + 
               2*(46908 - 203266*Nu + 59723*pow(Nu,2) + 
                  272204*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
                pow(rDOT,2) - 
               Complex(0,4)*(38798 - 217656*Nu + 324761*pow(Nu,2) + 
                  67186*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
                pow(rDOT,3) + 
               (58177 - 260454*Nu + 239688*pow(Nu,2) + 
                  324160*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
                pow(rDOT,4) - 
               Complex(0,2)*(11175 - 52698*Nu + 57436*pow(Nu,2) + 
                  60808*pow(Nu,3))*PhiDOT*r*pow(rDOT,5) + 
               18*(829 - 3726*Nu + 3480*pow(Nu,2) + 
                  4640*pow(Nu,3))*pow(rDOT,6)) + 
            26*pow(mass,3)*
             (2310*rDOT*(Complex(0,-30)*pow(Nu,2)*pow(S1z,2) + 
                  S2z*(-22 + 67*Nu - Complex(0,30)*pow(Nu,2)*S2z) + 
                  S1z*(-22 + Nu*(67 + Complex(0,100)*S2z) - 
                     Complex(0,60)*pow(Nu,2)*S2z)) + 
               PhiDOT*r*(-114228 + 524160*pow(Nu,3) - 
                  Complex(0,46585)*S1z - 62370*kappa1*pow(S1z,2) - 
                  Complex(0,46585)*S2z - 62370*kappa2*pow(S2z,2) - 
                  420*pow(Nu,2)*
                   (1422 + 11*(-25 + 54*kappa1)*pow(S1z,2) - 
                     1738*S1z*S2z + 11*(-25 + 54*kappa2)*pow(S2z,2))\
                   + 7*Nu*(18564 + 35640*kappa1*pow(S1z,2) + 
                     Complex(0,21505)*S2z + 
                     35640*kappa2*pow(S2z,2) + 
                     55*S1z*(Complex(0,391) + 312*S2z)))) + 
            pow(mass,2)*r*(60060*pow(rDOT,3)*(S1z + S2z)*
                (11 - 71*Nu - Complex(0,10)*pow(Nu,2)*(S1z + S2z)) + 
               156*PhiDOT*r*pow(rDOT,2)*
                (98013 + 129150*pow(Nu,3) - Complex(0,8470)*S1z + 
                  7*Nu*(31961 + Complex(0,2860)*S1z + 
                     Complex(0,2860)*S2z) - Complex(0,8470)*S2z + 
                  35*pow(Nu,2)*
                   (-33313 + 220*pow(S1z,2) + 440*S1z*S2z + 
                     220*pow(S2z,2))) - 
               5*pow(PhiDOT,3)*pow(r,3)*
                (3966680 + 5749576*pow(Nu,3) - 
                  Complex(0,231231)*S1z - 90090*kappa1*pow(S1z,2) - 
                  Complex(0,231231)*S2z - 90090*kappa2*pow(S2z,2) + 
                  7*Nu*(-921242 + Complex(0,110253)*S1z + 
                     51480*kappa1*pow(S1z,2) + 
                     Complex(0,110253)*S2z + 51480*kappa2*pow(S2z,2))
                    - 462*pow(Nu,2)*
                   (10483 + 130*(-5 + 6*kappa1)*pow(S1z,2) - 
                     2860*S1z*S2z + 130*(-5 + 6*kappa2)*pow(S2z,2)))\
                + Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
                (6531280*pow(Nu,3) + 
                  3*(5382288 - Complex(0,385385)*S1z + 
                     150150*kappa1*pow(S1z,2) - 
                     Complex(0,385385)*S2z + 150150*kappa2*pow(S2z,2)
                     ) + 210*pow(Nu,2)*
                   (322144 + 715*(19 + 12*kappa1)*pow(S1z,2) + 
                     10010*S1z*S2z + 715*(19 + 12*kappa2)*pow(S2z,2))
                    - 21*Nu*(2826484 + 85800*kappa1*pow(S1z,2) - 
             ...
             4*pow(rDOT,3)*
              ((11 - 93*Nu)*S1z + 
                Complex(0,2)*(-5 + 4*kappa1)*pow(Nu,2)*
                 pow(S1z,2) + 
                S2z*(-11 + 93*Nu - 
                   Complex(0,2)*(-5 + 4*kappa2)*pow(Nu,2)*S2z)) + 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,1)*(-77 + 351*Nu)*S1z + 
                2*(245*pow(Nu,2) + 
                   kappa1*(15 - 90*Nu + 68*pow(Nu,2)))*pow(S1z,2)\
                 - S2z*(Complex(0,-77) + 30*kappa2*S2z + 
                   2*(245 + 68*kappa2)*pow(Nu,2)*S2z - 
                   9*Nu*(Complex(0,-39) + 20*kappa2*S2z))) + 
             pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,-1)*(-77 + 411*Nu)*S1z + 
                2*(100*pow(Nu,2) + 
                   kappa1*(15 - 90*Nu + 172*pow(Nu,2)))*pow(S1z,2)\
                 - S2z*(Complex(0,77) + 30*kappa2*S2z + 
                   8*(25 + 43*kappa2)*pow(Nu,2)*S2z - 
                   3*Nu*(Complex(0,137) + 60*kappa2*S2z)))) + 
          2*mass*(6*rDOT*((22 - 111*Nu)*S1z + 
                Complex(0,2)*(15 + 8*kappa1)*pow(Nu,2)*
                 pow(S1z,2) + 
                S2z*(-22 + 111*Nu - 
                   Complex(0,2)*(15 + 8*kappa2)*pow(Nu,2)*S2z)) + 
             PhiDOT*r*(Complex(0,-1)*(-121 + 633*Nu)*S1z + 
                6*(220*pow(Nu,2) + 
                   3*kappa1*(9 - 54*Nu + 76*pow(Nu,2)))*pow(S1z,2)\
                 - S2z*(Complex(0,121) + 162*kappa2*S2z + 
                   24*(55 + 57*kappa2)*pow(Nu,2)*S2z - 
                   3*Nu*(Complex(0,211) + 324*kappa2*S2z)))))))/
   (sqrt(10)*pow(r,4))));
    }
    ...
    if(vpnorder == 3){
        ...
        + /* Henry et al. ecc spin terms */ ((Complex(0,-0.006944444444444444)*pow(mass,2)*
         (pow(mass,2)*((90 - 622*Nu + 966*pow(Nu,2) + 
             delta*(90 - 524*Nu + 770*pow(Nu,2)))*S1z + 
          2*(-45 + 311*Nu - 483*pow(Nu,2) + 
             delta*(45 - 262*Nu + 385*pow(Nu,2)))*S2z) + 
       3*pow(r,2)*(4*pow(rDOT,4)*
           ((15 - 92*Nu + 126*pow(Nu,2) + 
                delta*(15 - 64*Nu + 70*pow(Nu,2)))*S1z + 
             (-15 + 92*Nu - 126*pow(Nu,2) + 
                delta*(15 - 64*Nu + 70*pow(Nu,2)))*S2z) - 
          15*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
           ((41 - 258*Nu + 364*pow(Nu,2) + 
                delta*(41 - 154*Nu + 156*pow(Nu,2)))*S1z + 
             (-41 + 258*Nu - 364*pow(Nu,2) + 
                delta*(41 - 154*Nu + 156*pow(Nu,2)))*S2z) - 
          Complex(0,4)*PhiDOT*r*pow(rDOT,3)*
           ((75 - 464*Nu + 642*pow(Nu,2) + 
                delta*(75 - 298*Nu + 310*pow(Nu,2)))*S1z + 
             (-75 + 464*Nu - 642*pow(Nu,2) + 
                delta*(75 - 298*Nu + 310*pow(Nu,2)))*S2z) + 
          pow(PhiDOT,4)*pow(r,4)*
           ((300 - 2347*Nu + 4041*pow(Nu,2) + 
                delta*(300 - 869*Nu + 1085*pow(Nu,2)))*S1z + 
             (-300 + 2347*Nu - 4041*pow(Nu,2) + 
                delta*(300 - 869*Nu + 1085*pow(Nu,2)))*S2z) + 
          Complex(0,1)*pow(PhiDOT,3)*pow(r,3)*rDOT*
           ((675 - 4414*Nu + 6492*pow(Nu,2) + 
                delta*(675 - 2558*Nu + 2780*pow(Nu,2)))*S1z + 
             (-675 + 4414*Nu - 6492*pow(Nu,2) + 
                delta*(675 - 2558*Nu + 2780*pow(Nu,2)))*S2z)) + 
             mass*r*(-2*pow(rDOT,2)*
           ((255 - 1592*Nu + 2226*pow(Nu,2) + 
                delta*(255 - 1144*Nu + 1330*pow(Nu,2)))*S1z + 
             (-255 + 1592*Nu - 2226*pow(Nu,2) + 
                delta*(255 - 1144*Nu + 1330*pow(Nu,2)))*S2z) + 
          Complex(0,2)*PhiDOT*r*rDOT*
           ((870 - 5563*Nu + 7989*pow(Nu,2) + 
                delta*(870 - 3743*Nu + 4349*pow(Nu,2)))*S1z + 
             (-870 + 5563*Nu - 7989*pow(Nu,2) + 
                delta*(870 - 3743*Nu + 4349*pow(Nu,2)))*S2z) + 
          pow(PhiDOT,2)*pow(r,2)*
           ((1329 - 9376*Nu + 14838*pow(Nu,2) + 
                delta*(1329 - 5438*Nu + 6962*pow(Nu,2)))*S1z + 
             (-1329 + 9376*Nu - 14838*pow(Nu,2) + 
                delta*(1329 - 5438*Nu + 6962*pow(Nu,2)))*S2z))))/
             (sqrt(66)*pow(r,4))));
    }
        ...
        + /* Henry et al. ecc+spin terms */ ((Complex(0,24570)*pow(mass,3)*(1 - 6*Nu + 8*pow(Nu,2))*
      (mass*(298*PhiDOT*r + Complex(0,94)*rDOT) + 
        5*r*(95*pow(PhiDOT,3)*pow(r,3) + 
           Complex(0,58)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
           34*PhiDOT*r*pow(rDOT,2) - Complex(0,8)*pow(rDOT,3)))*
      (kappa1*pow(S1z,2) - kappa2*pow(S2z,2)) + 
     delta*(7560*(-135 + 1467*Nu - 5285*pow(Nu,2) + 
           6230*pow(Nu,3))*pow(r,4)*
         pow(Complex(0,1)*PhiDOT*r - rDOT,7)*
         pow(PhiDOT*r - Complex(0,1)*rDOT,2) + 
        6*pow(mass,2)*pow(r,2)*
         (Complex(0,2)*(-2032864 - 4559381*Nu - 3520590*pow(Nu,2) + 
              36950400*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5) - 
           8*(-1581827 + 6211490*Nu + 607860*pow(Nu,2) + 
              6123006*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*rDOT + 
           Complex(0,12)*(738669 - 8183419*Nu + 7682580*pow(Nu,2) + 
              9432160*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
            pow(rDOT,2) - 2*
            (323812 - 40147318*Nu + 43264365*pow(Nu,2) + 
              116543718*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
            pow(rDOT,3) - Complex(0,14)*
            (-19909 - 2880941*Nu + 2929365*pow(Nu,2) + 
              11172930*pow(Nu,3))*PhiDOT*r*pow(rDOT,4) + 
           21*(1285 - 417939*Nu + 376375*pow(Nu,2) + 
              1794742*pow(Nu,3))*pow(rDOT,5)) + 
        45*mass*pow(r,3)*(Complex(0,-4)*
            (-76218 + 328011*Nu - 511853*pow(Nu,2) + 
              804238*pow(Nu,3))*pow(PhiDOT,7)*pow(r,7) - 
           4*(241824 - 1017903*Nu + 1022762*pow(Nu,2) + 
              918896*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6)*rDOT - 
           Complex(0,4)*(450537 - 1503933*Nu - 642815*pow(Nu,2) + 
              6184642*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*
            pow(rDOT,2) + 8*
            (53226 + 197748*Nu - 1673279*pow(Nu,2) + 
              3045358*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
            pow(rDOT,3) - Complex(0,1)*
            (1855503 - 9943746*Nu + 10573448*pow(Nu,2) + 
              6270464*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
            pow(rDOT,4) + 16*
            (147339 - 604776*Nu + 17530*pow(Nu,2) + 
              1666996*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
            pow(rDOT,5) + Complex(0,28)*
            (41703 - 148362*Nu - 104120*pow(Nu,2) + 
              627040*pow(Nu,3))*PhiDOT*r*pow(rDOT,6) - 
           1344*(162 - 516*Nu - 707*pow(Nu,2) + 2870*pow(Nu,3))*
            pow(rDOT,7)) + 
        28*pow(mass,4)*(-3*rDOT*
            (300238 - 535772*pow(Nu,3) + 27495*kappa1*pow(S1z,2) + 
              27495*kappa2*pow(S2z,2) + 
              180*pow(Nu,2)*
               (3335 + 611*kappa1*pow(S1z,2) - 1222*S1z*S2z + 
                 611*kappa2*pow(S2z,2)) - 
              15*Nu*(38797 + 7332*kappa1*pow(S1z,2) - 7332*S1z*S2z + 
           ...
           Complex(0,1)*PhiDOT*r*
            (-5713898 + 2860180*pow(Nu,3) - 
              ...
              30*pow(Nu,2)*
               (278563 + 34866*kappa1*pow(S1z,2) - 69732*S1z*S2z + 
                 34866*kappa2*pow(S2z,2)) + 
              12*Nu*(1137419 + 87165*kappa1*pow(S1z,2) - 
                 87165*S1z*S2z + 87165*kappa2*pow(S2z,2)))) + 
        6*pow(mass,3)*r*(28*pow(rDOT,3)*
            (-175718 - 773906*pow(Nu,3) + 5850*kappa1*pow(S1z,2) + 
              5850*kappa2*pow(S2z,2) + 
              45*pow(Nu,2)*
               (-11217 + 520*kappa1*pow(S1z,2) - 1040*S1z*S2z + 
                 520*kappa2*pow(S2z,2)) - 
              3*Nu*(-243517 + 7800*kappa1*pow(S1z,2) - 
                 7800*S1z*S2z + 7800*kappa2*pow(S2z,2))) + 
           Complex(0,14)*PhiDOT*r*pow(rDOT,2)*
            (1974194 + 5947390*pow(Nu,3) - 
              49725*kappa1*pow(S1z,2) - 49725*kappa2*pow(S2z,2) - 
              1105*pow(Nu,2)*
               (-307 + 180*kappa1*pow(S1z,2) - 360*S1z*S2z + 
                 180*kappa2*pow(S2z,2)) + 
              Nu*(-5423729 + 198900*kappa1*pow(S1z,2) - 
                 198900*S1z*S2z + 198900*kappa2*pow(S2z,2))) + 
           2*pow(PhiDOT,2)*pow(r,2)*rDOT*
            (22105852 + 67721336*pow(Nu,3) - 
              593775*kappa1*pow(S1z,2) - 
              593775*kappa2*pow(S2z,2) - 
              60*pow(Nu,2)*
               (1466303 + 39585*kappa1*pow(S1z,2) - 79170*S1z*S2z + 
                 39585*kappa2*pow(S2z,2)) + 
              4*Nu*(-4950311 + 593775*kappa1*pow(S1z,2) - 
                 593775*S1z*S2z + 593775*kappa2*pow(S2z,2))) - 
            ...
            (82632040*pow(Nu,3) - 
              ...
              10*pow(Nu,2)*
               (24739703 + 778050*kappa1*pow(S1z,2) - 
                 1556100*S1z*S2z + 778050*kappa2*pow(S2z,2)) + 
              9*Nu*(14885821 + 864500*kappa1*pow(S1z,2) - 
                 864500*S1z*S2z + 864500*kappa2*pow(S2z,2))))))/
...
static COMPLEX16 hGO_5_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 4){
        ...
        + /* Henry et al. ecc spin terms */((pow(mass,2)*Nu*(82*mass*PhiDOT*r + 174*pow(PhiDOT,3)*pow(r,4) + 
       ...
       + /* Henry et al. ecc+spin terms */ ((pow(mass,2)*(4*pow(mass,2)*
        (210*pow(Nu,3)*(1950*PhiDOT*r + Complex(0,1373)*rDOT)*
           (S1z + S2z) + 10920*(20*PhiDOT*r + Complex(0,7)*rDOT)*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          21*pow(Nu,2)*(Complex(0,5)*rDOT*
              ((8093 + 1355*delta)*S1z + (8093 - 1355*delta)*S2z) + 
             26*PhiDOT*r*(Complex(0,554) + 25*(-157 + 89*delta)*S1z - 
                25*(157 + 89*delta)*S2z)) - 
          5*Nu*(Complex(0,42)*rDOT*
              ((2479 + 1083*delta)*S1z + (2479 - 1083*delta)*S2z) + 
             13*PhiDOT*r*(Complex(0,1675) + 
                168*(-74 + 295*delta)*S1z - 168*(74 + 295*delta)*S2z)))
         + 3*pow(r,2)*(-840*pow(Nu,3)*
           (13072*pow(PhiDOT,5)*pow(r,5) + 
             ...
             Complex(0,4459)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3) - 1432*PhiDOT*r*pow(rDOT,4) - 
             Complex(0,210)*pow(rDOT,5))*(S1z + S2z) + 
          Complex(0,859950)*pow(PhiDOT,4)*pow(r,4)*rDOT*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          14*pow(Nu,2)*(30*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,-3796) + (77 + 4765*delta)*S1z + 
                (77 - 4765*delta)*S2z) - 
             Complex(0,210)*pow(rDOT,5)*
              ((-23 + 5*delta)*S1z - (23 + 5*delta)*S2z) + 
             Complex(0,13)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,5296) + 105*(-29 + 39*delta)*S1z - 
                105*(29 + 39*delta)*S2z) + 
             Complex(0,2)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,-1058096) + 105*(4821 + 131*delta)*S1z - 
                105*(-4821 + 131*delta)*S2z) - 
             4*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,3796) + 15*(-399 + 193*delta)*S1z - 
                15*(399 + 193*delta)*S2z) + 
             4*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,387296) + 15*(-623 + 4413*delta)*S1z - 
                15*(623 + 4413*delta)*S2z)) - 
          3*Nu*(Complex(0,-140)*pow(rDOT,5)*
              ((-141 + 193*delta)*S1z - (141 + 193*delta)*S2z) + 
             Complex(0,182)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,632) + 5*(-319 + 555*delta)*S1z - 
                5*(319 + 555*delta)*S2z) - 
             8*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,2574) + 35*(-415 + 623*delta)*S1z - 
                35*(415 + 623*delta)*S2z) + 
             2*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,1106001) + 140*(-1069 + 3045*delta)*S1z - 
                140*(1069 + 3045*delta)*S2z) + 
             20*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,-8502) + 7*(-2883 + 6419*delta)*S1z - 
                7*(2883 + 6419*delta)*S2z) + 
             Complex(0,7)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,-431288) + 5*(72097 + 7957*delta)*S1z - 
                5*(-72097 + 7957*delta)*S2z))) - 
       6*mass*r*(420*pow(Nu,3)*
           (2698*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,307)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
             739*PhiDOT*r*pow(rDOT,2) + Complex(0,183)*pow(rDOT,3))
            *(S1z + S2z) - 5460*
           (86*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,137)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
             30*PhiDOT*r*pow(rDOT,2) - Complex(0,3)*pow(rDOT,3))*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          Nu*(Complex(0,700)*pow(rDOT,3)*
              ((-651 + 482*delta)*S1z - (651 + 482*delta)*S2z) + 
             28*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (34294 - Complex(0,5)*(-56523 + 1013*delta)*S1z + 
                Complex(0,5)*(56523 + 1013*delta)*S2z) + 
             pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,1423669) + 280*(2589 + 18458*delta)*S1z - 
                280*(-2589 + 18458*delta)*S2z) + 
             2*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,34203) + 35*(-40527 + 19571*delta)*S1z - 
                35*(40527 + 19571*delta)*S2z)) - 
          14*pow(Nu,2)*(Complex(0,50)*pow(rDOT,3)*
              ((-1330 + 223*delta)*S1z - (1330 + 223*delta)*S2z) + 
             2*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,7956) + 5*(-39389 + 2528*delta)*S1z - 
                5*(39389 + 2528*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,-213408) + 5*(202025 + 36547*delta)*S1z - 
                5*(-202025 + 36547*delta)*S2z) + 
             2*pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,160212) + 5*(-2831 + 38849*delta)*S1z - 
    ...
    if(vpnorder == 3){
     ...
     (pow(mass,2)*((90 - 622*Nu + 966*pow(Nu,2) + 
       ...
       3*pow(r,2)*(Complex(0,4)*PhiDOT*r*pow(rDOT,3)*
          ...
          4*pow(rDOT,4)*((15 - 92*Nu + 126*pow(Nu,2) + 
                delta*(15 - 64*Nu + 70*pow(Nu,2)))*S1z + 
             (-15 + 92*Nu - 126*pow(Nu,2) + 
                delta*(15 - 64*Nu + 70*pow(Nu,2)))*S2z) + 
          pow(PhiDOT,4)*pow(r,4)*
           ((20 - 317*Nu + 751*pow(Nu,2) + 
                delta*(20 + 13*Nu + 91*pow(Nu,2)))*S1z + 
             (-20 + 317*Nu - 751*pow(Nu,2) + 
                delta*(20 + 13*Nu + 91*pow(Nu,2)))*S2z) - 
          3*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
           ((-45 + 298*Nu - 444*pow(Nu,2) + 
                delta*(-45 + 2*Nu + 148*pow(Nu,2)))*S1z + 
             (45 - 298*Nu + 444*pow(Nu,2) + 
                delta*(-45 + 2*Nu + 148*pow(Nu,2)))*S2z)) + 
       mass*r*(Complex(0,6)*PhiDOT*r*rDOT*
          ...
          pow(PhiDOT,2)*pow(r,2)*
           ((849 - 5360*Nu + 7590*pow(Nu,2) + 
                delta*(849 - 1774*Nu + 418*pow(Nu,2)))*S1z + 
             (-849 + 5360*Nu - 7590*pow(Nu,2) + 
                delta*(849 - 1774*Nu + 418*pow(Nu,2)))*S2z) - 
          2*pow(rDOT,2)*((255 - 1592*Nu + 2226*pow(Nu,2) + 
                delta*(255 - 1144*Nu + 1330*pow(Nu,2)))*S1z + 
             (-255 + 1592*Nu - 2226*pow(Nu,2) + 
                delta*(255 - 1144*Nu + 1330*pow(Nu,2)))*S2z))))/
   (sqrt(330)*pow(r,4))));
        ...
        + /* Henry et al. ecc+spin terms */ ((8190*pow(mass,3)*(Complex(0,-2)*mass*
         (447 - 2682*Nu + 3224*pow(Nu,2))*PhiDOT*r + 
        2*mass*(235 + 2*Nu*(-705 + 1004*Nu))*rDOT + 
        r*(Complex(0,1)*(15 - 90*Nu + 2008*pow(Nu,2))*
            pow(PhiDOT,3)*pow(r,3) + 
           66*(5 + 6*Nu*(-5 + 12*Nu))*pow(PhiDOT,2)*pow(r,2)*
            rDOT + Complex(0,6)*(85 - 510*Nu + 808*pow(Nu,2))*PhiDOT*
            r*pow(rDOT,2) - 8*(-5 + 12*Nu)*(-5 + 18*Nu)*pow(rDOT,3)
           ))*(kappa1*pow(S1z,2) - kappa2*pow(S2z,2)) + 
     delta*(Complex(0,-12600)*
         (-135 + Nu*(1467 + 35*Nu*(-151 + 178*Nu)))*pow(r,4)*
         pow(PhiDOT*r - Complex(0,1)*rDOT,3)*
         pow(PhiDOT*r + Complex(0,1)*rDOT,6) + 
        6*pow(mass,2)*pow(r,2)*
         (Complex(0,-10)*(129184 + 
              Nu*(917839 + 2*Nu*(-1601563 + 652752*Nu)))*
            pow(PhiDOT,5)*pow(r,5) + 
           8*(3087667 + 2*Nu*(-3131631 + 5*Nu*(-385362 + 1212143*Nu)))*
            pow(PhiDOT,4)*pow(r,4)*rDOT + 
           Complex(0,4)*(1877161 + 
              Nu*(-1391951 + 20*Nu*(-594787 + 1654110*Nu)))*
            pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) + 
           2*(-919652 + Nu*(-16365978 + 5*Nu*(5343599 + 5349122*Nu)))*
            pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) + 
           Complex(0,14)*(-19909 + 
              Nu*(-2880941 + 15*Nu*(195291 + 744862*Nu)))*PhiDOT*r*
            pow(rDOT,4) - 35*
            (1285 + Nu*(-417939 + Nu*(376375 + 1794742*Nu)))*
            pow(rDOT,5)) + 
        45*mass*pow(r,3)*(Complex(0,4)*
            (54310 + Nu*(-20821 + Nu*(-636477 + 820286*Nu)))*
            pow(PhiDOT,7)*pow(r,7) + 
           4*(-119296 + Nu*(251655 + 893222*Nu - 3122048*pow(Nu,2)))*
            pow(PhiDOT,6)*pow(r,6)*rDOT - 
           Complex(0,4)*(42783 + 
              Nu*(123661 + 3*Nu*(-447987 + 841994*Nu)))*
            pow(PhiDOT,5)*pow(r,5)*pow(rDOT,2) - 
           8*(237862 + Nu*(-912196 + 3*Nu*(-46779 + 933382*Nu)))*
            pow(PhiDOT,4)*pow(r,4)*pow(rDOT,3) - 
           Complex(0,1)*(1550225 + 
              6*Nu*(-680405 + 4*Nu*(-402523 + 1277568*Nu)))*
            pow(PhiDOT,3)*pow(r,3)*pow(rDOT,4) - 
           16*(39855 + 2*Nu*(-106258 + Nu*(113231 + 75438*Nu)))*
            pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) - 
           Complex(0,28)*(41703 + 
              2*Nu*(-74181 + 20*Nu*(-2603 + 15676*Nu)))*PhiDOT*r*
            pow(rDOT,6) + 2240*
            (162 + Nu*(-516 + 7*Nu*(-101 + 410*Nu)))*pow(rDOT,7)) + 
        28*pow(mass,4)*(Complex(0,1)*PhiDOT*r*
            (-5713898 - 261495*kappa1*pow(S1z,2) + 
              2*Nu*(6824514 - 4178445*Nu + 1430090*pow(Nu,2) - 
                 522990*kappa1*(-1 + Nu)*pow(S1z,2)) + 
              1045980*Nu*(-1 + 2*Nu)*S1z*S2z - 
              261495*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)) + 
           5*rDOT*(300238 + 27495*kappa1*pow(S1z,2) + 
              Nu*(-581955 + 600300*Nu - 535772*pow(Nu,2) + 
                 109980*kappa1*(-1 + Nu)*pow(S1z,2)) - 
              109980*Nu*(-1 + 2*Nu)*S1z*S2z + 
              27495*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2))) + 
        2*pow(mass,3)*r*(Complex(0,-1)*pow(PhiDOT,3)*pow(r,3)*
            (-13*(371212 + 4725*kappa1*pow(S1z,2)) + 
              Nu*(-7716399 - 11038350*Nu + 21939560*pow(Nu,2) - 
                 245700*kappa1*(-1 + Nu)*pow(S1z,2)) + 
              245700*Nu*(-1 + 2*Nu)*S1z*S2z - 
              61425*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)) - 
           Complex(0,126)*PhiDOT*r*pow(rDOT,2)*
            ((1974194 - 5423729*Nu + 339235*pow(Nu,2) + 
                 5947390*pow(Nu,3) - 
                 49725*kappa1*pow(1 - 2*Nu,2)*pow(S1z,2))/3. + 
              66300*Nu*(-1 + 2*Nu)*S1z*S2z - 
              16575*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)) + 
           140*pow(rDOT,3)*
           ...
           6*pow(PhiDOT,2)*pow(r,2)*rDOT*
            (-8099876 + 225225*kappa1*pow(S1z,2) + 
              4*Nu*(1323649 + 9536535*Nu - 6899570*pow(Nu,2) + 
                 225225*kappa1*(-1 + Nu)*pow(S1z,2)) - 
              900900*Nu*(-1 + 2*Nu)*S1z*S2z + 
              225225*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)))))/
...
static COMPLEX16 hGO_5_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 4){
        ...
        + /* Henry et al. ecc spin terms */ (-0.027777777777777776*(pow(mass,2)*Nu*
      (mass*(41*PhiDOT*r + Complex(0,22)*rDOT) - 
        3*r*(11*pow(PhiDOT,3)*pow(r,3) - 
           Complex(0,3)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
           6*PhiDOT*r*pow(rDOT,2) + Complex(0,2)*pow(rDOT,3)))*
      ((-1 + delta + 2*Nu)*S1z - (1 + delta - 2*Nu)*S2z))/
        (sqrt(55)*pow(r,3))));
    }
        ...
        + /* Henry et al. ecc+spin terms */ (-1.6958350291683625e-6*(pow(mass,2)*
      (4*pow(mass,2)*(210*pow(Nu,3)*
            (975*PhiDOT*r + Complex(0,1373)*rDOT)*(S1z + S2z) + 
           10920*(10*PhiDOT*r + Complex(0,7)*rDOT)*
            (S1z + delta*S1z + S2z - delta*S2z) + 
           21*pow(Nu,2)*(Complex(0,5)*rDOT*
               ((8093 + 1355*delta)*S1z + (8093 - 1355*delta)*S2z) + 
              13*PhiDOT*r*(Complex(0,1108) + 
                 25*(-157 + 89*delta)*S1z - 25*(157 + 89*delta)*S2z))\
            - 5*Nu*(Complex(0,42)*rDOT*
               ((2479 + 1083*delta)*S1z + (2479 - 1083*delta)*S2z) + 
              13*PhiDOT*r*(Complex(0,1675) + 
                 84*(-74 + 295*delta)*S1z - 84*(74 + 295*delta)*S2z)))\
         + 3*pow(r,2)*(840*pow(Nu,3)*
            (896*pow(PhiDOT,5)*pow(r,5) + 
              ...
              Complex(0,235)*pow(PhiDOT,2)*pow(r,2)*
               pow(rDOT,3) + 716*PhiDOT*r*pow(rDOT,4) + 
              Complex(0,210)*pow(rDOT,5))*(S1z + S2z) - 
           Complex(0,286650)*pow(PhiDOT,4)*pow(r,4)*rDOT*
            (S1z + delta*S1z + S2z - delta*S2z) - 
           14*pow(Nu,2)*(Complex(0,2)*pow(PhiDOT,4)*pow(r,4)*
               rDOT*(Complex(0,-41392) + 15*(15219 + 1835*delta)*S1z + 
           ...
           3*Nu*(Complex(0,140)*pow(rDOT,5)*
              ...
              7*pow(PhiDOT,4)*pow(r,4)*rDOT*
               (16276 - Complex(0,5)*(-31495 + 2453*delta)*S1z + 
                 Complex(0,5)*(31495 + 2453*delta)*S2z) + 
              2*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
               (Complex(0,39156) + 35*(-1773 + 3437*delta)*S1z - 
                 35*(1773 + 3437*delta)*S2z))) - 
        6*mass*r*(210*pow(Nu,3)*
            (946*pow(PhiDOT,3)*pow(r,3) - 
              Complex(0,1150)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
              739*PhiDOT*r*pow(rDOT,2) + Complex(0,366)*pow(rDOT,3)
              )*(S1z + S2z) - 
           5460*(3*pow(PhiDOT,3)*pow(r,3) + 
              Complex(0,17)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
              15*PhiDOT*r*pow(rDOT,2) - Complex(0,3)*pow(rDOT,3))*
            (S1z + delta*S1z + S2z - delta*S2z) - 
           14*pow(Nu,2)*(Complex(0,1)*pow(PhiDOT,2)*pow(r,2)*
               rDOT*(Complex(0,-106704) + 5*(13991 + 6349*delta)*S1z + 
                 (69955 - 31745*delta)*S2z) + 
              Complex(0,50)*pow(rDOT,3)*
               ((-1330 + 223*delta)*S1z - (1330 + 223*delta)*S2z) + 
              PhiDOT*r*pow(rDOT,2)*
               (Complex(0,15912) + 5*(-39389 + 2528*delta)*S1z - 
                 5*(39389 + 2528*delta)*S2z) + 
              pow(PhiDOT,3)*pow(r,3)*
               (Complex(0,62868) + 5*(-5543 + 5105*delta)*S1z - 
                 5*(5543 + 5105*delta)*S2z)) + 
           Nu*(Complex(0,28)*pow(PhiDOT,2)*pow(r,2)*rDOT*
               (Complex(0,-17147) + 5*(5007 + 1675*delta)*S1z + 
              ...
              Complex(0,700)*pow(rDOT,3)*
               ((-651 + 482*delta)*S1z - (651 + 482*delta)*S2z) + 
              PhiDOT*r*pow(rDOT,2)*
               (Complex(0,68406) + 35*(-40527 + 19571*delta)*S1z - 
                 35*(40527 + 19571*delta)*S2z)))))/
    (sqrt(55)*pow(r,4))));
    }
    else{
...
static COMPLEX16 hGO_5_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
       ...
       3*pow(r,2)*(Complex(0,4)*PhiDOT*r*pow(rDOT,3)*
          ...
          pow(PhiDOT,4)*pow(r,4)*
           ((-180 + 1009*Nu - 1227*pow(Nu,2) + 
                delta*(-180 + 95*Nu + 601*pow(Nu,2)))*S1z + 
             (180 - 1009*Nu + 1227*pow(Nu,2) + 
                delta*(-180 + 95*Nu + 601*pow(Nu,2)))*S2z) + 
          3*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2)*
           ((35 - 198*Nu + 244*pow(Nu,2) + 
                delta*(35 - 382*Nu + 612*pow(Nu,2)))*S1z + 
             (-35 + 198*Nu - 244*pow(Nu,2) + 
                delta*(35 - 382*Nu + 612*pow(Nu,2)))*S2z)) + 
       mass*r*(Complex(0,-2)*PhiDOT*r*rDOT*
          ...
          pow(PhiDOT,2)*pow(r,2)*
           ((609 - 3352*Nu + 3966*pow(Nu,2) + 
                delta*(609 + 58*Nu - 2854*pow(Nu,2)))*S1z + 
             (-609 + 3352*Nu - 3966*pow(Nu,2) + 
                delta*(609 + 58*Nu - 2854*pow(Nu,2)))*S2z) - 
          2*pow(rDOT,2)*((255 - 1592*Nu + 2226*pow(Nu,2) + 
                delta*(255 - 1144*Nu + 1330*pow(Nu,2)))*S1z + 
             (-255 + 1592*Nu - 2226*pow(Nu,2) + 
                delta*(255 - 1144*Nu + 1330*pow(Nu,2)))*S2z))))/
   (sqrt(385)*pow(r,4))));
        ...
        + /* Henry et al. ecc+spin terms */ ((3510*pow(mass,3)*(Complex(0,2)*mass*(149 + 2*Nu*(-447 + 508*Nu))*
         PhiDOT*r - 2*mass*(235 + 2*Nu*(-705 + 1036*Nu))*rDOT + 
        r*(Complex(0,-7)*(35 - 210*Nu + 232*pow(Nu,2))*
            pow(PhiDOT,3)*pow(r,3) + 
           2*(115 + 2*Nu*(-345 + 628*Nu))*pow(PhiDOT,2)*pow(r,2)*
            rDOT - Complex(0,2)*(85 - 510*Nu + 872*pow(Nu,2))*PhiDOT*
            r*pow(rDOT,2) + 8*(-5 + 14*Nu)*(-5 + 16*Nu)*pow(rDOT,3)
           ))*(kappa1*pow(S1z,2) - kappa2*pow(S2z,2)) + 
     delta*(5400*(-135 + Nu*(1467 + 35*Nu*(-151 + 178*Nu)))*pow(r,4)*
         pow(PhiDOT*r - Complex(0,1)*rDOT,4)*
         pow(Complex(0,-1)*PhiDOT*r + rDOT,5) + 
        6*pow(mass,2)*pow(r,2)*
         (Complex(0,-2)*(556064 + 
              7*Nu*(259253 + 130*Nu*(-10297 + 8136*Nu)))*
            pow(PhiDOT,5)*pow(r,5) + 
           8*(349973 + 4*Nu*(-94417 + 5*Nu*(-65429 + 126618*Nu)))*
            pow(PhiDOT,4)*pow(r,4)*rDOT - 
           Complex(0,60)*(37369 + 
              Nu*(-136791 - 60188*Nu + 607348*pow(Nu,2)))*
            pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) + 
           2*(706852 + Nu*(-3817342 + 15*Nu*(-114953 + 1628610*Nu)))*
            pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
           Complex(0,2)*(-19909 + 
              Nu*(-2880941 + 15*Nu*(195291 + 744862*Nu)))*PhiDOT*r*
            pow(rDOT,4) + 15*
            ...
            pow(rDOT,5)) + 
        45*mass*pow(r,3)*(Complex(0,4)*
            (11270 + Nu*(40035 + Nu*(-338333 + 490662*Nu)))*
            pow(PhiDOT,7)*pow(r,7) - 
           4*(12816 + Nu*(1923 - 262738*Nu + 582488*pow(Nu,2)))*
            pow(PhiDOT,6)*pow(r,6)*rDOT + 
           Complex(0,4)*(76389 + 
              Nu*(-196893 + Nu*(-529811 + 1606402*Nu)))*
            pow(PhiDOT,5)*pow(r,5)*pow(rDOT,2) + 
           8*(-45746 + Nu*(115572 + (313303 - 946222*Nu)*Nu))*
            pow(PhiDOT,4)*pow(r,4)*pow(rDOT,3) + 
           Complex(0,1)*(464727 + 
              2*Nu*(-792537 + 4*Nu*(-164359 + 877280*Nu)))*
            pow(PhiDOT,3)*pow(r,3)*pow(rDOT,4) - 
           32*(13500 + Nu*(-39687 + Nu*(-69661 + 249182*Nu)))*
            pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) + 
           Complex(0,4)*(41703 + 
              2*Nu*(-74181 + 20*Nu*(-2603 + 15676*Nu)))*PhiDOT*r*
            pow(rDOT,6) - 960*
            (162 + Nu*(-516 + 7*Nu*(-101 + 410*Nu)))*pow(rDOT,7)) + 
        4*pow(mass,4)*(Complex(0,-1)*PhiDOT*r*
            (-5713898 - 261495*kappa1*pow(S1z,2) + 
              2*Nu*(6824514 - 4178445*Nu + 1430090*pow(Nu,2) - 
                 522990*kappa1*(-1 + Nu)*pow(S1z,2)) + 
              1045980*Nu*(-1 + 2*Nu)*S1z*S2z - 
              261495*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)) + 
           15*rDOT*(-300238 - 27495*kappa1*pow(S1z,2) + 
              Nu*(581955 - 600300*Nu + 535772*pow(Nu,2) - 
                 109980*kappa1*(-1 + Nu)*pow(S1z,2)) + 
              109980*Nu*(-1 + 2*Nu)*S1z*S2z - 
              27495*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2))) + 
        6*pow(mass,3)*r*(Complex(0,2)*PhiDOT*r*pow(rDOT,2)*
            (1974194 - 49725*kappa1*pow(S1z,2) + 
              Nu*(-5423729 + 339235*Nu + 5947390*pow(Nu,2) - 
                 198900*kappa1*(-1 + Nu)*pow(S1z,2)) + 
              198900*Nu*(-1 + 2*Nu)*S1z*S2z - 
              49725*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)) + 
           Complex(0,25)*pow(PhiDOT,3)*pow(r,3)*
            ((-265372 + Nu*(1803657 + 2*Nu*(-1845967 + 746940*Nu)))/
               5. - 5733*kappa1*pow(1 - 2*Nu,2)*pow(S1z,2) + 
              22932*Nu*(-1 + 2*Nu)*S1z*S2z - 
              5733*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)) + 
           20*pow(rDOT,3)*(-175718 + 5850*kappa1*pow(S1z,2) + 
              Nu*(730551 - 504765*Nu - 773906*pow(Nu,2) + 
                 23400*kappa1*(-1 + Nu)*pow(S1z,2)) - 
              23400*Nu*(-1 + 2*Nu)*S1z*S2z + 
              5850*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)) + 
           2*pow(PhiDOT,2)*pow(r,2)*rDOT*
            (-2687884 + 67275*kappa1*pow(S1z,2) + 
              4*Nu*(917051 + 1724565*Nu - 1611110*pow(Nu,2) + 
                 67275*kappa1*(-1 + Nu)*pow(S1z,2)) - 
              269100*Nu*(-1 + 2*Nu)*S1z*S2z + 
              67275*kappa2*pow(1 - 2*Nu,2)*pow(S2z,2)))))/
...
static COMPLEX16 hGO_6_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 4){
        ...
        + /* Henry et al. ecc+spin terms */ ((pow(mass,2)*(8*pow(mass,2)*
        (30*pow(Nu,3)*(9071*PhiDOT*r + Complex(0,4976)*rDOT)*
           (S1z + S2z) - 21*(761*PhiDOT*r + Complex(0,476)*rDOT)*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          Nu*(PhiDOT*r*(Complex(0,61450) + 125439*S1z + 
                94725*delta*S1z + 125439*S2z - 94725*delta*S2z) + 
             Complex(0,1)*rDOT*
              (Complex(0,14017) + 77370*S1z + 54090*delta*S1z + 
                77370*S2z - 54090*delta*S2z)) - 
          3*pow(Nu,2)*(Complex(0,1)*rDOT*
              (Complex(0,15107) + 40*(1592 + 485*delta)*S1z + 
                63680*S2z - 19400*delta*S2z) + 
             5*PhiDOT*r*(Complex(0,13198) + (21493 + 7303*delta)*S1z + 
                21493*S2z - 7303*delta*S2z))) - 
       3*pow(r,2)*(-900*pow(Nu,3)*
           (975*pow(PhiDOT,5)*pow(r,5) + 
             ...
             Complex(0,1592)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3) + 688*PhiDOT*r*pow(rDOT,4) + 
             Complex(0,128)*pow(rDOT,5))*(S1z + S2z) + 
          1260*(61*pow(PhiDOT,5)*pow(r,5) + 
             Complex(0,151)*pow(PhiDOT,4)*pow(r,4)*rDOT - 
             172*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) - 
             Complex(0,122)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) + 
             48*PhiDOT*r*pow(rDOT,4) + Complex(0,8)*pow(rDOT,5))*
           (S1z + delta*S1z + S2z - delta*S2z) - 
          3*Nu*(Complex(0,1)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,56511) + 10*(43269 + 36265*delta)*S1z + 
                432690*S2z - 362650*delta*S2z) - 
             Complex(0,4)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,14259) + 40*(2154 + 1675*delta)*S1z + 
                86160*S2z - 67000*delta*S2z) + 
             4*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,94823) + 25*(1494 + 1901*delta)*S1z + 
                37350*S2z - 47525*delta*S2z) - 
             16*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,6984) + 5*(5967 + 4855*delta)*S1z + 
                29835*S2z - 24275*delta*S2z) + 
             Complex(0,8)*pow(rDOT,5)*
              (Complex(0,251) + 10*(303 + 215*delta)*S1z + 3030*S2z - 
                2150*delta*S2z) + 
             64*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,251) + 5*(438 + 325*delta)*S1z + 2190*S2z - 
                1625*delta*S2z)) + 
          pow(Nu,2)*(Complex(0,8)*pow(rDOT,5)*
             ...
             64*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,2449) + 75*(188 + 67*delta)*S1z - 
                75*(-188 + 67*delta)*S2z) - 
             16*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,66866) + 75*(2423 + 1039*delta)*S1z - 
                75*(-2423 + 1039*delta)*S2z) - 
             Complex(0,4)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,139541) + 150*(3551 + 1399*delta)*S1z - 
                150*(-3551 + 1399*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,515089) + 600*(4703 + 2041*delta)*S1z - 
                600*(-4703 + 2041*delta)*S2z) + 
             4*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,925502) + 75*(2966 + 2521*delta)*S1z - 
                75*(-2966 + 2521*delta)*S2z))) + 
       12*mass*r*(30*pow(Nu,3)*
           (20149*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,33176)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
             18519*PhiDOT*r*pow(rDOT,2) - 
             Complex(0,4092)*pow(rDOT,3))*(S1z + S2z) - 
          42*(1167*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,2042)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
             1131*PhiDOT*r*pow(rDOT,2) - Complex(0,236)*pow(rDOT,3)
             )*(S1z + delta*S1z + S2z - delta*S2z) + 
          pow(Nu,2)*(-2*pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,452503) + 5*(72902 + 36559*delta)*S1z + 
                364510*S2z - 182795*delta*S2z) + 
             3*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,53821) + 30*(8510 + 2941*delta)*S1z + 
                255300*S2z - 88230*delta*S2z) - 
             Complex(0,6)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,65461) + 30*(7463 + 2831*delta)*S1z + 
                223890*S2z - 84930*delta*S2z) + 
             Complex(0,1)*pow(rDOT,3)*
              (Complex(0,26693) + 20*(8419 + 2675*delta)*S1z + 
                168380*S2z - 53500*delta*S2z)) + 
          Nu*(pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,280937) + (329808 + 305330*delta)*S1z + 
                (329808 - 305330*delta)*S2z) - 
             Complex(0,1)*pow(rDOT,3)*
              (Complex(0,8281) + 10*(7293 + 5153*delta)*S1z + 
                (72930 - 51530*delta)*S2z) - 
             3*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,16877) + 90*(1261 + 930*delta)*S1z - 
                90*(-1261 + 930*delta)*S2z) + 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,60821) + 24*(12576 + 9775*delta)*S1z - 
...
static COMPLEX16 hGO_6_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 5){
        ...
        + /* Henry et al. ecc spin terms */ ((Complex(0,-0.006944444444444444)*pow(mass,2)*Nu*
     (82*pow(mass,2) + 2*mass*r*
        (701*pow(PhiDOT,2)*pow(r,2) + 
          Complex(0,343)*PhiDOT*r*rDOT - 62*pow(rDOT,2)) + 
       3*pow(r,2)*(547*pow(PhiDOT,4)*pow(r,4) + 
          Complex(0,364)*pow(PhiDOT,3)*pow(r,3)*rDOT - 
          180*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2) - 
          Complex(0,56)*PhiDOT*r*pow(rDOT,3) + 8*pow(rDOT,4)))*
     ((1 + delta*(-1 + Nu) - 3*Nu)*S1z + 
       (-1 + delta*(-1 + Nu) + 3*Nu)*S2z))/(sqrt(429)*pow(r,4))));
    }

    else if(vpnorder == 7){

        return((Complex(0,0.00003306878306878307)*delta*mass*PhiDOT*
     (16*pow(mass,3)*(-3893 + 16386*Nu - 17175*pow(Nu,2) + 
          6922*pow(Nu,3)) + 
       24*pow(mass,2)*r*((-25472 + 127239*Nu - 198605*pow(Nu,2) + 
             117623*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2) + 
          Complex(0,10)*(1954 - 7090*Nu + 1431*pow(Nu,2) + 
             5232*pow(Nu,3))*PhiDOT*r*rDOT - 
          (6603 - 26446*Nu + 16325*pow(Nu,2) + 7138*pow(Nu,3))*
           pow(rDOT,2)) + 12*mass*pow(r,2)*
        (2*(-23971 + 144172*Nu - 256320*pow(Nu,2) + 
             127374*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4) + 
          Complex(0,5)*(40015 - 154144*Nu + 84408*pow(Nu,2) + 
             41694*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*rDOT - 
          3*(46471 - 183392*Nu + 109660*pow(Nu,2) + 
             47046*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*
           pow(rDOT,2) - Complex(0,5)*
           (9713 - 38048*Nu + 21348*pow(Nu,2) + 11562*pow(Nu,3))*
           PhiDOT*r*pow(rDOT,3) + 
          4*(1811 - 7007*Nu + 3585*pow(Nu,2) + 2511*pow(Nu,3))*
           pow(rDOT,4)) - 45*pow(r,3)*
        ((3177 - 1626*Nu - 54862*pow(Nu,2) + 73376*pow(Nu,3))*
           pow(PhiDOT,6)*pow(r,6) + 
          Complex(0,2)*(-5337 + 26646*Nu - 34862*pow(Nu,2) + 
             11212*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*rDOT + 
          4*(1917 - 7098*Nu + 1187*pow(Nu,2) + 6278*pow(Nu,3))*
           pow(PhiDOT,4)*pow(r,4)*pow(rDOT,2) + 
          Complex(0,8)*(639 - 1986*Nu - 1156*pow(Nu,2) + 
             3296*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,3)
            - 16*(153 - 402*Nu - 577*pow(Nu,2) + 1022*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,4) - 
          Complex(0,16)*(45 - 102*Nu - 236*pow(Nu,2) + 
             352*pow(Nu,3))*PhiDOT*r*pow(rDOT,5) + 
          32*(3 - 6*Nu - 19*pow(Nu,2) + 26*pow(Nu,3))*pow(rDOT,6)
          )))/(sqrt(429)*pow(r,4)));
    }
...
static COMPLEX16 hGO_6_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 4){
        ...
        + /* Henry et al. ecc+spin terms */ ((pow(mass,2)*(-8*pow(mass,2)*
        (30*pow(Nu,3)*(10641*PhiDOT*r + Complex(0,9952)*rDOT)*
           (S1z + S2z) - 21*(1283*PhiDOT*r + Complex(0,952)*rDOT)*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          Nu*(PhiDOT*r*(Complex(0,122900) + 
                3*(62389 + 51235*delta)*S1z + 187167*S2z - 
                153705*delta*S2z) + 
             Complex(0,3)*rDOT*
              (Complex(0,14017) + 20*(2579 + 1803*delta)*S1z + 
                51580*S2z - 36060*delta*S2z)) - 
          3*pow(Nu,2)*(5*PhiDOT*r*
              (Complex(0,26396) + (27731 + 11513*delta)*S1z + 
                (27731 - 11513*delta)*S2z) + 
             Complex(0,1)*rDOT*
              (Complex(0,45321) + 80*(1592 + 485*delta)*S1z - 
                80*(-1592 + 485*delta)*S2z))) - 
       3*pow(r,2)*(-60*pow(Nu,3)*
           (401*pow(PhiDOT,5)*pow(r,5) + 
             ...
             Complex(0,3632)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3) - 10736*PhiDOT*r*pow(rDOT,4) - 
             Complex(0,3840)*pow(rDOT,5))*(S1z + S2z) + 
          1260*(17*pow(PhiDOT,5)*pow(r,5) + 
             Complex(0,58)*pow(PhiDOT,4)*pow(r,4)*rDOT + 
             16*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) + 
             Complex(0,84)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
             64*PhiDOT*r*pow(rDOT,4) - Complex(0,16)*pow(rDOT,5))*
           (S1z + delta*S1z + S2z - delta*S2z) - 
             3*Nu*(Complex(0,20)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,3109) + (9208 + 9384*delta)*S1z + 
                (9208 - 9384*delta)*S2z) - 
             32*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,1004) + 5*(1091 + 869*delta)*S1z + 
                (5455 - 4345*delta)*S2z) - 
             Complex(0,8)*pow(rDOT,5)*
             ...
             20*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,4690) + (652 + 3807*delta)*S1z + 
                (652 - 3807*delta)*S2z) + 
             16*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,1872) + 5*(-591 + 605*delta)*S1z - 
                5*(591 + 605*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,78819) + 20*(12535 + 5539*delta)*S1z - 
                20*(-12535 + 5539*delta)*S2z)) + 
            pow(Nu,2)*(Complex(0,20)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3)*(Complex(0,30451) + 
                12*(2831 + 2487*delta)*S1z + (33972 - 29844*delta)*S2z)
               - 64*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,4898) + 15*(1062 + 449*delta)*S1z + 
                (15930 - 6735*delta)*S2z) - 
             Complex(0,24)*pow(rDOT,5)*
              (Complex(0,2449) + 400*(34 + 11*delta)*S1z - 
                400*(-34 + 11*delta)*S2z) + 
             96*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,2838) + 25*(-445 + 79*delta)*S1z - 
                25*(445 + 79*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,761581) + 240*(9441 + 1247*delta)*S1z - 
                240*(-9441 + 1247*delta)*S2z) + 
             20*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,44900) + 3*(-1858 + 5829*delta)*S1z - 
                3*(1858 + 5829*delta)*S2z))) + 
             12*mass*r*(30*pow(Nu,3)*
             (73*pow(PhiDOT,3)*pow(r,3) - 
             Complex(0,11024)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
             20149*PhiDOT*r*pow(rDOT,2) + 
             Complex(0,8184)*pow(rDOT,3))*(S1z + S2z) + 
             42*(871*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,1684)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
             1543*PhiDOT*r*pow(rDOT,2) - Complex(0,472)*pow(rDOT,3)
             )*(S1z + delta*S1z + S2z - delta*S2z) + 
             Nu*(-2*pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,69725) + (89007 + 95170*delta)*S1z + 
                (89007 - 95170*delta)*S2z) + 
             Complex(0,1)*pow(rDOT,3)*
              (Complex(0,24843) + 20*(7293 + 5153*delta)*S1z - 
                20*(-7293 + 5153*delta)*S2z) - 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,66847) + 8*(24951 + 24245*delta)*S1z - 
                8*(-24951 + 24245*delta)*S2z) + 
             2*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,50631) + 5*(43338 + 34327*delta)*S1z - 
                5*(-43338 + 34327*delta)*S2z)) + 
             pow(Nu,2)*(10*pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,44862) + (16586 + 19777*delta)*S1z + 
                (16586 - 19777*delta)*S2z) + 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,216321) + 100*(3079 + 2111*delta)*S1z - 
                100*(-3079 + 2111*delta)*S2z) - 
             Complex(0,1)*pow(rDOT,3)*
              (Complex(0,80079) + 40*(8419 + 2675*delta)*S1z - 
                40*(-8419 + 2675*delta)*S2z) - 
             2*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,161463) + 5*(89002 + 36251*delta)*S1z - 
...
static COMPLEX16 hGO_6_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 5){
        ...
        + /* Henry et al. ecc spin terms */ ((Complex(0,0.0006313131313131314)*pow(mass,2)*Nu*
     (410*pow(mass,2) + 2*mass*r*
        (929*pow(PhiDOT,2)*pow(r,2) + 
          Complex(0,1029)*PhiDOT*r*rDOT - 310*pow(rDOT,2)) - 
       3*pow(r,2)*(513*pow(PhiDOT,4)*pow(r,4) + 
          Complex(0,28)*pow(PhiDOT,3)*pow(r,3)*rDOT + 
          228*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2) + 
          Complex(0,168)*PhiDOT*r*pow(rDOT,3) - 40*pow(rDOT,4)))*
     ((1 + delta*(-1 + Nu) - 3*Nu)*S1z + 
       (-1 + delta*(-1 + Nu) + 3*Nu)*S2z))/(sqrt(65)*pow(r,4))));
    }

    else if(vpnorder == 7){

        return((Complex(0,-0.000015031265031265032)*delta*mass*PhiDOT*
     (16*pow(mass,3)*(-3893 + 16386*Nu - 17175*pow(Nu,2) + 
          6922*pow(Nu,3)) + 
       8*pow(mass,2)*r*((-22256 + 111525*Nu - 170247*pow(Nu,2) + 
             94453*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2) + 
          Complex(0,18)*(1954 - 7090*Nu + 1431*pow(Nu,2) + 
             5232*pow(Nu,3))*PhiDOT*r*rDOT - 
          3*(6603 - 26446*Nu + 16325*pow(Nu,2) + 7138*pow(Nu,3))*
           pow(rDOT,2)) - 12*mass*pow(r,2)*
        (2*(771 + 6004*Nu - 44896*pow(Nu,2) + 48978*pow(Nu,3))*
           pow(PhiDOT,4)*pow(r,4) + 
          Complex(0,1)*(10771 - 40224*Nu + 14456*pow(Nu,2) + 
             21414*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*rDOT + 
          (34437 - 136928*Nu + 85844*pow(Nu,2) + 30834*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2) + 
          Complex(0,3)*(9713 - 38048*Nu + 21348*pow(Nu,2) + 
             11562*pow(Nu,3))*PhiDOT*r*pow(rDOT,3) - 
          4*(1811 - 7007*Nu + 3585*pow(Nu,2) + 2511*pow(Nu,3))*
           pow(rDOT,4)) + 9*pow(r,3)*
        ((4339 - 4350*Nu - 50298*pow(Nu,2) + 61600*pow(Nu,3))*
           pow(PhiDOT,6)*pow(r,6) + 
          Complex(0,2)*(-12661 + 53118*Nu - 45494*pow(Nu,2) + 
             2652*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*rDOT + 
          12*(885 - 2346*Nu - 3253*pow(Nu,2) + 5846*pow(Nu,3))*
           pow(PhiDOT,4)*pow(r,4)*pow(rDOT,2) + 
          Complex(0,8)*(211 - 90*Nu - 2692*pow(Nu,2) + 
             2880*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,3)
            + 16*(181 - 522*Nu - 493*pow(Nu,2) + 1062*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,4) + 
          Complex(0,48)*(45 - 102*Nu - 236*pow(Nu,2) + 
             352*pow(Nu,3))*PhiDOT*r*pow(rDOT,5) - 
          160*(3 - 6*Nu - 19*pow(Nu,2) + 26*pow(Nu,3))*
           pow(rDOT,6))))/(sqrt(65)*pow(r,3)));
    }
...
static COMPLEX16 hGO_6_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 4){
        ...
        +/*Henry et al. ecc+spin terms */ ((pow(mass,2)*(40*pow(mass,2)*
        (6*pow(Nu,3)*(3489*PhiDOT*r + Complex(0,24880)*rDOT)*
           (S1z + S2z) - 21*(683*PhiDOT*r + Complex(0,476)*rDOT)*
           (S1z + delta*S1z + S2z - delta*S2z) - 
          3*pow(Nu,2)*(PhiDOT*r*
              (Complex(0,65990) + (28411 + 26377*delta)*S1z + 
                28411*S2z - 26377*delta*S2z) + 
             Complex(0,1)*rDOT*
              (Complex(0,45321) + 40*(1592 + 485*delta)*S1z + 
                63680*S2z - 19400*delta*S2z)) + 
          Nu*(PhiDOT*r*(Complex(0,61450) + 73677*S1z + 
                75423*delta*S1z + 73677*S2z - 75423*delta*S2z) + 
             Complex(0,3)*rDOT*
              (Complex(0,14017) + 25790*S1z + 18030*delta*S1z + 
                25790*S2z - 18030*delta*S2z))) - 
       12*mass*r*(30*pow(Nu,3)*
           (9893*pow(PhiDOT,3)*pow(r,3) + 
             Complex(0,55432)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
             5479*PhiDOT*r*pow(rDOT,2) + 
             Complex(0,20460)*pow(rDOT,3))*(S1z + S2z) - 
          210*(67*pow(PhiDOT,3)*pow(r,3) - 
             Complex(0,122)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
             433*PhiDOT*r*pow(rDOT,2) + Complex(0,236)*pow(rDOT,3))
            *(S1z + delta*S1z + S2z - delta*S2z) + 
          Nu*(pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,285011) + 10*(10608 + 10973*delta)*S1z + 
                (106080 - 109730*delta)*S2z) + 
             5*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,50631) + (80562 + 97252*delta)*S1z + 
                (80562 - 97252*delta)*S2z) + 
             Complex(0,5)*pow(rDOT,3)*
              (Complex(0,24843) + 10*(7293 + 5153*delta)*S1z + 
                (72930 - 51530*delta)*S2z) - 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,-12613) + 40*(-2676 + 1801*delta)*S1z - 
                40*(2676 + 1801*delta)*S2z)) - 
          pow(Nu,2)*(5*PhiDOT*r*pow(rDOT,2)*
              (Complex(0,161463) + 2*(22706 + 51787*delta)*S1z + 
                (45412 - 103574*delta)*S2z) + 
             2*pow(PhiDOT,3)*pow(r,3)*
              (Complex(0,460269) + 5*(28838 + 14911*delta)*S1z + 
                (144190 - 74555*delta)*S2z) + 
             Complex(0,5)*pow(rDOT,3)*
              (Complex(0,80079) + 20*(8419 + 2675*delta)*S1z - 
                20*(-8419 + 2675*delta)*S2z) - 
             Complex(0,2)*pow(PhiDOT,2)*pow(r,2)*rDOT*
              (Complex(0,-36879) + 10*(-78341 + 8003*delta)*S1z - 
       ...
       3*pow(r,2)*(60*pow(Nu,3)*
           (11215*pow(PhiDOT,5)*pow(r,5) + 
             ...
             Complex(0,57112)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3) - 6992*PhiDOT*r*pow(rDOT,4) + 
             Complex(0,9600)*pow(rDOT,5))*(S1z + S2z) + 
          6300*(9*pow(PhiDOT,5)*pow(r,5) + 
             Complex(0,9)*pow(PhiDOT,4)*pow(r,4)*rDOT - 
             28*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) - 
             Complex(0,6)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
             16*PhiDOT*r*pow(rDOT,4) - Complex(0,8)*pow(rDOT,5))*
           (S1z + delta*S1z + S2z - delta*S2z) + 
          pow(Nu,2)*(Complex(0,-4)*pow(PhiDOT,2)*pow(r,2)*
              pow(rDOT,3)*(Complex(0,37829) + 
                30*(30617 + 1089*delta)*S1z + 
                (918510 - 32670*delta)*S2z) - 
             48*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,44162) + 5*(10459 + 3923*delta)*S1z + 
                (52295 - 19615*delta)*S2z) - 
             Complex(0,120)*pow(rDOT,5)*
              (Complex(0,2449) + 200*(34 + 11*delta)*S1z - 
                200*(-34 + 11*delta)*S2z) + 
             4*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,-354934) + 75*(-650 + 297*delta)*S1z - 
                75*(650 + 297*delta)*S2z) - 
             320*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,2449) + 3*(36 + 577*delta)*S1z - 
                3*(-36 + 577*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,880129) + 120*(-28647 + 4751*delta)*S1z - 
                120*(28647 + 4751*delta)*S2z)) - 
          3*Nu*(Complex(0,-40)*pow(rDOT,5)*
             ...
             320*PhiDOT*r*pow(rDOT,4)*
              (Complex(0,251) + (422 + 551*delta)*S1z + 
                (422 - 551*delta)*S2z) - 
             Complex(0,4)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3)*
              (Complex(0,3971) + 40*(1858 + 333*delta)*S1z - 
                40*(-1858 + 333*delta)*S2z) + 
             4*pow(PhiDOT,5)*pow(r,5)*
              (Complex(0,-37091) + 5*(3454 + 3105*delta)*S1z - 
                5*(-3454 + 3105*delta)*S2z) - 
             16*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2)*
              (Complex(0,13464) + 5*(5007 + 3799*delta)*S1z - 
                5*(-5007 + 3799*delta)*S2z) + 
             Complex(0,1)*pow(PhiDOT,4)*pow(r,4)*rDOT*
              (Complex(0,94671) + 10*(-16313 + 14227*delta)*S1z - 
...
static COMPLEX16 hGO_6_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 5){
        ...
        + /* Henry et al. ecc spin terms */ ((Complex(0,-0.00042087542087542086)*pow(mass,2)*Nu*
         (410*pow(mass,2) - 2*mass*r*
        (359*pow(PhiDOT,2)*pow(r,2) - 
          Complex(0,343)*PhiDOT*r*rDOT + 310*pow(rDOT,2)) + 
         3*pow(r,2)*(103*pow(PhiDOT,4)*pow(r,4) - 
          Complex(0,196)*pow(PhiDOT,3)*pow(r,3)*rDOT + 
          108*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2) - 
          Complex(0,56)*PhiDOT*r*pow(rDOT,3) + 40*pow(rDOT,4)))*
        ((1 + delta*(-1 + Nu) - 3*Nu)*S1z + 
         (-1 + delta*(-1 + Nu) + 3*Nu)*S2z))/(sqrt(26)*pow(r,4))));
    }

    else if(vpnorder == 7){

        return((delta*mass*PhiDOT*(Complex(0,16)*pow(mass,3)*
        (-3893 + Nu*(16386 + Nu*(-17175 + 6922*Nu))) + 
       24*pow(mass,2)*r*(Complex(0,-1)*
           (-1608 + Nu*(7857 + Nu*(-14179 + 11585*Nu)))*
           pow(PhiDOT,2)*pow(r,2) - 
          2*(1954 + Nu*(-7090 + 3*Nu*(477 + 1744*Nu)))*PhiDOT*r*rDOT - 
          Complex(0,1)*(6603 + Nu*(-26446 + Nu*(16325 + 7138*Nu)))*
           pow(rDOT,2)) + 12*mass*pow(r,2)*
        (Complex(0,2)*(973 + 2*Nu*(-898 + Nu*(-4168 + 6015*Nu)))*
           pow(PhiDOT,4)*pow(r,4) + 
          (25393 + 2*Nu*(-48592 + Nu*(24716 + 15777*Nu)))*
           pow(PhiDOT,3)*pow(r,3)*rDOT + 
          Complex(0,3)*(6017 + 2*Nu*(-11616 + Nu*(5954 + 4053*Nu)))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,2) + 
          (9713 + 2*Nu*(-19024 + 3*Nu*(3558 + 1927*Nu)))*PhiDOT*r*
           pow(rDOT,3) + Complex(0,4)*
           (1811 + Nu*(-7007 + 3*Nu*(1195 + 837*Nu)))*pow(rDOT,4)) + 
       9*pow(r,3)*(Complex(0,-1)*
           (781 + 2*Nu*(-81 + Nu*(-5699 + 6336*Nu)))*pow(PhiDOT,6)*
           pow(r,6) - 2*(8025 + 2*Nu*(-15003 + Nu*(6791 + 5258*Nu)))*
           pow(PhiDOT,5)*pow(r,5)*rDOT - 
          Complex(0,844)*(3 + Nu*(-6 + Nu*(-19 + 26*Nu)))*
           pow(PhiDOT,4)*pow(r,4)*pow(rDOT,2) + 
          8*(-425 + 2*Nu*(519 + 2*(481 - 772*Nu)*Nu))*pow(PhiDOT,3)*
           pow(r,3)*pow(rDOT,3) - 
          Complex(0,592)*(3 + Nu*(-6 + Nu*(-19 + 26*Nu)))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,4) + 
          16*(-45 + 2*Nu*(51 + 2*(59 - 88*Nu)*Nu))*PhiDOT*r*
           pow(rDOT,5) - Complex(0,160)*
           (3 + Nu*(-6 + Nu*(-19 + 26*Nu)))*pow(rDOT,6))))/
...
static COMPLEX16 hGO_7_m_7(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    ...
    if(vpnorder == 5){
        ...
        return((delta*(5040*(-59 + 473*Nu - 1185*pow(Nu,2) + 831*pow(Nu,3))*
        pow(r,4)*pow(PhiDOT*r + Complex(0,1)*rDOT,8)*
        (Complex(0,1)*PhiDOT*r + rDOT) + 
       4*pow(mass,4)*(Complex(0,-7)*
           (-845315 + 3567934*Nu - 3505793*pow(Nu,2) + 
             1006326*pow(Nu,3))*PhiDOT*r + 
          4*(-482641 + 2069935*Nu - 2198091*pow(Nu,2) + 
             803481*pow(Nu,3))*rDOT) + 
       2*pow(mass,3)*r*(Complex(0,-7)*
           (-8046605 + 37481621*Nu - 46964439*pow(Nu,2) + 
             19173243*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3) + 
          2*(-17292661 + 90383188*Nu - 148920723*pow(Nu,2) + 
             88022760*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*rDOT + 
          Complex(0,7)*(-1175695 + 7490560*Nu - 17116047*pow(Nu,2) + 
             13239024*pow(Nu,3))*PhiDOT*r*pow(rDOT,2) - 
          8*(-74093 + 755216*Nu - 2568447*pow(Nu,2) + 
             2398116*pow(Nu,3))*pow(rDOT,3)) + 
       18*pow(mass,2)*pow(r,2)*
        (Complex(0,-14)*(-270811 + 1455597*Nu - 2122103*pow(Nu,2) + 
             757575*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5) + 
          (1113940 + 4956889*Nu - 34515698*pow(Nu,2) + 
             28651791*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*rDOT + 
          Complex(0,7)*(715061 - 1359787*Nu - 4470709*pow(Nu,2) + 
             5729499*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,2) + (-4243543 + 9349627*Nu + 
             22353219*pow(Nu,2) - 32044971*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
          Complex(0,14)*(119115 - 252749*Nu - 689509*pow(Nu,2) + 
             975153*pow(Nu,3))*PhiDOT*r*pow(rDOT,4) + 
          2*(131615 - 252847*Nu - 892507*pow(Nu,2) + 
             1206639*pow(Nu,3))*pow(rDOT,5)) + 
       315*mass*pow(r,3)*(Complex(0,1)*
           (5005 + 44124*Nu - 401470*pow(Nu,2) + 512250*pow(Nu,3))*
           pow(PhiDOT,7)*pow(r,7) + 
          2*(32339 - 197757*Nu + 459526*pow(Nu,2) - 
             383013*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6)*rDOT - 
          Complex(0,1)*(-168255 + 685408*Nu - 635707*pow(Nu,2) + 
             199944*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*
           pow(rDOT,2) + 4*
           (-53106 + 146273*Nu + 123916*pow(Nu,2) - 
             235713*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
           pow(rDOT,3) - Complex(0,10)*
           (16287 - 22820*Nu - 136891*pow(Nu,2) + 
             159864*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,4) + 16*
           (4761 + 725*Nu - 72818*pow(Nu,2) + 75357*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) + 
          Complex(0,40)*(499 + 1018*Nu - 11789*pow(Nu,2) + 
             11502*pow(Nu,3))*PhiDOT*r*pow(rDOT,6) - 
          32*(70 + 311*Nu - 2394*pow(Nu,2) + 2253*pow(Nu,3))*
           pow(rDOT,7))))/(171360.*sqrt(6006)*pow(r,4)));
    }
...
static COMPLEX16 hGO_7_m_5(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    ...
    if(vpnorder == 5){
        ...
        return((delta*(Complex(0,5040)*(-59 + 473*Nu - 1185*pow(Nu,2) + 
          831*pow(Nu,3))*pow(r,4)*
        pow(PhiDOT*r - Complex(0,1)*rDOT,2)*
        pow(PhiDOT*r + Complex(0,1)*rDOT,7) + 
       4*pow(mass,4)*(Complex(0,5)*
           (-845315 + 3567934*Nu - 3505793*pow(Nu,2) + 
             1006326*pow(Nu,3))*PhiDOT*r + 
          4*(482641 - 2069935*Nu + 2198091*pow(Nu,2) - 
             803481*pow(Nu,3))*rDOT) + 
       2*pow(mass,3)*r*(Complex(0,5)*
           (-2480333 + 11838029*Nu - 15223575*pow(Nu,2) + 
             5981667*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3) - 
          2*(-7732189 + 40782964*Nu - 67735947*pow(Nu,2) + 
             39807720*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*rDOT - 
          Complex(0,5)*(-1175695 + 7490560*Nu - 17116047*pow(Nu,2) + 
             13239024*pow(Nu,3))*PhiDOT*r*pow(rDOT,2) + 
          8*(-74093 + 755216*Nu - 2568447*pow(Nu,2) + 
             2398116*pow(Nu,3))*pow(rDOT,3)) + 
       18*pow(mass,2)*pow(r,2)*
        (Complex(0,-10)*(-58221 + 312011*Nu - 571313*pow(Nu,2) + 
             397665*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5) + 
          (-117884 + 723063*Nu - 2639174*pow(Nu,2) + 
             3313409*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*rDOT - 
          Complex(0,5)*(236029 - 577139*Nu - 804413*pow(Nu,2) + 
             1190115*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,2) + (1940751 - 4452163*Nu - 
             9331755*pow(Nu,2) + 13753811*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) + 
          Complex(0,10)*(119115 - 252749*Nu - 689509*pow(Nu,2) + 
             975153*pow(Nu,3))*PhiDOT*r*pow(rDOT,4) + 
          2*(-131615 + 252847*Nu + 892507*pow(Nu,2) - 
             1206639*pow(Nu,3))*pow(rDOT,5)) + 
       45*mass*pow(r,3)*(Complex(0,1)*
           (39847 - 121612*Nu - 163210*pow(Nu,2) + 
             376622*pow(Nu,3))*pow(PhiDOT,7)*pow(r,7) + 
          2*(79987 - 238709*Nu - 93106*pow(Nu,2) + 
             259939*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6)*rDOT + 
          Complex(0,1)*(173997 + 166656*Nu - 3315983*pow(Nu,2) + 
             3362728*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*
           pow(rDOT,2) - 4*
           (-13074 + 266583*Nu - 998488*pow(Nu,2) + 
             847097*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
           pow(rDOT,3) + Complex(0,2)*
           (135447 - 440484*Nu - 25811*pow(Nu,2) + 
             357784*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,4) - 16*
           (15423 - 4597*Nu - 205150*pow(Nu,2) + 217363*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) - 
          Complex(0,200)*(499 + 1018*Nu - 11789*pow(Nu,2) + 
             11502*pow(Nu,3))*PhiDOT*r*pow(rDOT,6) + 
          224*(70 + 311*Nu - 2394*pow(Nu,2) + 2253*pow(Nu,3))*
           pow(rDOT,7))))/(2.22768e6*sqrt(66)*pow(r,4)));
    }
...
static COMPLEX16 hGO_7_m_3(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    ...
    if(vpnorder == 5){
       ...
       4*pow(mass,4)*(Complex(0,-3)*
           (-845315 + 3567934*Nu - 3505793*pow(Nu,2) + 
             1006326*pow(Nu,3))*PhiDOT*r + 
          4*(-482641 + 2069935*Nu - 2198091*pow(Nu,2) + 
             803481*pow(Nu,3))*rDOT) + 
       2*pow(mass,3)*r*(Complex(0,3)*
           (-1230515 + 5257699*Nu - 5937001*pow(Nu,2) + 
             2812717*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3) + 
          2*(-1358541 + 7716148*Nu - 13612763*pow(Nu,2) + 
             7664360*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*rDOT + 
          Complex(0,3)*(-1175695 + 7490560*Nu - 17116047*pow(Nu,2) + 
             13239024*pow(Nu,3))*PhiDOT*r*pow(rDOT,2) - 
          8*(-74093 + 755216*Nu - 2568447*pow(Nu,2) + 
             2398116*pow(Nu,3))*pow(rDOT,3)) + 
       6*pow(mass,2)*pow(r,2)*
        (Complex(0,-2)*(76741 - 370227*Nu + 248553*pow(Nu,2) + 
             279655*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5) - 
          3*(65300 + 667351*Nu - 4038422*pow(Nu,2) + 
             3825889*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*rDOT - 
          Complex(0,3)*(249977 + 166121*Nu - 4919353*pow(Nu,2) + 
             5508423*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,2) + (-1216669 + 3561561*Nu + 
             1952337*pow(Nu,2) - 4679113*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
          Complex(0,18)*(119115 - 252749*Nu - 689509*pow(Nu,2) + 
             975153*pow(Nu,3))*PhiDOT*r*pow(rDOT,4) + 
          6*(131615 - 252847*Nu - 892507*pow(Nu,2) + 
             1206639*pow(Nu,3))*pow(rDOT,5)) + 
       15*mass*pow(r,3)*(Complex(0,-17)*
           (-3693 + 24516*Nu - 50930*pow(Nu,2) + 30982*pow(Nu,3))*
           pow(PhiDOT,7)*pow(r,7) + 
          6*(14141 + 89013*Nu - 604958*pow(Nu,2) + 
             566877*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6)*rDOT + 
          Complex(0,1)*(-125697 + 1209408*Nu - 3554741*pow(Nu,2) + 
             2822200*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*
           pow(rDOT,2) + 4*
           (90786 - 8859*Nu - 1290784*pow(Nu,2) + 
             1354859*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
           pow(rDOT,3) + Complex(0,6)*
           (27423 + 212284*Nu - 1343099*pow(Nu,2) + 
             1240856*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,4) + 16*
           (10461 - 33135*Nu - 6298*pow(Nu,2) + 31817*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) + 
          Complex(0,360)*(499 + 1018*Nu - 11789*pow(Nu,2) + 
             11502*pow(Nu,3))*PhiDOT*r*pow(rDOT,6) - 
          672*(70 + 311*Nu - 2394*pow(Nu,2) + 2253*pow(Nu,3))*
           pow(rDOT,7))))/(8.16816e6*sqrt(6)*pow(r,4)));
    }
...
static COMPLEX16 hGO_7_m_1(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder){
    ...
    if(vpnorder == 5){
       ...
       4*pow(mass,4)*(Complex(0,1)*
           (-845315 + 3567934*Nu - 3505793*pow(Nu,2) + 
             1006326*pow(Nu,3))*PhiDOT*r + 
          4*(482641 - 2069935*Nu + 2198091*pow(Nu,2) - 
             803481*pow(Nu,3))*rDOT) + 
       2*pow(mass,3)*r*(Complex(0,-1)*
           (-3085939 + 13805563*Nu - 16517289*pow(Nu,2) + 
             7209909*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3) + 
          2*(-1828283 + 8817260*Nu - 13448829*pow(Nu,2) + 
             8407320*pow(Nu,3))*pow(PhiDOT,2)*pow(r,2)*rDOT - 
          Complex(0,1)*(-1175695 + 7490560*Nu - 17116047*pow(Nu,2) + 
             13239024*pow(Nu,3))*PhiDOT*r*pow(rDOT,2) + 
          8*(-74093 + 755216*Nu - 2568447*pow(Nu,2) + 
             2398116*pow(Nu,3))*pow(rDOT,3)) + 
       18*pow(mass,2)*pow(r,2)*
        (Complex(0,2)*(-97035 + 529085*Nu - 946023*pow(Nu,2) + 
             605111*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5) + 
          (12636 - 513209*Nu + 2273154*pow(Nu,2) - 
             2157167*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*rDOT + 
          Complex(0,3)*(81001 - 68503*Nu - 953961*pow(Nu,2) + 
             1116423*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,2) + (-362041 + 445301*Nu + 
             3689709*pow(Nu,2) - 4537349*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) + 
          Complex(0,2)*(119115 - 252749*Nu - 689509*pow(Nu,2) + 
             975153*pow(Nu,3))*PhiDOT*r*pow(rDOT,4) + 
          2*(-131615 + 252847*Nu + 892507*pow(Nu,2) - 
             1206639*pow(Nu,3))*pow(rDOT,5)) - 
       Complex(0,9)*mass*pow(r,3)*
        ((-107407 + 883020*Nu - 2319286*pow(Nu,2) + 
             1727170*pow(Nu,3))*pow(PhiDOT,7)*pow(r,7) + 
          Complex(0,2)*(-937 + 307287*Nu - 1356450*pow(Nu,2) + 
             1189583*pow(Nu,3))*pow(PhiDOT,6)*pow(r,6)*rDOT + 
          (216555 + 690656*Nu - 6235017*pow(Nu,2) + 
             5984984*pow(Nu,3))*pow(PhiDOT,5)*pow(r,5)*
           pow(rDOT,2) + Complex(0,4)*
           (34014 + 335581*Nu - 1987500*pow(Nu,2) + 
             1820899*pow(Nu,3))*pow(PhiDOT,4)*pow(r,4)*
           pow(rDOT,3) + 2*
           (136281 + 310468*Nu - 3370653*pow(Nu,2) + 
             3281032*pow(Nu,3))*pow(PhiDOT,3)*pow(r,3)*
           pow(rDOT,4) + Complex(0,80)*
           (2481 + 14269*Nu - 99426*pow(Nu,2) + 92773*pow(Nu,3))*
           pow(PhiDOT,2)*pow(r,2)*pow(rDOT,5) + 
          200*(499 + 1018*Nu - 11789*pow(Nu,2) + 11502*pow(Nu,3))*
           PhiDOT*r*pow(rDOT,6) + 
          Complex(0,1120)*(70 + 311*Nu - 2394*pow(Nu,2) + 
             2253*pow(Nu,3))*pow(rDOT,7))))/
...
static COMPLEX16 hGO_7_m_2(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 6){
        ...
        + /* Henry et al. ecc+spin terms */((pow(mass,2)*Nu*(8*pow(mass,2)*
        (494*PhiDOT*r + Complex(0,411)*rDOT) - 
       12*mass*r*(530*pow(PhiDOT,3)*pow(r,3) - 
          Complex(0,6)*pow(PhiDOT,2)*pow(r,2)*rDOT + 
          453*PhiDOT*r*pow(rDOT,2) + Complex(0,197)*pow(rDOT,3)) + 
       3*pow(r,2)*(824*pow(PhiDOT,5)*pow(r,5) - 
          Complex(0,671)*pow(PhiDOT,4)*pow(r,4)*rDOT + 
          864*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) + 
          Complex(0,44)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) + 
          320*PhiDOT*r*pow(rDOT,4) + Complex(0,120)*pow(rDOT,5)))*
     ((1 - 4*Nu + 2*pow(Nu,2) + delta*(-1 + 2*Nu))*S1z + 
       (1 + delta - 4*Nu - 2*delta*Nu + 2*pow(Nu,2))*S2z))/
...
static COMPLEX16 hGO_7_m_4(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
   REAL8 delta = sqrt(1-4*Nu);
    ...
    if(vpnorder == 6){
        ...
        + /* Henry et al. ecc+spin terms */(-0.00009157509157509158*(pow(mass,2)*Nu*
      (8*pow(mass,2)*(988*PhiDOT*r + Complex(0,411)*rDOT) + 
        12*mass*r*(844*pow(PhiDOT,3)*pow(r,3) + 
           Complex(0,1518)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
           906*PhiDOT*r*pow(rDOT,2) - Complex(0,197)*pow(rDOT,3))\
         - 15*pow(r,2)*(656*pow(PhiDOT,5)*pow(r,5) + 
           Complex(0,179)*pow(PhiDOT,4)*pow(r,4)*rDOT + 
           192*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) + 
           Complex(0,260)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) - 
           128*PhiDOT*r*pow(rDOT,4) - Complex(0,24)*pow(rDOT,5)))*
      ((1 - 4*Nu + 2*pow(Nu,2) + delta*(-1 + 2*Nu))*S1z + 
        (1 + delta - 4*Nu - 2*delta*Nu + 2*pow(Nu,2))*S2z))/
    (sqrt(66)*pow(r,4))));
    }
...
static COMPLEX16 hGO_7_m_6(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 PhiDOT,UINT4 vpnorder,REAL8 S1z, REAL8 S2z, REAL8 x){
    ...
    if(vpnorder == 6){
       ...
       4*mass*r*(6026*pow(PhiDOT,3)*pow(r,3) + 
          Complex(0,4038)*pow(PhiDOT,2)*pow(r,2)*rDOT - 
          1359*PhiDOT*r*pow(rDOT,2) - Complex(0,197)*pow(rDOT,3))\
        + 15*pow(r,2)*(1240*pow(PhiDOT,5)*pow(r,5) + 
          Complex(0,911)*pow(PhiDOT,4)*pow(r,4)*rDOT - 
          544*pow(PhiDOT,3)*pow(r,3)*pow(rDOT,2) - 
          Complex(0,236)*pow(PhiDOT,2)*pow(r,2)*pow(rDOT,3) + 
          64*PhiDOT*r*pow(rDOT,4) + Complex(0,8)*pow(rDOT,5)))*
     ((1 - 4*Nu + 2*pow(Nu,2) + delta*(-1 + 2*Nu))*S1z + 
       (1 + delta - 4*Nu - 2*delta*Nu + 2*pow(Nu,2))*S2z))/
...
static COMPLEX16 h05PNGOresult(REAL8 mass,REAL8 Nu,REAL8 r,REAL8 rDOT,REAL8 Phi,REAL8 PhiDOT,REAL8 inc,REAL8 euler_beta,REAL8 R,UINT4 vpnorder,REAL8 S1z,REAL8 S2z, REAL8 x){
    ...
    //3.5PN(only quasi-circular spinning terms)
         ...
         COMPLEX16 hcombined =XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,1)*hl_6_m_1(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-1)*hl_6_m_min1(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+ 
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,2)*hl_6_m_2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-2)*hl_6_m_min2(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,3)*hl_6_m_3(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-3)*hl_6_m_min3(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,5)*hl_6_m_5(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,6,-5)*hl_6_m_min5(mass,Nu,r,rDOT,Phi,PhiDOT,R,7,S1z,S2z,x)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,7)*hl_7_m_7(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,-7)*hl_7_m_min7(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,5)*hl_7_m_5(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,-5)*hl_7_m_min5(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,3)*hl_7_m_3(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,-3)*hl_7_m_min3(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
                              ...
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,1)*hl_7_m_1(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
                              XLALSpinWeightedSphericalHarmonic(inc,euler_beta, -2,7,-1)*hl_7_m_min1(mass,Nu,r,rDOT,Phi,PhiDOT,R,7)+
